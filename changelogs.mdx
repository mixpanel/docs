...
<Update label="2026-08-24">
  ...
  - **Trust every result:** Pre-Experiment Bias and SRM checks run automatically, and advanced methodologies like CUPED, Winsorization, Bonferroni, Benjamini-Hochburg are available to keep every experiment statistically sound
