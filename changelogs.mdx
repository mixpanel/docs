...
<Update label="2026-09-09">
  ...
  Changing one filter across ten reports used to mean opening all ten and making the same edit ten times. Now Mixpanel Agent can now edit the reports already on a board, so a board-wide change takes a single request.
