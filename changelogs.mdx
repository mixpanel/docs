...
<Update label="2026-09-28">
  ...
  Getting Mixpanel's [Audit Log](/docs/access-security/audit-log) into your security tooling used to mean exporting it by hand or building your own integration. Audit Log Streaming now delivers every audit log entry for your organization to a bucket you own, usually within minutes of the action.
