...
type Card = {
  title: string;
  label: string;
  img?: string;       // if present, show image; otherwise render black placeholder
...
const cards: Card[] = [
  {
    ...
    img: "/navattic/launch-an-experiment.png", // lives in /public/navattic/
    popupUrl: "https://capture.navattic.com/cmfkxwfa5000004lc8408f5wi",
  },
  {
    title: "Example Walkthrough",
    label: "PRODUCT OVERVIEWS",
    // no img -> black box fallback
        ...
        <div className="flex flex-wrap gap-6">
          {cards.map((c, i) => (
            <button
              ...
              style={{ width: 296, height: 319 }} /* EXACT 296×319 */
              className="relative rounded-[14px] overflow-hidden bg-[#0B0A13] border border-[#2A2A35] shadow-md hover:shadow-xl transition-transform hover:-translate-y-1 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#8B5CF6]"
            >
              {/* Dog-ear */}
              <div
              ...
              {/* Media: fixed height; indent to the right; image OR black fallback */}
