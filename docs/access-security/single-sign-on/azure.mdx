---
title: Setup Azure SSO
description: "You can set up Microsoft Azure Single Sign-On to use with your Mixpanel account"
---
...
- **Reply URL:** [https://sso.mixpanel.com/sso/saml2](https://sso.mixpanel.com/sso/saml2)
- **Sign on URL:** Postback URL from Mixpanel ([https://mixpanel.com/security/sso/v2/authorize/?org\_id=YOUR\_ORG\_ID](https://mixpanel.com/security/sso/v2/authorize/?org_id=YOUR_ORG_ID))

<Frame>
  ![Azure Config 1 Image](/images/azure_config1.png)
</Frame>
...
<Frame>
  ![Azure Config 2 Image](/images/azure_config2.png)
</Frame>

4. Make sure to clear out the **Namespace** field as well, or else it won't work!

<Frame>
  ![Azure Config 3 Image](/images/azure_config3.png)
</Frame>
