---
title: "Setup Google Workspace SSO"
---
...
3. If seeing the "Error 403: app_not_configured" message when trying to log in, please follow [these instructions](https://knowledge.workspace.google.com/admin/apps/saml-app-error-messages#403_app_not_configured) to grant the necessary permissions to the user's account.
