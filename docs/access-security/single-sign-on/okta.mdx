...
Then, in Mixpanel, go to **Organization Settings** > **Access Security** > **Single Sign-On**. Enter the **Public Certificate** in the **SAML Certificate** field, the **Authentication URL** in the **Identity Provider Sign-in URL** field, and the **Issuer URL** in the **Issuer URL** field.
