---
sidebarTitle: "Shared SSO"
title: "Shared SSO: Use the same SSO setting for multiple Mixpanel organizations"
---
...
<Frame>
![SSO Admin Organization Image](/images/sso_view_admin_org.png)
</Frame>
...
<Frame>
![SSO Create Admin Organization Image](/images/sso_create_admin_org1.png)
</Frame>

<Frame>
![SSO Create Admin Organization Image](/images/sso_create_admin_org2.png)
</Frame>

The new Admin Organization will be listed in the left nav in Organization Settings.
<Frame>
![SSO Admin Organization Navigation Image](/images/sso_admin_org_nav.png)
</Frame>
...
<Frame>
![SSO Generate Linking Code Image](/images/sso_generate_linking_code.png)
</Frame>

Then complete the linking by entering the linking code in the Organization to be linked.

<Frame>
![SSO Enter Linking Code Image](/images/sso_enter_linking_code.png)
</Frame>
...
<Frame>
![SSO Domain Transfer Image](/images/sso_domain_transfer_image.png)
</Frame>
...
<Frame>
![SSO Linked Organizations Image](/images/sso_linked_orgs.png)
</Frame>
