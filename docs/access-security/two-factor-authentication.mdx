...
description: "Enable two-factor authentication (2FA) for your Mixpanel organization, how it applies to Google and password logins, and why SSO users are exempt"
---
...
When you enable 2FA for your organization, all users will be prompted for a 2FA code, including users who log in with Google social login (OAuth) and traditional username/password login methods. If a user hasn't set up 2FA yet, they will be prompted to set it up on their next login.

This is distinct from [SSO](/docs/access-security/single-sign-on) (SAML-based Single Sign-On) users, who are exempt from 2FA prompts if SSO is enforced for them.
...
<Frame>
  ![2FA Access Security Image](/images/2fa_access_security.png)
</Frame>

2. In “Two Factor Authentication”, if the icon is gray, click it to enable. If the icon is purple, click it to disable.

<Frame>
  ![2FA Enable Image](/images/2fa_enable_2fa.png)
</Frame>

When SSO is enabled, Two Factor Authentication **will not be enforced for users required to use SSO**, as authentication will be handled through the IDP directly. However, users who are not required to log in through SSO (just have the option), will need to pass two factor authentication if enabled along with SSO.
...
<Frame>
  ![2FA Verify Password Image](/images/2fa_verify_password.png)
</Frame>
...
<Frame>
  ![2FA Authentication App 1 Image](/images/2fa_authentication_app1.png)
</Frame>

2. Scan the QR code via your Authentication App in order to complete the setup.

<Frame>
  ![2FA Authentication App 2 Image](/images/2fa_authentication_app2.png)
</Frame>
...
<Frame>
  ![2FA Authentication App 2b Image](/images/2fa_authentication_app2b.png)
</Frame>
...
<Frame>
  ![2FA Authentication App 3 Image](/images/2fa_authentication_app3.png)
</Frame>
...
<Frame>
  ![2FA Personal 1 Image](/images/2fa_personal1.png)
</Frame>
...
<Frame>
  ![2FA Personal 2 Image](/images/2fa_personal2.png)
</Frame>
...
<Frame>
  ![2FA Change 1 Image](/images/2fa_change1.png)
</Frame>
...
<Frame>
  ![2FA Change 2 Image](/images/2fa_change2.png)
</Frame>
...
<Frame>
  ![2FA Backup 1 Image](/images/2fa_backup1.png)
</Frame>

2. Enter your recovery code and click "Login".

<Frame>
  ![2FA Backup 2 Image](/images/2fa_backup2.png)
</Frame>
