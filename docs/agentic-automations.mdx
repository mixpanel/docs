...
- **KPI Monitoring** _(available now)_ — Watches a metric you own and ships a personalized digest on the cadence you choose. See [below](#kpi-monitoring) for details.
