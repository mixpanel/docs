---
title: Apptimize
description: "Export Mixpanel cohorts to Apptimize groups for targeting, as a one-time export or a sync that updates every 15 minutes"
---
...
2. Click **Add Destination**, select Apptimize, and click **Connect**.

<Frame>
  ![Apptimize 2 Image](/images/apptimize2.png)
</Frame>
...
<Frame>
  ![Apptimize 3 Image](/images/apptimize3.png)
</Frame>
...
<Tabs>
  <Tab title="From the Destinations page (recommended)">
    1. Navigate to **Data** in the nav bar, then select **Destinations**.
    2. Find the Apptimize destination in the list and click on it.
  ...
  <Tab title="From Lexicon">
    ...
    3. Click Export to \> Apptimize. Select either one-time sync or dynamic sync. Click Start Sync.
  </Tab>
</Tabs>
...
<Frame>
  ![Apptimize 4 Image](/images/apptimize4.png)
</Frame>
