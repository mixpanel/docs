---
title: Braze
description: "The Mixpanel Braze integration exports Mixpanel Cohorts into Braze"
---
...
2. Click **Add Destination**, then select **Braze**. Click **Connect**.
...
<Frame>
  ![Braze 4 Image](/images/braze4.png)
</Frame>
...
<Frame>
  ![Braze 5 Image](/images/braze5.png)
</Frame>
...
<Tabs>
  <Tab title="From the Destinations page (recommended)">
    1. Navigate to **Data** in the nav bar, then select **Destinations**.
    2. Find the Braze destination in the list and click on it. If you have multiple Connections, they will be differentiated by the Connection Name.
    3. Click the **Syncs** tab, then click **Add Cohort Sync**.
    4. Select the cohort to send to Braze and configure the sync (One-time export or Dynamic sync). Click **Begin Sync**.
  </Tab>
  <Tab title="From Lexicon">
    1. Navigate to **Lexicon**, then select the **Cohorts** tab to view all of your cohorts.

    <Frame>
      ![Braze 6 Image](/images/braze6.png)
    </Frame>
    ...
    <Frame>
      ![Braze 7 Image](/images/braze7.png)
    </Frame>

    3. Select a One-time export or a Dynamic sync. Click Begin Sync.

    <Frame>
      ![Braze 8 Image](/images/braze8.png)
    </Frame>
  </Tab>
</Tabs>
