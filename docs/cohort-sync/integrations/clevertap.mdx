---
title: CleverTap
description: "Export Mixpanel cohorts to CleverTap to create custom segments that you can apply in your CleverTap campaigns and"
---

## Overview

Export Mixpanel cohorts to CleverTap to create custom segments that you can apply in your CleverTap campaigns and journeys. Manage the CleverTap integration from the Mixpanel Destinations page.
...
2. Click **Add Destination**, select CleverTap, and click **Connect**.

<Frame>
  ![CleverTap 2 Image](/images/clevertap2.png)
</Frame>
...
4. You can optionally select the user properties to export by clicking on the **_Edit Columns_** and selecting the user properties you wish to be included in the export. The default user properties that are exported can be found [here](/docs/cohort-sync#limits).
...
<Tabs>
  <Tab title="From the Destinations page (recommended)">
    1. Navigate to **Data** in the nav bar, then select **Destinations**.
    2. Find the CleverTap destination in the list and click on it.
  ...
  <Tab title="From Lexicon">
    ...
    3. Click **Export to \> CleverTap**. Select either one-time sync or dynamic sync. Click **Start Sync**.
  </Tab>
</Tabs>
...
<Frame>
  ![CleverTap 4 Image](/images/clevertap4.png)
</Frame>
