---
title: Iterable
description: "Export Mixpanel cohorts to Iterable to create user lists that you can target in your Iterable campaigns"
---

## Overview

Export Mixpanel cohorts to Iterable to create user lists that you can target in your Iterable campaigns. Manage the Iterable integration from the Mixpanel Destinations page.
...
2. Click **Add Destination**, select Iterable, and click **Connect**.
...
<Tabs>
  <Tab title="From the Destinations page (recommended)">
    1. Navigate to **Data** in the nav bar, then select **Destinations**.
    2. Find the Iterable destination in the list and click on it.
  ...
  <Tab title="From Lexicon">
    ...
    <Frame>
      ![iterable 3 Image](/images/iterable3.png)
    </Frame>
  </Tab>
</Tabs>
...
<Frame>
  ![iterable 4 Image](/images/Iterable4.png)
</Frame>
...
<Frame>
  ![Iterable's user ID](/images/iterable_user_id.png)
</Frame>
