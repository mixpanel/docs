---
title: Leanplum
description: "Export Mixpanel cohorts to Leanplum to create custom audiences that you can apply in your Leanplum campaigns"
---

## Overview

Export Mixpanel cohorts to Leanplum to create custom audiences that you can apply in your Leanplum campaigns. Manage the Leanplum integration from the Mixpanel Destinations page.
...
2. Click **Add Destination**, select Leanplum, and click **Connect**.

<Frame>
  ![Leanplum 2 Image](/images/leanplum2.png)
</Frame>
...
<Tabs>
  <Tab title="From the Destinations page (recommended)">
    1. Navigate to **Data** in the nav bar, then select **Destinations**.
    2. Find the Leanplum destination in the list and click on it.
  ...
  <Tab title="From Lexicon">
    ...
    3. Click Export to \> Leanplum. Select either one-time sync or dynamic sync. Click Start Sync.

    <Frame>
      ![Leanplum 3 Image](/images/leanplum3.png)
    </Frame>
  </Tab>
</Tabs>
...
<Frame>
  ![Leanplum 4 Image](/images/leanplum4.png)
</Frame>
