---
title: OneSignal
description: "Export Mixpanel cohorts to OneSignal to create custom segments that you can apply in your OneSignal campaigns"
---

## Overview

Export Mixpanel cohorts to OneSignal to create custom segments that you can apply in your OneSignal campaigns. Manage the OneSignal integration from the Mixpanel Destinations page.
...
2. Click **Add Destination**, select OneSignal, and click **Connect**.
...
<Frame>
  ![OneSignal 2 Image](/images/onesignal6.png)
</Frame>
...
<Tabs>
  <Tab title="From the Destinations page (recommended)">
    1. Navigate to **Data** in the nav bar, then select **Destinations**.
    2. Find the OneSignal destination in the list and click on it.
  ...
  <Tab title="From Lexicon">
    ...
    <Frame>
      ![OneSignal 4 Image](/images/onesignal4.png)
    </Frame>
  </Tab>
</Tabs>
...
<Frame>
  ![OneSignal 5 Image](/images/onesignal5.png)
</Frame>
