---
title: Segment
description: "Export Mixpanel cohorts to Segment with a Mixpanel Cohorts source and write key, so you can target users across Segment destinations"
---
...
<Frame>
  ![Segment 1 Image](/images/segment1.png)
</Frame>

4. Create a Mixpanel Cohorts source.

<Frame>
  ![Segment 2 Image](/images/segment2.png)
</Frame>

5. Copy the **Write Key** displayed there.

<Frame>
  ![Segment 3 Image](/images/segment3.png)
</Frame>
...
2. Click **Add Destination**, select Segment, click **Connect**, and paste the **Write Key** that you generated in Segment.
...
<Frame>
  ![Segment 5 Image](/images/segment5.png)
</Frame>
...
<Tabs>
  <Tab title="From the Destinations page (recommended)">
    1. Navigate to **Data** in the nav bar, then select **Destinations**.
    2. Find the Segment destination in the list and click on it.
  ...
  <Tab title="From Lexicon">
    ...
    <Frame>
      ![Segment 6 Image](/images/segment6.png)
    </Frame>
...
<Frame>
  ![Segment 7 Image](/images/segment7.png)
</Frame>
