---
title: Taplytics
description: "Export Mixpanel cohorts to Taplytics to create custom segments that you can apply in your Taplytics experiments,"
---

## Overview

Export Mixpanel cohorts to Taplytics to create custom segments that you can apply in your Taplytics experiments, feature flags, and more. Manage the Taplytics integration from the Mixpanel Destinations page.
...
2. Click **Add Destination**, select Taplytics, and click **Connect**.

<Frame>
  ![Taplytics 2 Image](/images/taplytics2.png)
</Frame>
...
<Tabs>
  <Tab title="From the Destinations page (recommended)">
    1. Navigate to **Data** in the nav bar, then select **Destinations**.
    2. Find the Taplytics destination in the list and click on it.
  ...
  <Tab title="From Lexicon">
    ...
    3. Click **Export to \> Taplytics**. Select either one-time sync or dynamic sync. Click **Start Sync**.
  </Tab>
</Tabs>

<Frame>
  ![Taplytics 3 Image](/images/taplytics3.png)
</Frame>
...
<Frame>
  ![Taplytics 4 Image](/images/taplytics4.png)
</Frame>
