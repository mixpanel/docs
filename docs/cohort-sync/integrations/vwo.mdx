---
title: VWO
description: "Export Mixpanel cohorts to VWO to create custom segments that you can apply in your VWO experiments"
---

## Overview

Export Mixpanel cohorts to VWO to create custom segments that you can apply in your VWO experiments. Manage the VWO integration from the Mixpanel Destinations page.
...
2. Click **Add Destination**, select VWO, and click **Connect**.

<Frame>
  ![VWO 2 Image](/images/vwo2.png)
</Frame>
...
<Tabs>
  <Tab title="From the Destinations page (recommended)">
    1. Navigate to **Data** in the nav bar, then select **Destinations**.
    2. Find the VWO destination in the list and click on it.
    3. Click the **Syncs** tab, then click **Add Cohort Sync**.
    4. Select the cohort you want to export and configure the sync (one-time or dynamic). Click **Start Sync**. Do note: VWO has a 15MB export limit for profiles in the cohort.
  </Tab>
