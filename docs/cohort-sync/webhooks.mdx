...
- The webhook server should send back events to Mixpanel to track actions like 'Message sent', etc. (This is optional, but customers who need this have to implement it themselves) Customers can follow the naming convention mentioned in our [pricing documentation](/docs/pricing) to avoid certain events from being considered for MTU tallies.
