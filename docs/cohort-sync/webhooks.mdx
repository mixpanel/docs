...
**How can I delete/remove a webhook from the Integrations page?**

It's not possible at this moment to delete or remove a webhook from your project's Integrations page; the only available action via UI is to disconnect it.