...
<Warning>
    While the deletion becomes permanent after 7 days, the process to fully clean the data from the storage can take up to 30 days from the 7 day mark. During this time, said data will not appear in reports, or formatted API queries, but might appear in raw exports while it's fully removed
</Warning>
