---
title: Data Clean-Up
description: "Clean up messy or problematic project data with merge suggestions, Lexicon spot checks, event blocking, and data deletion"
---
...
### Automatically find duplicates with merge suggestions

If you're on an Enterprise plan with AI features enabled, Mixpanel can automatically discover duplicate events and event properties for you and merge them in bulk. See [AI-Powered Data Governance → Merge suggestions](/docs/data-governance/ai-powered-data-governance#merge-suggestions).
...
- Have **malformed or deprecated events** you no longer intend to send
