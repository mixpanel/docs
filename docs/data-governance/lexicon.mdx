...
title: "Lexicon"
description: "Describe your events and data using a dictionary"
---

## Overview

<Frame>
  <iframe src="https://www.youtube-nocookie.com/embed/lAToFlwXHEU" frameBorder="0" webkitallowfullscreen="true" mozallowfullscreen="true" allowFullScreen />
</Frame>
...
4. Custom Profile Properties
5. Lookup Tables
6. Metrics
7. Behaviors

<Info>
  "Saved Definitions" was previously labeled "Computed Data" in Lexicon.
</Info>
...
<Frame>
  ![Lexicon Events](/images/lexicon-events-with-em.png)
</Frame>
...
<Frame>
  ![Lexicon Event Properties](/images/lexicon-default-properties.png)
</Frame>
...
<Frame>
  ![Lexicon Profile Properties](/images/lexicon-group-analytics-GIF.gif)
</Frame>
...
### Custom Event Properties and Custom Profile Properties

[Custom properties](/docs/features/custom-properties) combine existing properties into new ones on the fly using a simple, Excel-like formula language. When you save a custom property so your team can reuse it across reports, it appears in Lexicon as a saved definition.

- **Custom Event Properties** can reference both event and user profile properties in their formula.
- **Custom Profile Properties** can reference only user profile properties.

Click into a definition to review its formula, description, and query volume. See [Custom Properties](/docs/features/custom-properties) for how to create, save, and share them.
...
The **Metrics** page in your Lexicon documents your saved metrics and [Formulas](/docs/reports/insights#formulas). Saved [Funnels/Retention Behaviors](/docs/features/saved-metrics-and-behaviors) in your project are documented here as well. Review these to get an overview of existing definitions you can quickly leverage in your own analysis.
...
<Frame>
  ![Lexicon Filtering](/images/lexiconFiltering.png)
</Frame>
...
<Frame>
  ![Lexicon Query Volumes](/images/thirtyDayMetrics.png)
</Frame>
...
<Frame>
  ![Lexicon Block Events](/images/lexicon-block-event.png)
</Frame>

2. Click Block. A “Confirm blocking your event(s)” warning indicates you cannot recover the data associated with the event.

<Frame>
  ![Lexicon Block Events Warning](/images/lexicon-block-event-warning.png)
</Frame>
...
<Frame>
  ![Lexicon Unblock Events](/images/lexicon-unblock-event.png)
</Frame>
...
<Frame>
  ![Lexicon Block Properties](/images/lexicon-block-property.png)
</Frame>
...
<Frame>
  ![Lexicon Unblock Properties](/images/lexicon-unblock-property.png)
</Frame>
...
<Frame>
  ![Lexicon Hide Events](/images/hide-events.png)
</Frame>
...
<Frame>
  ![Lexicon Hide Events Warning](/images/lexicon-hide-events2.png)
</Frame>
...
<Frame>
  ![Lexicon Show Events and Properties](/images/show-events-and-properties.png)
</Frame>
...
<Frame>
  ![Lexicon Merge Events](/images/lexicon-merge-events.png)
</Frame>
...
<Frame>
  ![Lexicon Unmerge Events](/images/unmerge-events.png)
</Frame>
...
<Frame>
  ![Lexicon Merge Events](/images/merge-properties.png)
</Frame>
...
<Frame>
  ![Lexicon Unmerge Events](/images/unmerge-properties.png)
</Frame>
...
<Frame>
  ![verifyButton](/images/verifyButton.png)
</Frame>
...
<Frame>
  ![Lexicon Export](/images/lexiconExport.png)
</Frame>
...
<Frame>
  ![Lexicon CSV Import Format](/images/lexicon-csv-import-format.png)
</Frame>
...
Mixpanel provides a suite of API endpoints for you to Retrieve, Create, and Delete your data dictionary in Lexicon. To use these APIs, check out our [API reference docs](/reference/lexicon-schemas-api).
