...
description: "Continuously export Mixpanel data to a cloud storage bucket or data warehouse with the Data Pipelines add-on, including destination setup and the free trial"
---
...
<Steps>
  <Step title="Click the settings button and select Destinations">
    <Frame>
      ![create\_pipeline1](/images/create_pipeline1.png)
    </Frame>
  </Step>
  <Step title='Select the provider of your warehouse destination, and click "+ Create Pipeline"'>
    <Frame>
      ![create\_pipeline2](/images/create_pipeline2.png)
    </Frame>
  </Step>
  <Step title="Provide the details of your destination to create the pipeline">
    <Frame>
      ![create\_pipeline3](/images/create_pipeline3.png)
    </Frame>
  </Step>
</Steps>
...
The Account Name should be set to your unique account identifier, e.g., "example1234.us-west-2", while the Storage Integration should be set to the name of the storage integration you created in Snowflake Eg. "MIXPANEL\_EXPORT\_STORAGE\_INTEGRATION".
