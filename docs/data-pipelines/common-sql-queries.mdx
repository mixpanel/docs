...
description: "Example SQL for Data Pipelines exports: deduplicated daily event counts, unique users with ID resolution, top events by volume, and finding duplicates"
---
