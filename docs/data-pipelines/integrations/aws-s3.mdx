---
title: AWS S3
description: "Export Mixpanel events and people data to an AWS S3 bucket with JSON Pipelines, including cross-account role permission setup"
---
...
Refer to [Step 2: Creating the Pipeline](/docs/data-pipelines/#step-2-creating-the-pipeline) to create data pipeline via UI. It is essential to provide specific details to ensure that Mixpanel can accurately direct the data exports to your S3 bucket:
...
<Note>
  If you'll query this data through Glue or Redshift Spectrum and your account uses AWS Lake Formation, see [Setting Glue Permissions](/docs/data-pipelines/integrations/redshift-spectrum#setting-glue-permissions) for the additional Lake Formation grants you'll need.
</Note>
