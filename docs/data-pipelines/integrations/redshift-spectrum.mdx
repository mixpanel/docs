---
sidebarTitle: Redshift Spectrum
...
<Frame>
  ![image](/images/dad7fe54-caf6-4952-bedc-90da7a4650da.png)
</Frame>
...
<Frame>
  ![image](/images/230698403-de71ee8f-03c2-4528-abd7-94be5a5d1e30.png)
</Frame>
...
<Warning>
  If your Glue Data Catalog is governed by [AWS Lake Formation](https://docs.aws.amazon.com/lake-formation/latest/dg/what-is-lake-formation.html), the IAM permissions above are not sufficient on their own. Lake Formation enforces its own permission layer, so you'll also need to grant the Mixpanel Glue role permissions inside Lake Formation: `CREATE_TABLE` on the Glue **database**, plus a **Data location** permission on your registered S3 export path. Grant these at the database and data-location level, not only on the table. Mixpanel may drop and recreate the Glue table (for example, after a transient error), which discards any table-level grants; without database-level grants, recreation fails with `AccessDeniedException: Insufficient Lake Formation permission(s)` and exports stop while the pipeline still shows as active.
</Warning>
...
<Frame>
  ![image](/images/48198342-27dc-43b1-bab8-434b31f97e34.png)
</Frame>

<Frame>
  ![image](/images/0867f1d8-3649-4f9e-b0d2-9a3b73cfbe97.png)
</Frame>
