---
title: Snowflake
description: "Export Mixpanel data into a Snowflake dataset with JSON Pipelines, including role setup, storage integration, and IP restrictions"
---
...
Refer to [Step 2: Creating the Pipeline](/docs/data-pipelines/#step-2-creating-the-pipeline) to create a data pipeline via the UI.
