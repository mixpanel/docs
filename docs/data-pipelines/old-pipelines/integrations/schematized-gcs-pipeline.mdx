...
description: "Export schematized, transformed Mixpanel data to a Google Cloud Storage bucket via the Data Pipelines API"
---
...
To set up a schematized export pipeline to Google Cloud Storage (GCS) from Mixpanel, you must configure GCS to receive the exported data, then [create a pipeline](/reference/create-warehouse-pipeline) to export the data.
