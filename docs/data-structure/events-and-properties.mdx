...
title: "Events"
description: "Events are the core of Mixpanel's data model. Learn how to structure events, attach properties, and capture meaningful user actions for analysis."
---
