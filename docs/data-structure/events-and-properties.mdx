...
For more information about events refer to the documentation on [The Mixpanel Data Model](/guides/mixpanel-introduction#mixpanel-data-model).
...
> **Tip:** Learn more best practices around defining your events and properties under our tutorials for [Creating a Tracking Plan](/docs/tracking-best-practices/tracking-plan#tracking-plan-methodology).
...
We also have a soft limit of 5000 distinct event properties per project. If you send more distinct properties, we'll still ingest them, but those properties will not be indexed and will not appear in our autocomplete menus.
