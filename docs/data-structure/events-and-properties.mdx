...
We also have a soft limit of 2000 distinct event properties. If you send more distinct properties, we'll still ingest them, but those properties will not be indexed and will not appear in our autocomplete menus.
