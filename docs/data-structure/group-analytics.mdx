...
<Warning>
  You cannot migrate a project between the independent and hierarchical models after the project has been created. Choose the model that matches your data before you start sending events.
</Warning>
