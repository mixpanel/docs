...
<Warning>
  You cannot migrate a Standard project to Hierarchical (or vice versa) after the project has been created. Choose the model that matches your data before you start sending events.
</Warning>
...
To use these features, you must [designate the group key as a company key when setting up the group](/docs/data-structure/group-analytics/standard-group-analytics#setup-b2b-company-key).
...
Note: This is only available if you have [set up a B2B Company Key](/docs/data-structure/group-analytics/standard-group-analytics#setup-b2b-company-key), an option available in the Group Analytics package.
