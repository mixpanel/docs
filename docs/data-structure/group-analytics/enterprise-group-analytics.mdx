...
You can define a maximum of 3 or 6 group keys per project depending on your plan. Events can carry values for multiple group IDs and keys simultaneously.
