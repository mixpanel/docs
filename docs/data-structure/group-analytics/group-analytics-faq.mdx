---
sidebarTitle: FAQ
title: Group Analytics FAQ
description: "Group Analytics limits, why events go missing from groups, using groups in reports, exporting group profiles via API, and B2B Company Analytics"
---
...
Use the [Engage API endpoint](/reference/engage-query) to export Group Profiles by adding `data_group_id` in the `data` param of the request.
