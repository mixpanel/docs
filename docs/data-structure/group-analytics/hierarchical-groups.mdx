...
**This is a project-creation-time decision.** You cannot convert an existing standard project to Group Analytics, and you cannot remove Group Analytics from a project once enabled. Choose your model before sending any data. Existing projects would need to have their data migrated to a *new* hierarchical project to work on this system.
...
3. **Map the column containing your user-level identifier** to **User ID**. This mapping is **required** for Group Analytics projects (it is optional in standard projects).
...
#### Can I start with a standard project and switch to Group Analytics later?
