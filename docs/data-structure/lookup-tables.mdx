...
title: "Lookup Tables: Enrich ingested data using a CSV"
---
...
We also provide an [API](/reference/replace-lookup-table) and [Warehouse Connectors](/docs/tracking-methods/data-warehouse#lookup-tables) to keep Lookup Tables synced on a recurring basis.
...
Lookup Tables can be replaced with a fresh copy, either via our UI, [API](/reference/replace-lookup-table), or [Warehouse Connectors](/docs/tracking-methods/data-warehouse#lookup-tables).
