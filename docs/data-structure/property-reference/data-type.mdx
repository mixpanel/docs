---
title: Supported Properties Data Type
description: "The property data types Mixpanel supports (string, numeric, boolean, date, list, object, list of objects) and how each behaves in reports"
---
...
- Timestamps are ingested with [millisecond precision](/changelogs/2022-11-07-millisecond), but exported with second precision.
...
<Frame>
  ![/breakdown\_by\_date.gif](/images/breakdown_by_date.gif)
</Frame>
...
- Note: Editing of list properties is not supported directly within the Mixpanel UI. To modify list properties, you must use the [Mixpanel API](/reference/profile-set) or one of our SDKs.
...
<Frame>
  ![list computed properties](/images/list-computed-properties.png)
</Frame>
...
<Frame>
  ![image](/images/1a2465e1-da8d-4fe4-937a-5753716129b3.png)
</Frame>

3. Directly exclude undefined or null values from an Insights visualization by hitting the exclude action:

<Frame>
  ![image](/images/4d010827-cc4e-4a11-9716-cd3bfbaebadd.png)
</Frame>
