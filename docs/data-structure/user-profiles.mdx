...
For more information about user profiles refer to the documentation on [The Mixpanel Data Model](/guides/mixpanel-introduction#mixpanel-data-model).
...
You can get an overview of how Group Profiles relate to Mixpanel's Data Model under the section [Group Level Behaviors and Demographics](/docs/data-structure/group-analytics) in our tutorials. A more detailed explanation of [Group Profiles](/docs/data-structure/group-analytics#group-profiles) is documented under our [Group Analytics](/docs/data-structure/group-analytics) page.
