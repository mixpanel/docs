...
Experiments is available on all Mixpanel plans. Each plan includes a set amount of usage, measured in Monthly Experiment Users (MEU) — users exposed to an experiment in a calendar month. See our [pricing page](https://mixpanel.com/pricing/) for more details.

| Plan | Included Usage | How to Get More |
| --- | --- | --- |
| Free | 1k MEU per month, unlimited experiments | Upgrade to a Growth plan via the [pricing page](https://mixpanel.com/pricing/). |
| Growth | 5k MEU per month, unlimited experiments | Purchase additional MEU (up to 100k per month) by selecting **Upgrade Plan** under Organization Settings > Plan Details & Billing, adding Experiments to your plan, and checking out. |
| Enterprise | 3 created experiments | Purchase the Experiments add-on for unlimited experiments — [contact us](https://mixpanel.com/contact-us/sales/) or reach out to your account team. |

On the Free plan, once you pass your included MEU in a calendar month, experiment metrics stop being computed for the remainder of the month; your feature flags continue to serve and route traffic. On Growth and Enterprise plans, usage beyond your included or purchased MEU is billed at an overage rate.

<Note>
    Experiment creation is irreversible — experiments cannot be deleted.
</Note>

Every Experiments plan includes usage of [Feature Flags](/docs/featureflags), with limits on active flags and cohort targeting that vary by plan. See [Feature Flags plan availability](/docs/featureflags#plan-availability) for details.
...
On the Free plan, experiment metrics stop being computed for the remainder of the calendar month; your feature flags continue to serve and route traffic. On Growth and Enterprise plans, you can continue using Experiments, and usage beyond your included or purchased MEU is billed at an overage rate. Growth plans can purchase up to 100k MEU per month; for more, [contact us](https://mixpanel.com/contact-us/sales/) about an Enterprise plan.

#### Can I analyze experiments prior to my Experiments purchase date?
No. If you purchase additional Experiments volume, you can only analyze experiments starting from your purchase date. This means that the date used in your experiment cannot start prior to the purchase date.
