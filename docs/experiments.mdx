...
Mixpanel Experiments measures how a change affects your metrics, so you can decide which variant to roll out. Because your product analytics data already lives in Mixpanel, you can evaluate results against the metrics you already track.

## Plan Availability

Experiments is available for customers on Free, Growth, and Enterprise plans. Usage is measured in Monthly Experiment Users (MEU): the number of distinct users exposed to an experiment during a calendar month. A user exposed to three experiments in one month counts as one MEU, not three. MEU and experiment counts apply across your whole organization unless noted. See our [pricing page](https://mixpanel.com/pricing/) for more details.
...
<Warning>
  On an Enterprise plan without purchased Experiments, creating an experiment is irreversible: each of your 3 experiments per project is consumed permanently and cannot be recovered from the UI.
</Warning>
