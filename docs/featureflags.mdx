---
title: "Feature Flags: Rollout with precision control"
...
Yes. Both these are separate add-ons to ensure we're compatible with your tech stack. So, if you are also looking to analyze experiments, please check our \[experimentation offering.\] ([https://docs.mixpanel.com/docs/experiments](https://docs.mixpanel.com/docs/experiments))
