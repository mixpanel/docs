...
| --- | --- | --- | --- |
| Free | Up to 10 flags simultaneously enabled | Cohorts up to 100k users, in one rollout group | Switch plans from the [pricing page](https://mixpanel.com/pricing/). |
| Growth | Up to 50 flags simultaneously enabled, or 500 with purchased Experiments volume | Cohorts up to 20M users | Purchase Experiments volume under Organization Settings > Plan Details & Billing. |
| Enterprise | Up to 3 flags created, or 500 simultaneously enabled with purchased Experiments | Cohorts up to 20M users | Purchase Experiments to raise your limit to 500 active flags — [contact us](https://mixpanel.com/contact-us/sales/) or reach out to your account team. |

The Enterprise allowance of up to 3 flags created is the default trial amount for evaluating Feature Flags; purchasing Experiments removes this limitation. Contact us to inquire about an unlimited usage Enterprise trial.
