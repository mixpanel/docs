...
Feature Flags is available on all Mixpanel plans as part of [Experiments](/docs/experiments). Each plan includes a set number of active flags — flags that are marked Enabled at the same time — with no limit on API requests. See our [pricing page](https://mixpanel.com/pricing/) for more details.

| Plan | Active Flags | Cohort Targeting | How to Get More |
| --- | --- | --- | --- |
| Free | 10 | 1 rollout group with cohort targeting conditions; cohorts up to 100k users | Upgrade to a Growth plan via the [pricing page](https://mixpanel.com/pricing/). |
| Growth | 50 (500 with purchased Experiments volume) | Cohorts up to 20 million users | Purchase additional Experiments volume by selecting **Upgrade Plan** under Organization Settings > Plan Details & Billing. |
| Enterprise | 3 (500 with the Experiments add-on) | Cohorts up to 20 million users | [Contact us](https://mixpanel.com/contact-us/sales/) or reach out to your account team. |

Standalone Feature Flags without Experiments is available to Enterprise plan customers — [contact us](https://mixpanel.com/contact-us/sales/) for details.
  ...
  <Step title="Rollout Groups">
    ...
    **Group Cohort Targeting**
    ...
    <Note>
      ...
      - Free plans can use cohort targeting conditions in 1 rollout group, and cannot save cohorts.
    </Note>
...
Feature Flags is included with [Experiments](/docs/experiments) on every Mixpanel plan. Usage is limited by the number of active flags and the maximum cohort size for targeting — see [Plan Availability](#plan-availability). API requests are unlimited on all plans.
...
No more flags will be fetched as part of the API request until you disable some others or upgrade your plan. If you are at your limit, the flags fetched are the first ones based on the 'start' date, up to your limit.
...
Standalone Feature Flags is available to Enterprise plan customers. Please [contact us](https://mixpanel.com/contact-us/sales/) for more details.
