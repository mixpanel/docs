...
<Steps>
  ...
  <Step title="Runtime Targeting">
    ...
    **Filter by Runtime Property**
    ...
    | **Number** | A number, e.g. `42` | Numeric comparison. | <ul><li>Is</li><li>Is not</li><li>Greater than</li><li>Greater than or equal to</li><li>Less than</li><li>Less than or equal to</li></ul> |
