...
<Steps>
  ...
  <Step title="Runtime Targeting">
    ...
    **Filter by Runtime Property**
    ...
    | --- | --- | --- | --- |
    | **String** | A string, e.g. `"enterprise"` | Case-insensitive text match. | <ul><li>Is</li><li>Is not</li><li>Contains</li><li>In</li></ul>Ordered comparisons below compare strings in lexicographical order (by character), not numerically:<ul><li>Greater than</li><li>Greater than or equal to</li><li>Less than</li><li>Less than or equal to</li></ul> |
    ...
    | **Fuzzy** | Any value | Case-insensitive loose match that coerces across types before comparing, so `"5"` matches `5` and `"1"` matches `true`. | <ul><li>Is (only)</li></ul> |
