...
The Enterprise allowance of up to 3 flags created is the default Enterprise trial amount for evaluating Feature Flags; purchasing Experiments removes this limitation. Contact us to inquire about an unlimited usage Enterprise trial.
