...
1. Open a saved report and click the **bell icon** in the report header.
   _Note: You won't be able to create an alert if the report has unsaved changes. Save your report before setting up an alert._
   If no alerts exist on the report, the modal will show _"No alerts for this report."_ Click **Create Alert** in the bottom right of the modal.
...
5. **Set your notification frequency.** Choose how often _at most_ you'll receive an alert — from hourly up to monthly.
   _Note:_
