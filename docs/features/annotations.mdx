---
title: Annotations
description: "Annotations add valuable context to your reports by linking notes to specific dates"
---
...
<Steps>
  <Step title="Open the Annotations side panel to create an annotation">
    Select the **Annotations** tab (above the query builder) and click the “\+” button to add a new annotation.

    <Frame>
      ![annotations2](/images/annotations2.png)
    </Frame>
  </Step>
  <Step title="Alternatively, you can create annotations from the bottom of a time-series Insights report">
    ...
    <Frame>
      ![annotations1](/images/annotations1.png)
    </Frame>
  ...
  <Step title="Select a date and time, then enter a description">
    Add one or more tags to categorize the annotation.

    <Frame>
      ![annotations3](/images/annotations3.png)
    </Frame>
...
<Frame>
  ![annotations4](/images/annotations4.png)
</Frame>
...
<Frame>
  ![annotations5](/images/annotations5.png)
</Frame>
...
<Frame>
  ![annotations7](/images/annotations7.png)
</Frame>
...
<Frame>
  ![annotations6](/images/annotations6.png)
</Frame>
