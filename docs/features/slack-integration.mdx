...
To send an alert to a Slack Channel, see [Custom Alerts](/docs/features/alerts). To set up a board subscription to a Slack Channel, see [Advanced Board Functionality - Subscriptions](/docs/boards#board-subscriptions).
...
<Frame>
  ![/Screen\_Shot\_2020-06-15\_at\_10.41.00\_PM.png](/images/Screen_Shot_2020-06-15_at_10.41.00_PM.png)
</Frame>

After clicking allow, you'll return to Mixpanel, where you'll see a success banner:

<Frame>
  ![/Screen\_Shot\_2020-06-15\_at\_10.42.06\_PM.png](/images/Screen_Shot_2020-06-15_at_10.42.06_PM.png)
</Frame>
...
<Frame>
  ![/slack\_app\_demo.png](/images/slack_app_demo.png)
</Frame>
