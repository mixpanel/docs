...
| **Experiments** | `List-Experiments` | List and search experiments in a project |
...
| **Feature Flags** | `List-Feature-Flags` | List and search feature flags in a project |
...
<Warning>
  Audience targeting and cohort editing are not yet supported via MCP — use the Mixpanel UI instead.
</Warning>
