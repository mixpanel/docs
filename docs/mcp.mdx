...
description: "Hosted Model Context Protocol server that gives AI assistants access to your Mixpanel data"
---
...
1. Go to **Plugins** and add a new plugin — set the [MCP Server URL](#mcp-server-urls) to your regional endpoint and Authentication to **OAuth**
