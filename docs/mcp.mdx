...
**Note:** If your workspace is in the **EU or IN region** **and** you want to publish a custom plugin to your workspace for teammates to use, you must first enable **Developer Mode**.
