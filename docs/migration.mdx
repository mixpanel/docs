...
- If you have a data warehouse: Leverage our [data warehouse connector](/docs/tracking-methods/warehouse-connectors) or our [Import API](/reference/import-events) to import to Mixpanel.
...
- Have your Mixpanel champion or owner first set up your [Organization settings](/docs/orgs-and-projects/managing-projects#mixpanel-organization) and [Project settings](/docs/orgs-and-projects/managing-projects#mixpanel-projects). This will ensure the right access level for your team and enable you to prepare the workspace for ingesting data. This can be done later but doing it up front will allow for you to set key settings for data ingestion (US vs EU servers, project timezone, etc.).
