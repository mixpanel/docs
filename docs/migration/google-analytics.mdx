...
description: "Migrate from Google Analytics 4 to Mixpanel, including loading historical GA4 data through the BigQuery warehouse connector"
---
...
<Frame>
  ![image](/images/ga4_event_validation.png)
</Frame>
...
- For any other implementation method
  ...
  - Leverage our [Import API](/reference/import-events) to send us the formatted events from your data warehouse
