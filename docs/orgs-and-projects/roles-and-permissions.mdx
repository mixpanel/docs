...
<Frame>
  ![image](/images/Add_Org_Users.png)
</Frame>
...
<Frame>
  ![image](/images/Bulk_Invite_Org_Users.png)
</Frame>
...
<Frame>
  ![image](/images/Add_Proj_Users.png)
</Frame>
...
<Frame>
  ![image](/images/Add_All_Users_In_Org.png)
</Frame>
...
Owners and Admins can update the role of an existing user at any time. You can only assign a role at or below your own permission level.

#### Change an Organization Role

To change a user's organization role:

1. Under "Organization Settings", click **Users & Teams** and you will land on the Users tab.
2. Find the user's account in the list and click their name.
3. Next to **Organization Role**, click the edit (pencil) icon, select the new role from the dropdown, and click **Save**.

<Note>
  Only an Owner can assign the Owner role; Admins can assign roles up to Admin. See [Organization Roles](#organization-roles) for what each role can do.
</Note>

#### Change a Project Role

To change a user's project role:

1. Under "Project Settings", click **Project Users** to open the **Current Users** tab.
2. Find the user in the list and click the **Role** dropdown in their row.
3. Select the new role from the dropdown.

<Note>
  See [Project Roles](#project-roles) for what each role can do.
</Note>
...
<Frame>
  ![image](/images/Del_Org_Users.png)
</Frame>
...
<Frame>
  ![image](/images/Del_Proj_Users.png)
</Frame>
...
| Add/Invite/Remove Users to Org/Projects | ✅ | ✅ | ❌ | ❌ |
| Add/Modify/Remove Service Accounts to Org/Projects | ✅ | ✅ | ❌ | ❌ |
| Modify Roles - Org Level | ✅ | ✅ | ❌ | ❌ |
| Modify Roles - Make Self Owner | ✅ | ❌ | ❌ | ❌ |
...
| **Project Roles** | **Owner** | **Admin** | **Analyst** | **Consumer** |
| --- | --- | --- | --- | --- |
| Create/View Insights Reports | ✅ | ✅ | ✅ | ✅ |
| Create/View Flows Reports | ✅ | ✅ | ✅ | ✅ |
| Create/View Funnels Reports | ✅ | ✅ | ✅ | ✅ |
| Create/View Retention Reports | ✅ | ✅ | ✅ | ✅ |
| Download Reports | ✅ | ✅ | ✅ | ❌ |
...
| Edit Subscriptions for Boards | ✅ | Only Creator | Only Creator | Only Creator |
| Create/Edit Custom Events | ✅ | ✅ | ✅ | ✅ Only for self |
| Create/Edit Saved Behaviors | ✅ | ✅ | ✅ | ✅ Only for self |
| Create/Edit Saved Formulas | ✅ | ✅ | ✅ | ✅ Only for self |
| Create/Edit Custom Properties | ✅ | ✅ | ✅ | ✅ Only for self |
| Create/Edit Borrowed Properties | ✅ | ✅ | ❌ | ❌ |
| Upload a Lookup Table | ✅ | ✅ | ✅ | ✅ |
| Map Property to Lookup Table | ✅ | ✅ | ❌ | ❌ |
...
- Duplicate another user's Board and edit it.
- Edit reports and Boards on which they have been added as an editor. However, they cannot change the sharing settings of these reports and Boards.
- Cannot create public Boards.

Boards created by Project Consumers will not be surfaced to other users in Mixpanel. Project Consumers also cannot manage project user roles.
...
[Service Accounts](/reference/service-accounts) can also be added to teams, similar to how you would add a user to teams.

### Managing Team Permission

<Frame>
  ![image](/images/Manage_Team.png)
</Frame>
...
<Frame>
  ![create\_custom\_role](/images/create_custom_role.png)
</Frame>
