...
description: "Use Mixpanel for free for the first year"
---
...
The Startup Plan gives you every advanced report, plus four add-on packages: [Data Pipelines](/docs/data-pipelines/), [Group Analytics](/docs/data-structure/group-analytics), [Warehouse Connectors](/docs/tracking-methods/warehouse-connectors), and [Session Replay](/docs/session-replay).

It runs for 12 months and includes:
- 1 billion events per year
- 500,000 Session Replay recordings
- [Experiments](/docs/experiments), with 1.2M MEUs per year
- [Feature Flags](/docs/featureflags), with 50 flags and 120M Feature Flags API requests per year

The plan is available only to participants in the Mixpanel for Startups program, and it doesn't support BAAs or MSAs.
