...
description: "Mixpanel believes in respecting and protecting people’s fundamental online privacy and data rights"
---
...
You may process and store your customers' personal data in India via our [India Data Residency Program](/docs/privacy/in-residency). Contact your Mixpanel account manager to learn more about enabling India Data Residency for your account.
...
[Mixpanel deletion and retrieval APIs](/reference/gdpr-api) are in place to help Mixpanel implementations meet the requirements outlined by the General Data Protection Regulation (GDPR) legislation.
