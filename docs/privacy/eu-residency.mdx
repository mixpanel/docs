...
<Warning>
  No data will be ingested into your EU Data Residency project unless your SDK is sending data to the EU URL endpoint. Ensure you are using the EU URL endpoint in your SDK configuration. 

  For EU Projects created before August 18, 2025, US-to-EU Data Forwarding ended in July 2026 for the majority of projects. See [changelog here](/changelogs#deprecation-notice-legacy-us-to-eu-data-forwarding-ends-july-2026-for-eu-projects).
</Warning>
