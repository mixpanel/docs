...
<Warning>
  ...
  For most EU Projects created before August 18, 2025, US-to-EU Data Forwarding ended in July 2026. **Please ensure your implementation is updated to point to Mixpanel’s EU Servers** `api-eu.mixpanel.com`. See [changelog here](/changelogs#deprecation-notice-legacy-us-to-eu-data-forwarding-ends-july-2026-for-eu-projects).
</Warning>
