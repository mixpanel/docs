...
<Warning>
  Important: No data will be ingested into your EU Data Residency project unless your SDK is sending data to the EU URL endpoint. Ensure you are using the EU URL endpoint in your SDK configuration. 

  For EU Projects created before August 18, 2025, US-to-EU Data Forwarding ended in July 2026 for majority of projects. See [changelog here](/changelogs#deprecation-notice-legacy-us-to-eu-data-forwarding-ends-july-2026-for-eu-projects).
</Warning>
...
| --- | --- | --- |
| [Ingestion API](/reference/ingestion-api) | `api.mixpanel.com` | `api-eu.mixpanel.com` |
| [Query API](/reference/query-api) | `mixpanel.com/api` | `eu.mixpanel.com/api` |
| [Raw Data Export API](/reference/raw-data-export-api) | `data.mixpanel.com/api/2.0/export` | `data-eu.mixpanel.com/api/2.0/export` |
