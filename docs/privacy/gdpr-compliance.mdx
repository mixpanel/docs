...
description: "How Mixpanel supports GDPR data subject rights, including access, erasure, objection, and its data retention policy"
---
...
Section 2. User data is retained for the duration of an active Subscription Plan. Customers are given the ability to delete profiles using the [Engage API](/reference/delete-profile).
