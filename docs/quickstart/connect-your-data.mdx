...
<Tabs>
  ...
  <Tab>
    ...
    **Carthage** Add `github "mixpanel/mixpanel-iphone"` to your Cartfile.
  </Tab>
  <Tab>
    ...
    **Carthage** Add `github "mixpanel/mixpanel-swift"` to your Cartfile.
  </Tab>
  <Tab>
...
<Accordion title="How do I connect events from logged out vs logged in users?">
  ...
  If tracking server-side, check out our [server-side best practices guide](/docs/tracking-best-practices/server-side-best-practices). For more information, read our comprehensive guide on [Identifying Users](/docs/tracking-methods/id-management/identifying-users-simplified).
</Accordion>
