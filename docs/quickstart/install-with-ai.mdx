...
description: "The Mixpanel Implementation Skill installs Mixpanel into your project through your AI coding agent"
---
...
4. **Copy your Project Token** from the Access Keys section. It's a long string of letters and numbers. _Note: You'll need to be an Admin or Owner in your project._
...
- Browse the [Mixpanel documentation](/).
