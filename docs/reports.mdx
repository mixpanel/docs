...
This option allows you to select a date range that will update dynamically to fit the current interval - you can choose "Day", "Week", "Month", "Quarter", and "Year". When the boundary of the interval is passed, the date range will automatically update to include only the current interval. For example, if "Month" was selected, and the date was February 27, the date range would include Feb 1 - Feb 27. The next week, after the month boundary has passed, the date range would include Mar 1 - Mar 4. "Period to date" respects the start of the week and start of quarter settings under Project Settings.
