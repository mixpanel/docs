...
All dates and times in Mixpanel reflect the project timezone. The default for most reports is “Last 30 days” (displayed as "30D"), but there are a variety of preset options, as well as the option to select a custom date range.
