...
title: Funnels FAQ
sidebarTitle: FAQ
description: "Answers to common Funnels questions, including ID merge delays in conversion, loose step ordering, Funnels vs Insights counts, and breakdown segment limits"
---
