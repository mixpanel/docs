...
<Frame>
  ![Insights Overview Image](/images/overview.png)
</Frame>
...
Insights can be accessed from the left-side navigation by clicking the '\+ Create New' button.
...
<Frame>
  <iframe src="https://www.youtube-nocookie.com/embed/Popsy5G4i54" frameBorder="0" webkitallowfullscreen="true" mozallowfullscreen="true" allowFullScreen />
</Frame>
...
<Frame>
  ![Choose Events](/images/choose-events.png)
</Frame>
...
<Frame>
  ![Choose Measurement](/images/choose-measurement.png)
</Frame>
...
<Frame>
  ![Choose Filters](/images/choose-filters.png)
</Frame>
...
- **Global filter (whole report):** Click the **Filter** button at the top of the report. The filter applies to every metric in the report.

See [Filters](/docs/reports#filters) for more on the two scopes.
...
<Frame>
  ![Choose Breakdowns](/images/choose-breakdowns.png)
</Frame>
...
<Frame>
  ![Change Visualization](/images/change-visualization.png)
</Frame>
...
<Frame>
  ![Insights Saved Behaviors](/images/insights-saved-behavior.png)
</Frame>
...
<Frame>
  ![Sorting Bar Chart](/images/sorting-bar-chart.png)
</Frame>
...
<Frame>
  ![Sorting Line Chart](/images/sorting-line-chart-1.png)
</Frame>
...
<Frame>
  ![Sorting Line Chart](/images/sorting-line-chart-2.gif)
</Frame>

Clicking on the "Average" data column performs a flat sort across all segments:

<Frame>
  ![Sorting Line Chart](/images/sorting-line-chart-3.png)
</Frame>
...
<Frame>
  ![Sorting.gif](/images/a61948a6-3e4a-4e5d-9b75-3f4b14cb1450.gif)
</Frame>
...
<Frame>
  ![image](/images/e57400a1-a86c-4d46-9ffb-379306586d8d.png)
</Frame>
...
<Frame>
  ![image](/images/2a72e93c-c332-4418-83e1-91bb24e2d271.png)
</Frame>
...
<Frame>
  ![image](/images/4697ce00-d394-46ce-b538-66ec91ccd6e7.png)
</Frame>
...
<Frame>
  ![image](/images/3d6556a4-9468-4d1f-8979-4fdb512f2aaa.png)
</Frame>
...
<Frame>
  ![image](/images/ee7d8c9b-f738-4a5b-8967-300cf8322f76.png)
</Frame>
...
<Frame>
  ![image](/images/dynamic_segments.png)
</Frame>

When using Dynamic Segments, you can select the number of segments to display from the column headers.

<Frame>
  ![View\_N\_gif](/images/4fb0fd18-2ef7-416b-adaa-c7299da0f7b3.gif)
</Frame>

In the ungrouped view, choose the number of rows to display:

<Frame>
  ![image](/images/b1b25b19-51be-4934-bbfd-7562e0f98d4a.png)
</Frame>

In the grouped view, you can choose the number of rows you want to display for each breakdown:

<Frame>
  ![image](/images/f9f8c83c-34ed-44bd-b4e7-f60b70255a6f.png)
</Frame>

<Frame>
  ![image](/images/b09c1ad1-1392-4ec0-9358-361f677c600d.png)
</Frame>
...
<Frame>
  ![Formulas 1](/images/advanced-formulas-1.png)
</Frame>
...
<Frame>
  ![saveformula.gif](/images/saveformula.png)
</Frame>
...
To access and re-use saved formulas, click on “\+Formula”, and then see the list of saved formulas. You can also look at all the saved formulas in the Lexicon tab “Metrics”. Some callouts regarding permissions:
...
<Frame>
  ![Bucketing](/images/advanced-bucketing.png)
</Frame>
...
<Frame>
  ![Time Period Comparison](/images/advanced-time-period-comparison.gif)
</Frame>
...
<Frame>
  ![Value Setting](/images/advanced-value-comparison.png)
</Frame>
...
<Frame>
  ![Measurements 1](/images/advanced-data-functions-1.png)
</Frame>
...
<Frame>
  ![Measurements 2](/images/advanced-data-functions-2.png)
</Frame>
...
<Frame>
  ![Measurements 3](/images/advanced-data-functions-3.png)
</Frame>
...
- If the time interval is "Month": [https://mixpanel.com/s/3LC8ll](https://mixpanel.com/s/3LC8ll)
...
- If the time interval is "Day": [https://mixpanel.com/s/47YhnE](https://mixpanel.com/s/47YhnE)
...
- If the time interval is "Week": [https://mixpanel.com/s/dA5BK](https://mixpanel.com/s/dA5BK)
...
<Frame>
  ![image](/images/uniques_default.png)
</Frame>
...
<Frame>
  ![image](/images/uniques_count_once.png)
</Frame>
...
<Frame>
  <img
    src="/images/reports_view_events.gif"
    alt="Reports View Events"
    title="Reports View Events"
    className="mx-auto"
  />
</Frame>
...
<Frame>
  ![Reports View Sample Events](/images/reports_view_sample_events.gif)
</Frame>
