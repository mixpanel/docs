---
title: "Retention: Measure engagement over time"
...
<Frame>
  ![/Screen\_Shot\_2021-05-27\_at\_7.49.12\_AM.png](/images/Screen_Shot_2021-05-27_at_7.49.12_AM.png)
</Frame>
...
Retention can be accessed from the left-side navigation by clicking the '\+ Create New' button.

<Note>
  The Retention report is available on all free and paid subscription plans.
</Note>
...
<Frame>
  <iframe src="https://www.youtube-nocookie.com/embed/W8yqLYuSIaU" frameBorder="0" webkitallowfullscreen="true" mozallowfullscreen="true" allowFullScreen />
</Frame>
...
<Frame>
  ![/retention\_beta\_1.png](/images/retention_beta_1.png)
</Frame>
...
After your retention behavior is defined, you can choose how you want to measure it. By default, the Retention report will select retention rate as the measurement.
...
<Frame>
  ![/Updated\_retention\_measurements.png](/images/Updated_retention_measurements.png)
</Frame>
...
<Frame>
  ![/Retention\_Filter.png](/images/Retention_Filter.png)
</Frame>
...
<Frame>
  ![/Retention\_Breakdown.png](/images/Retention_Breakdown.png)
</Frame>
...
<Frame>
  ![/retention\_beta\_5.png](/images/retention_beta_5.png)
</Frame>
...
<Frame>
  <iframe src="https://www.youtube-nocookie.com/embed/iYAKsmgqWZU" frameBorder="0" webkitallowfullscreen="true" mozallowfullscreen="true" allowFullScreen />
</Frame>
...
<Frame>
  ![/Retention Line Chart](/images/Retention_Trend.png)
</Frame>
...
<Frame>
  ![/Updated\_retention\_criteria.png](/images/Updated_retention_criteria.png)
</Frame>
...
<Frame>
  <iframe src="https://www.youtube-nocookie.com/embed/zTkQVsMgPc0" frameBorder="0" webkitallowfullscreen="true" mozallowfullscreen="true" allowFullScreen />
</Frame>
...
<Frame>
  ![Retention 7 30](/images/Retention_7_30.png)
</Frame>
...
<Frame>
  ![Retention 3 3](/images/Retention_3_3.png)
</Frame>
...
<Frame>
  ![Setting Custom Buckets](/images/Retention_Setting_Custom.png)
</Frame>
...
You can go into the advanced menu under Retention Criteria to switch the retention mode from the default rolling time windows to calendar-defined time windows. This aligns the retention calculation so that all users entering within a time bucket get calculated together.

<Frame>
  ![/13599603833876.png](/images/13599603833876.png)
</Frame>
...
<Frame>
  ![/13599765981076.png](/images/13599765981076.png)
</Frame>
...
Select the "..." button in the top right corner of the metric, then click "Save Behavior".<br />Learn more about [Saved Metrics and Behaviors](/docs/features/saved-metrics-and-behaviors).

### Frequency View

<Frame>
  <iframe src="https://www.youtube-nocookie.com/embed/KWUJIXeH_SU" frameBorder="0" webkitallowfullscreen="true" mozallowfullscreen="true" allowFullScreen />
</Frame>
...
<Frame>
  ![/Screen\_Shot\_2022-07-05\_at\_4.41.04\_PM.png](/images/Screen_Shot_2022-07-05_at_4.41.04_PM.png)
</Frame>
...
**Cumulative Frequency**: calculates the number of users who did the event **in at least** X unique intervals. This shows overall engagement up to each frequency interval.
...
**1. Retention reports do not extend beyond 60 days. How can I look beyond the 60-day mark?**
...
<Frame>
  ![/intervalized\_retention.png](/images/intervalized_retention.png)
</Frame>
...
**4. What does the Metric view in the Retention Trends report show?**
