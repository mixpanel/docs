...
1. If you're logged in to Mixpanel, click on “Contact Support” in the Help Menu:
   <Frame>
     <img
       ...
       alt="Screenshot 2026 06 25 At 12 38 38 PM"
       title="Screenshot 2026 06 25 At 12 38 38 PM"
       className="mx-auto"
       style={{ width:"45%" }}
     />
   </Frame>
...
If you're logged into Mixpanel, you can access the AI Help Chat via the Help Menu. This allows you to open a ticket with Support (FRTs apply) or troubleshoot your issue with the AI Help Chat agent.
...
- [Mixpanel Status Page](https://www.mixpanelstatus.com/): Updates on Mixpanel incidents to view or subscribe