...
description: "Watch playbacks of user digital experiences"
---
...
- **Paid Session Replay Add-On**: UI Controls is available exclusively to customers who have purchased additional Session Replays beyond [the free Replay allowance](/docs/session-replay#plan-availability).
