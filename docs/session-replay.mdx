...
<CardGroup cols={3}>
  <Card title="Web" href="/docs/tracking-methods/sdks/javascript/javascript-replay" />
  <Card title="iOS" href="/docs/tracking-methods/sdks/swift/swift-replay" />
  <Card title="Android" href="/docs/tracking-methods/sdks/android/android-replay" />
  <Card title="React Native" href="/docs/tracking-methods/sdks/react-native/react-native-replay" />
</CardGroup>
...
<Frame>
![remoteSettingsGlobal](/images/remoteSettingsGlobal.png)
</Frame>
...
<Frame>
![remoteSettingsConditional](/images/remoteSettingsConditional.png)
</Frame>
...
<Frame>
![replayReportEntry](/images/sr_reports_entry_point.png)
</Frame>
...
<Frame>
![replayProfileEntry](/images/sr_users_entry_point.png)
</Frame>

## Watching Replays

<Frame>
![replayPlayer](/images/sr-player-apr-26-2.png)
</Frame>
...
<Frame>
![Save Playlist button](/images/save-playlist-button.png)
</Frame>
...
A web session replay is a continuous recording of a user's activity that ends after 30 minutes of inactivity (a new replay begins automatically when the user is active again) or once it reaches a maximum length of 24 hours, whichever comes first. On web, both thresholds are configurable via the `record_idle_timeout_ms` (default 30 minutes) and `record_max_ms` (default 24 hours) [JavaScript init options](/docs/tracking-methods/sdks/javascript/javascript-replay#init-options). For our mobile session replay SDKs, capture runs per app session and can be started or stopped manually. 
