...
Mixpanel Agent in Slack is available at no additional cost to existing Mixpanel customers, on request. We're rolling it out account-by-account during early access.
