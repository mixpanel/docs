---
sidebarTitle: Tracking Plan
title: Create A Tracking Plan
description: "Create a tracking plan for Mixpanel by defining and prioritizing KPIs, mapping them to user flows, and translating flows into events and properties"
---

<Note>
  Read the detailed [guide on creating a tracking plan](/guides/guides-by-workflow/build-tracking-strategy).
</Note>
