...
description: "Compare client-side and server-side tracking with Mixpanel SDKs, including the pros and cons of each and why Mixpanel recommends server-side"
---
