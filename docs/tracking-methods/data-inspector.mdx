---
title: Mixpanel Data Inspector
description: "Browser extension that shows events sent to Mixpanel from your web app in real time, with JSON payload inspection"
---
