...
<Note>
  First-Party Domains are available on the Enterprise plan and are currently in beta. Contact your Mixpanel account team to have them enabled for your organization. See our [pricing page](https://mixpanel.com/pricing/) for more details.
</Note>
...
| Availability | Enterprise, beta | Any plan |
...
- An Enterprise plan, with the First-Party Domains beta enabled for your organization.
