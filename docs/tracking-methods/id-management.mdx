...
Distinct ID is Mixpanel's identifier used to uniquely track a user in the system. Every event data and profile update sent to Mixpanel should have a distinct\_id property associated with it (except in the case of preventing [hot shards](/docs/tracking-best-practices/hot-shard-limits)). The Distinct ID value tells Mixpanel which user to attach your events and profile property updates.
...
<Frame>
  <img
    src="/images/no_id_management.png"
    alt="no_id_management"
    width="400"
  />
</Frame>
...
<Frame>
  ![with\_id\_management](/images/with_id_management.png)
</Frame>
...
<Frame>
  ![Untitled](/images/Tracking/id-merge-org-settings.png)
</Frame>
...
<Frame>
  ![Untitled](/images/Tracking/id-merge-project-settings.png)
</Frame>
...
If your project is not ID Merge enabled, please refer to [this documentation](https://github.com/mixpanel/docs-legacy/blob/main/legacy/aliases.md) for identity management using our legacy ID management version.
