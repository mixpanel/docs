...
description: "How Mixpanel identity management works: the Distinct ID, linking anonymous and identified activity, and differences between the Simplified and Original ID Merge APIs"
---
