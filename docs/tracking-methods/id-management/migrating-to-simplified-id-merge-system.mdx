...
description: "Decide whether to move from Legacy ID Management or Original ID Merge to Simplified ID Merge, then migrate data and reports into a new project"
---
