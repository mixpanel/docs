...
3. Continue to set up the new project by following the guide [here](/docs/orgs-and-projects/managing-projects). Configure the new project's settings by referring to your existing project’s settings. Some of the setup tasks may include:
