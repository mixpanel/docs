---
title: Kafka
description: "Route events from a Kafka topic into Mixpanel with a Python consumer for real-time analytics"
---
...
3. Replace 'YOUR\_MIXPANEL\_TOKEN' with your actual Mixpanel token.
4. Run the code.
