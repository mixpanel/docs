...
It's easy to integrate Mixpanel in CMS or E-Commerce sites with minimal code. Most approaches require adding our [Javascript snippet](/docs/quickstart/install-mixpanel), which will automatically track all pageviews, and then customizing with additional `.track()` calls to track custom events.
...
<CardGroup cols={3}>
  <Card title="Integration Guide" href="/docs/tracking-methods/integrations/shopify">
  </Card>
</CardGroup>
