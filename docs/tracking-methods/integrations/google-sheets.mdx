...
<Frame>
<img src="/images/gsheets-main-menu.png" alt="gsheets-main-menu" />
</Frame>
...
<Frame>
<img src="/images/gsheets-mapping.png" alt="gsheets-mapping" />
</Frame>
...
- **project_secret** (or [Service Account](/reference/service-accounts))
...
<Frame>
<img src="/images/gsheets-parse.gif" alt="gsheets-parse" />
</Frame>
...
- your [workspace_id](/reference/query-api-authentication#:~:text=Projects%20with%20Data,a%20request%20parameter.)
- [report_id](/reference/insights-query#:~:text=The%20ID%20of%20your%20Insights%20report%20can%20be%20found%20from%20the%20url%3A%20https%3A//mixpanel.com/report/1/insights%23report/%3CYOUR_BOOKMARK_ID%3E/example%2Dreport) OR [cohort_id](/reference/cohorts-list)
...
<Frame>
<img src="/images/gsheets-four-actions.png" alt="gsheets-four-actions" />
</Frame>
...
<Frame>
<img src="/images/gsheets-sync-now.png" alt="gsheets-sync-now" />
</Frame>
