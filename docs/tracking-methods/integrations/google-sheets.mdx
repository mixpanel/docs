---
title: Google Sheets
description: "Mixpanel has a native extension for Google Sheets that enables you to import CSV data to your Mixpanel project, and"
---
...
<Frame>
  ![gsheets-main-menu](/images/gsheets-main-menu.png)
</Frame>
...
<Frame>
  ![gsheets-mapping](/images/gsheets-mapping.png)
</Frame>
...
<Frame>
  ![gsheets-parse](/images/gsheets-parse.gif)
</Frame>
...
<Frame>
  ![gsheets-four-actions](/images/gsheets-four-actions.png)
</Frame>
...
<Frame>
  ![gsheets-sync-now](/images/gsheets-sync-now.png)
</Frame>
