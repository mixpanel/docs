---
title: mParticle
description: "Send event and audience data from mParticle to Mixpanel with the native integration, including schema requirements and setup steps"
---
...
| Project API Secret | `string` | none | Found in your Mixpanel project settings. This is required to forward Historical Data older than 5 days, which is sent to [Mixpanel's import API](/reference/import-events). |
...
<Frame>
  ![mparticle\_output\_mapping](/images/mparticle_output_mapping.png)
</Frame>
...
<Frame>
  ![live\_stream](/images/mparticle_live_stream.png)
</Frame>
...
<Frame>
  ![event\_forwarding](/images/mparticle_event_forwarding.png)
</Frame>
...
<Frame>
  ![Mixpanel Residency](/images/mixpanel_data_residency.png)
</Frame>

<Frame>
  ![mParticle Residency](/images/mparticle_data_residency.png)
</Frame>
