...
Lastly, track your users' actions using [Segment's track API call](https://segment.com/docs/connections/spec/track/), which would trigger [Mixpanel's import API](/reference/import-events) and ingest an event in your project.
...
<Frame>
![segment_catalog](/images/segment_catalog_destination.png)
</Frame>

2. Select a Segment source to stream to the destination.

<Frame>
![segment_source](/images/segment_source.png)
</Frame>
...
<Frame>
![segment_action_select](/images/segment_action_select.png)
</Frame>
...
<Frame>
![segment_enable_setting](/images/segment_enable_setting.png)
</Frame>
...
|-----------------------|-----------------------------------------------------|-----------------|
| Order Completed Calls | [Event type = "track"](https://segment.com/docs/connections/spec/track/) and event = "Order Completed"  | [Import Event](/reference/import-events) "Order Completed"  |
| Track Calls           | [Event type = "track"](https://segment.com/docs/connections/spec/track/) and event != "Order Completed" | [Import Event](/reference/import-events)     |
| Screen Calls          | [Event type = "screen"](https://segment.com/docs/connections/spec/screen/)                               | [Import Event](/reference/import-events) "Viewed \{name\}"     |
| Identify Calls        | [Event type = "identify"](https://segment.com/docs/connections/spec/identify/)                             | Identify User ([Simplified API](/docs/tracking-methods/id-management/identifying-users-simplified#user_id) /[Original API](/reference/create-identity)) and [Set Profile Properties](/reference/profile-set)   |
| Page Calls            | [Event type = "page"](https://segment.com/docs/connections/spec/page/)                                 | [Import Event](/reference/import-events) "Viewed \{name\}"    |
| Group Calls           | [Event type = "group"](https://segment.com/docs/connections/spec/group/)                                | [Identify Group](/reference/group-set-property)  |
...
<Frame>
![segment_condition](/images/segment_condition.png)
</Frame>
...
<Frame>
![segment_sample_payload](/images/segment_sample_payload.png)
</Frame>
...
<Frame>
![segment_mapping_name](/images/segment_mapping_name.png)
</Frame>
...
<Frame>
![segment_mapping_properties](/images/segment_mapping_properties.png)
</Frame>
...
<Note>
    ...
    <Frame>
    ![segment_mapping_properties_edit](/images/segment_mapping_properties_edit.png)
    </Frame>
</Note>    
...
<Frame>
![segment_test_event](/images/segment_test_event.png)
</Frame>
...
<Frame>
![1groupkey_projectsettings](/images/835de9fa-eea2-47b0-9965-4a922ebd39ab.gif)
</Frame>
...
<Frame>
![segment_group_mapping](/images/segment_group_mapping.png)
</Frame>
...
<Frame>
![4groupprofile](/images/b8b7ab18-4c65-4dff-965a-d532ae49cffc.png)
</Frame>
...
<Frame>
![5identify](/images/41cc54c4-2e52-4e77-833d-cc178d1fb107.png)
</Frame>
...
<Frame>
![6trackcall](/images/9609917d-f00b-4450-a9d5-7d77bd338f9d.png)
</Frame>
...
<Frame>
<img width="1080" alt="debugger screenshot" src="/images/6ee0bbcd-8bf2-4f86-83a7-b0a3c39108e4.png" />
</Frame>
...
<Frame>
![pasted image 0 (1)](/images/0344decc-dc96-4569-ac3d-cc530c63bdb3.png)
</Frame>
...
<Note>Note: In most cases, we do not recommend implementing Autocapture with Segment to minimize the risks of identity management issues. Please consult with a member of our team if you choose to use this approach.</Note>
...
<Note>Important: the following snippet includes options for both simplified and original identity merge; please comment out the method you are not using.</Note>
...
Mixpanel SDKs assign an [\$insert_id](/reference/import-events#propertiesinsert_id) to each tracked event.
...
<Frame>
![segment_page_name_mapping](/images/segment_page_name_mapping.png)
</Frame>
