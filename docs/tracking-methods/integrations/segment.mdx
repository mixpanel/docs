---
title: Segment
description: "Route Segment event data into Mixpanel using the Segment destination integration"
---
...
<Frame>
  ![segment\_catalog](/images/segment_catalog_destination.png)
</Frame>

2. Select a Segment source to stream to the destination.

<Frame>
  ![segment\_source](/images/segment_source.png)
</Frame>
...
<Frame>
  ![segment\_action\_select](/images/segment_action_select.png)
</Frame>
...
<Frame>
  ![segment\_enable\_setting](/images/segment_enable_setting.png)
</Frame>
...
<Frame>
  ![segment\_mapping](/images/segment_mapping.png)
</Frame>
...
<Frame>
  ![segment\_condition](/images/segment_condition.png)
</Frame>
...
<Frame>
  ![segment\_sample\_payload](/images/segment_sample_payload.png)
</Frame>
...
<Frame>
  ![segment\_mapping\_name](/images/segment_mapping_name.png)
</Frame>
...
<Frame>
  ![segment\_mapping\_properties](/images/segment_mapping_properties.png)
</Frame>
...
<Note>
  ...
  <Frame>
    ![segment\_mapping\_properties\_edit](/images/segment_mapping_properties_edit.png)
  </Frame>
</Note>
...
<Frame>
  ![segment\_test\_event](/images/segment_test_event.png)
</Frame>
...
<Frame>
  ![1groupkey\_projectsettings](/images/835de9fa-eea2-47b0-9965-4a922ebd39ab.gif)
</Frame>
...
<Frame>
  ![segment\_group\_mapping](/images/segment_group_mapping.png)
</Frame>
...
<Frame>
  <img
    width="1080"
    alt="debugger screenshot"
    src="/images/6ee0bbcd-8bf2-4f86-83a7-b0a3c39108e4.png"
  />
</Frame>
...
Mixpanel SDKs assign an [\$insert\_id](/reference/import-events#propertiesinsert_id) to each tracked event.
...
<Frame>
  ![segment\_page\_name\_mapping](/images/segment_page_name_mapping.png)
</Frame>
