---
title: Stripe
description: "Stream Stripe webhook events into Mixpanel through a Google Cloud Function that forwards them to the import API"
---
...
<Frame>
  ![](/images/stripe_cloud_functions_setup.png)
</Frame>
...
<Frame>
  ![](/images/stripe_cloud_functions_screenshot.png)
</Frame>
