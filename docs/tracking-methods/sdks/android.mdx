...
- **Verify with debug logging before you rely on the data.** Enable SDK logs, tap through your key flows, and confirm the `$el_id` values that appear are the ones you expect.
