---
sidebarTitle: Feature Flags (Android)
title: Implement Feature Flags (Android)
description: "Configure your Android app for Feature Flags using the Mixpanel Android SDK"
---
...
- You have the latest version of the SDK installed (minimum supported version is [`v8.2.4`](https://github.com/mixpanel/mixpanel-android/releases/tag/v8.2.4)). If not, please follow [this doc](/docs/quickstart/install-mixpanel) to install the SDK.
...
If any of these property filters use a **Date** or **Semantic Version** condition, as described in [Data types for runtime values](/docs/featureflags#data-types-for-runtime-values), ensure your SDK version meets the minimum supported: [`v8.11.0`](https://github.com/mixpanel/mixpanel-android/releases/tag/v8.11.0).
...
Lookup the assigned value for a feature flag. This action triggers tracking an exposure event, `$experiment_started` to your Mixpanel project _if_ the user context is in a rollout group for the feature flag.
