...
description: "Install and configure the Mixpanel Session Replay SDK for Android via Maven Central, including prerequisites, privacy best practices, and masking"
---
