...
**Date** and **Semantic Version** conditions, as described in [Data types for runtime values](/docs/featureflags#data-types-for-runtime-values), are not yet supported in runtime event property filters on this SDK.
