...
description: "Install and configure the Mixpanel Session Replay SDK for Flutter, including platform version requirements, privacy best practices, and masking"
---
