---
sidebarTitle: Feature Flags (Node.js)
title: Implement Feature Flags (Node.js)
---
...
- You have the [Mixpanel Node.js SDK](https://github.com/mixpanel/mixpanel-node) installed. If not, please follow [this doc](/docs/quickstart/install-mixpanel) to install the SDK. The minimum supported version is [v0.20.0](https://www.npmjs.com/package/mixpanel)
...
Minimum supported SDK version: [`v0.24.0`](https://www.npmjs.com/package/mixpanel)
