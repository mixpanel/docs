---
title: OpenFeature Provider (Node.js)
description: "Use Mixpanel Feature Flags through the OpenFeature standard with the Mixpanel Node.js OpenFeature provider"
---
