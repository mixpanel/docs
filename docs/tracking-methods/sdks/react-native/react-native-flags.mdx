...
description: "Configure your React Native app for Feature Flags using the Mixpanel SDK"
---
...
- You have the latest version of the SDK installed (minimum supported version is [`v3.5.0`](https://github.com/mixpanel/mixpanel-react-native/releases)). If not, install with `npm install mixpanel-react-native`.
...
If any of these property filters use a **Date** or **Semantic Version** condition, as described in [Data types for runtime values](/docs/featureflags#data-types-for-runtime-values), ensure your SDK version meets the minimum supported: [`v3.8.0`](https://github.com/mixpanel/mixpanel-react-native/releases/tag/v3.8.0).
