...
description: "Capture Session Replays in React Native apps on iOS and Android with Mixpanel's Turbo Module SDK, including requirements, sampling, and masking"
---
