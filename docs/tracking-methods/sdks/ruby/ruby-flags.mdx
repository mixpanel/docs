---
sidebarTitle: Feature Flags (Ruby)
title: Implement Feature Flags (Ruby)
description: "Configure your Ruby server for Feature Flags using the Mixpanel Ruby SDK"
---
...
- You have the [Mixpanel Ruby SDK](https://github.com/mixpanel/mixpanel-ruby) installed. If not, please follow [this doc](/docs/quickstart/install-mixpanel) to install the SDK. The minimum supported version is [v3.0.0](https://rubygems.org/gems/mixpanel-ruby)
...
### Local Evaluation Runtime Property Evaluation

Runtime property evaluation evaluates properties passed in the `custom_properties` node within the user context against target values defined in your feature flag. During Local Evaluation the SDK performs this comparison itself.

If any of these conditions use a **Date** or **Semantic Version** type, as described in [Data types for runtime values](/docs/featureflags#data-types-for-runtime-values), ensure your SDK version meets the minimum supported: [`v3.4.0`](https://github.com/mixpanel/mixpanel-ruby/releases/tag/v3.4.0).
