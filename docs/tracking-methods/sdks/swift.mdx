...
<span id="library-configuration"></span>
...
let mixpanel = Mixpanel.initialize(
    options: MixpanelOptions(token: "YOUR_TOKEN", proxyServerConfig: proxyConfig)
)
