...
3. Fill out the following fields, then click **Create Source**:
   ...
   - **Authentication** — Choose one of the following:
     ...
     - **Personal Access Token** — The service principal token from Option B above.
     - **OAuth Client ID** and **OAuth Client Secret** — The client credentials from Option A above.
