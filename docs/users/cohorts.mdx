...
title: "Cohorts"
description: "Group users by demographic and behavior"
---
...
<Frame>
  ![/cohort\_example\_1.gif](/images/cohort_example_1.gif)
</Frame>

**Filter to only users who watched a video for the very first time in the past 30 days**

<Frame>
  ![/cohort\_example\_2.gif](/images/cohort_example_2.gif)
</Frame>

**Chaining cohorts together using the AND/OR operators**

<Frame>
  ![/cohort\_example\_3.gif](/images/cohort_example_3.gif)
</Frame>
...
<Frame>
  ![cohort\_csv3.png](/images/cohort_csv3.png)
</Frame>
...
<Frame>
  ![cohort\_csv4.png](/images/cohort_csv4.png)
</Frame>
...
<Note>
  Customers on an Enterprise plan can access the Verified Data feature. See our [pricing page](https://mixpanel.com/pricing/) for more details.
</Note>

Cohorts can be verified to signal that they are trustworthy and ready for broad use across your team — for example, a shared definition of "Power Users" that your whole org can rely on. This makes it easier for teammates to discover the right cohort for their analysis and avoid duplicating definitions that already exist.

**How it Works**

1. Navigate to **Lexicon \> Cohorts**.
2. Select up to 100 cohorts using the checkboxes, then click **Verify**. You can also verify a single cohort from the **"..."** overflow menu, or by clicking the verified icon in the edit modal.
3. Verified cohorts display a badge in the Cohorts table (showing who verified it and when) and appear under a **Verified** section in query builders. You can also filter the Cohorts table by verification status.

To verify a cohort, you need verification permissions and edit access to that cohort. To un-verify, follow the same steps on an already-verified cohort.
...
The first way would be to create a Funnels report and click the respective segments in order to find the retained/dropped-off users. You can then click “View Users”, followed by “Create Cohort”. Here is a Funnels report to play with: [https://mixpanel.com/s/8JY6o](https://mixpanel.com/s/8JY6o)

The second way would be to use the Users page to create cohorts. For example, if you would like to find users who “watch video” and _then_ “like video”. You can create the cohort in the Users page. Here is the cohort for reference: [https://mixpanel.com/project/3187764/view/3699044/app/users#T9bjQw9kLb7c](https://mixpanel.com/project/3187764/view/3699044/app/users#T9bjQw9kLb7c)

If you would like to find those who have dropped off, you could switch “did” to “did not do”. Here is the cohort for reference: [https://mixpanel.com/project/3187764/view/3699044/app/users#Umm8E4JZxLSe](https://mixpanel.com/project/3187764/view/3699044/app/users#Umm8E4JZxLSe)
...
You can do so by using the “AND” operator. Here is a cohort for reference: [https://mixpanel.com/project/3187764/view/3699044/app/users#Tc76sqFRzbao](https://mixpanel.com/project/3187764/view/3699044/app/users#Tc76sqFRzbao)
...
### How do I create a cohort based on users who did the same event in different time intervals?

If you want to filter for users that have done an event on X time units within a given timeframe, you can filter for the event, change 'Total Events' to 'Aggregate Property --> Distinct Count', then select the property 'Time' and the time unit you wish to filter for. You can then indicate the number of time units and the time frame as needed. This will show you e.g. the number of users who did an event on 5 different days within the last 2 months.
