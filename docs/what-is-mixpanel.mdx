...
description: "An introduction to Mixpanel product analytics and its three core concepts: events, users, and properties"
---

import { ExtendedButton } from "/snippets/ExtendedButton/ExtendedButton.jsx";

TESTING Mixpanel will help you better understand your customers and answer questions about your product. It enables you to track how users engage with your product and analyze this data with interactive reports that let you query and visualize the results with just a few clicks.
