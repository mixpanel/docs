---
title: "What is Mixpanel? webeditortest"
---
...
Mixpanel is built on three key concepts: [**Events**](#events), [**Users**](#users), and [**Properties**](#properties). test
...
Now that you understand the basics, **we recommend planning the first events you would like to track**. This will help you understand what you need to get started. Choosing these events should take no more than a few minutes.
