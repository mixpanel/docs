...
<Callout icon="🚧" theme="warn">
  To ensure data ingests into your project, use the correct Ingestion API subdomain for your project's data residency. For more information, you can learn more about: [EU Residency](https://app.gitbook.com/s/qGpd1uH02qXOCsOiKqLX/privacy/eu-residency) and [IN Residency](https://app.gitbook.com/s/qGpd1uH02qXOCsOiKqLX/privacy/in-residency).
</Callout>
