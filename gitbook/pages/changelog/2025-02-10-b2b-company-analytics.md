...
To access the new features, customers will need the Group Analytics add-on. In addition, you will need to turn on the advanced B2B Account Analytics functionality, steps for which are [here](https://app.gitbook.com/s/qGpd1uH02qXOCsOiKqLX/data-structure/group-analytics#setup-b2b-company-key).

Once done, [Account Profiles](https://app.gitbook.com/s/qGpd1uH02qXOCsOiKqLX/features/advanced#company-profiles) will automatically be created per each account, and can be accessed in the Users tab. You can also share Account Profiles with key stakeholders for simple account health reporting, such as Sales teams, Customer Success teams, and executives.

To identify your [Account Activation Metrics](https://app.gitbook.com/s/qGpd1uH02qXOCsOiKqLX/features/advanced#activation-metrics), head over to an insights report and use the new computed property now available: **Number of users who did… (then select an event)**. This property makes it easy to create reports to track account activation, i.e., their adoption progress as an account.
...
*Requires ingesting revenue data from [Data Warehouse Connectors](https://app.gitbook.com/s/qGpd1uH02qXOCsOiKqLX/tracking-methods/warehouse-connectors).
