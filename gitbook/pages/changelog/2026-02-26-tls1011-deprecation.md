...
2. Break down by the [following properties](https://app.gitbook.com/s/qGpd1uH02qXOCsOiKqLX/data-structure/property-reference/default-properties), depending on your tracking SDK(s)
- JavaScript (Web): Browser (`$browser`) and Browser Version (`$browser_version`)
- Mobile: Operating System (`$os`), OS Version (`$os_version`)

Tip: You can create a [Custom Property](https://app.gitbook.com/s/qGpd1uH02qXOCsOiKqLX/features/custom-properties) to quickly bucket users. 
For example, the following Custom Property can help check against Chrome and Firefox.

![Custom Prop Example](.gitbook/assets/changelog/tls-dep-custom-prop-example.png)
...
If you have questions about your project’s compatibility or need general assistance, please reach out to [Mixpanel Support](https://app.gitbook.com/s/qGpd1uH02qXOCsOiKqLX/response-times#contacting-mixpanel-support). 
