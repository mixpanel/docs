...
You can also save the unit to a formula so that future uses of that formula will already be configured with the right unit. You can learn more in documentation [here](https://app.gitbook.com/s/qGpd1uH02qXOCsOiKqLX/features/chart-customization#metric-units)
