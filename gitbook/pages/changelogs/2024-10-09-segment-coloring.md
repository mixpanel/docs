...
Color selection is available on both boards and reports, so you can easily update the segment colors for a report on a board as well. You can learn more in documentation [here](https://app.gitbook.com/s/qGpd1uH02qXOCsOiKqLX/features/chart-customization#segment-coloring)
