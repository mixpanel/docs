...
Connect Mixpanel to Claude, ChatGPT, Gemini, Cursor, Notion, and more. Ask product questions, build dashboards, explore Session Replays, and manage Lexicon — all from the tools you already use.
...
Enter your website, add context, and generate a structured Metric Tree tailored to your business.
...
Target via group cohorts — cohorts of companies, organizations, or any data group entity — for precise B2B rollouts.
...
Data Volume Monitoring is now on be default for new enterprise customers. Enterprise projects are opted into this system, which automatically monitors and detects sudden, drastic changes in event volume and notifies admins for corrective action.
...
Debug and validate your Mixpanel tracking implementation directly in your browser.
...
Select between Dynamic and Manual Segments in your reports to control how breakdowns update as your data changes.
...
We're excited to announce our integration with Langfuse, the open-source LLM engineering platform. Now you can automatically sync your AI application metrics from Langfuse directly into Mixpanel.
...
Safely test new features, measure impact, and roll out to the right users — with cohorts, kill switches, and full visibility in one place.
...
Debug and validate your Mixpanel tracking implementation with real-time event monitoring directly in your browser.
...
Review your metrics against different layers of context using Annotation tags and filters.
...
Talk to your Mixpanel data using natural language. The MCP Server enables AI tools like Claude to directly query your analytics data, democratizing insights across your entire organization.
...
You can find your Cohorts in Lexicon, alongside your other saved definitions like metrics, custom events, and custom properties.
...
New default Billing and Data Retention policies for simpler pricing and and enhanced privacy and security
...
Expand images in Query Builder's context panel for a clearer view when hovering over event names.
...
Growth customers can now purchase up to 500K monthly / 6M annual replays directly online, in addition to their 20k free replays!
...
Now you can replay user sessions for web and mobile (iOS + Android), all in one unified platform alongside your analytics.
...
Confidently ship features your users love, with our fully revamped experimentation reporting.
...
Turn strategy into action: Align teams to business goals with a context-rich, interactive, and measurable framework of your metrics.
...
Save custom column widths in Report and Board tables
...
A new way to define and standardize your KPIs in Mixpanel.
...
Tailor your Mixpanel experience to suit the needs of your organization. Now, project admins can set any Board in the project as the default project homepage.
...
Mixpanel’s AI Company KPIs template helps you determine which AI metrics to track and how to measure them immediately.
...
Mixpanel's new navigation makes it easier to get around and stay in the zone, all while giving you more space to work.
...
Data Standards helps you keep your data organized and understandable, by enforcing naming conventions and metadata requirements. Now, teams can easily spot non-compliant events in Lexicon and take action to maintain high data quality at scale.
...
No more feature limits. Get 1M monthly events free on Mixpanel’s Growth plan. Because we're done being part of the unintuitive SaaS pricing doom loop.
...
Introducing Autocapture from Mixpanel! With just a single code snippet, you can now track common events without custom code, enabling you to get started with analytics in <2 minutes.
...
The revamped startup program offers eligible companies with complete access to Mixpanel's comprehensive analytics, free for their first year.
...
Now you can replay user sessions for React Native apps, bringing Session Replay to your cross-platform mobile development workflow.
...
You can now customize how filters appear on Boards with new settings. Pin a filter to a board for easy access or select the default filter values that should appear for all users.
...
Session Replay is now available on all of our latest plans! Customers can update to the latest Free and Growth plans to unlock free monthly replays.
...
Governors can now designate metrics, events, and formulas as Verified, adding a verified badge to these items across the platform. Highlighting vetted content can make it crystal clear for your team which metrics are trusted across the organization.
...
Mixpanel Session Replay is officially out of beta! Quickly pinpoint drop-offs in your funnels and instantly dive into replays to understand exactly why users get stuck.
...
You choose date ranges that are specified up to the minute. If there's a metric that you want to drill in on for only a few hours, you can set your time range and see only that exact range. This saves you work from having to create a detailed time filter or custom property to do the same thing.
...
You can now view your time series as a column or stacked column chart in Insights report.
