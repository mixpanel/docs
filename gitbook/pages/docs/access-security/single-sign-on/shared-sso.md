...
1. In Mixpanel, [Create an Admin Organization](shared-sso.md#1-create-an-admin-organization-in-mixpanel)
...
5. In Mixpanel, [link the original Organization to the Admin Organization](shared-sso.md#3-link-any-organizations-to-the-admin-organization-in-mixpanel). Users should be able to log in via SSO again.
6. In Mixpanel, transfer claimed Domains from the original Organization to the Admin Organization. (see [Transfer Existing Domains](shared-sso.md#4-optional-transfer-existing-domains) above)
7. Deactivate the original SSO application in your IDP
8. (Optional) Finish setting up SCIM
9. In your IDP, establish a Group for the users who have access to the original Organization
10. In Mixpanel, edit the SCIM name of the original Organization to match the name of this group
11. Configure your IDP to push this group to Mixpanel
