...
{% hint style="info" %}
To enable or disable the setting to move board, you will need an admin or own project role. Learn more about [Roles and Permissions](../orgs-and-projects/roles-and-permissions.md).
{% endhint %}
