...
To get started, click the icon in the left-hand navigator to create a new Board, and select `Use a Template`. You’ll then select your desired template and click `Start from Template`.
