...
![CleverTap 2 Image](../../.gitbook/assets/clevertap2.png)
...
4. You can optionally select the user properties to export by clicking on the ***Edit Columns*** and selecting the user properties you wish to be included in the export. The default user properties that are exported can be found [here](../../cohort-sync.md#limits).
...
![CleverTap 3 Image](../../.gitbook/assets/clevertap3.png)
...
![CleverTap 4 Image](../../.gitbook/assets/clevertap4.png)
