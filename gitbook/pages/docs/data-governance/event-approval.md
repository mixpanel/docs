...
![event-approval-settings](../.gitbook/assets/event-approval-settings.png)
...
![lexicon-event-approval](../.gitbook/assets/Lexicon-Event-Approval.png)
...
### Additional Notes
- Please note that all [custom properties](../features/custom-properties.md) will **not** be marked as "New"
