...
{% embed url="https://www.youtube.com/watch?v=lAToFlwXHEU" %}
...
![Lexicon Events](../.gitbook/assets/lexicon-events-with-em.png)
...
![Lexicon Event Properties](../.gitbook/assets/lexicon-default-properties.png)
...
![Lexicon Profile Properties](../.gitbook/assets/lexicon-group-analytics-GIF.gif)

### Cohorts

[Cohorts](../users/cohorts.md) are groups of users that share a certain set of properties or who perform a similar sequence of events. You can create cohorts based on user properties, events, and other criteria to analyze user behavior and engagement.

### Custom Events

[Custom Events](../features/custom-events.md) are events and properties you combine into one event to use in Mixpanel reports. The fields for custom events are “Name”, “Description”, "Definition", "30 Day Queries", "Last Queried" and “Created” (defined above). 

### Lookup Tables

[Lookup Tables](../data-structure/lookup-tables.md) in your project are listed in your Lexicon. Click into a Lookup Table definition to export the underlying CSV, replace the Lookup Table with a new CSV, and see which properties are linked.

### Formulas and Behaviors
Saved [Formulas](../reports/insights.md#formulas) and [Funnels/Retention Behaviors](../features/saved-metrics-and-behaviors.md) in your project are also documented in your Lexicon. Review here to get an overview of existing definitions in your project that you can quickly leverage in your own analysis.
...
![Lexicon Filtering](../.gitbook/assets/lexiconFiltering.png)
...
![Lexicon Query Volumes](../.gitbook/assets/thirtyDayMetrics.png)

## Dropping Data

{% hint style="info" %}
Only project owners may drop and undrop data from the Lexicon. Learn more about [Roles and Permissions](../orgs-and-projects/roles-and-permissions.md).
{% endhint %}
...
{% hint style="info" %}
You must have an admin or owner project role to hide and unhide data from the Lexicon. Learn more about [Roles and Permissions](../orgs-and-projects/roles-and-permissions.md).
{% endhint %}

In Lexicon, you can hide any events or properties. Unlike [dropping data](./lexicon.md#dropping-data), hiding data does not affect data ingestion; any events/properties that are hidden will continue to be ingested in your project and count toward your data allowance.

A hidden entity will not be indexed in your event/properties menu in the query builder. Any [inactive events and properties](../tracking-best-practices/debugging.md#inactive-events-and-properties) will also be hidden.

Hidden events will be excluded from your query results. For example, it will not be included in "All Events" and won't appear as an intermediate step in your [Flows report](../reports/flows.md).
...
{% hint style="info" %}
In Lexicon, only project owners can merge events and event properties. Learn more about [Roles and Permissions](../orgs-and-projects/roles-and-permissions.md).
{% endhint %}
...
![Lexicon Unmerge Events](../.gitbook/assets/unmerge-properties.png)
...
![verifyButton](../.gitbook/assets/verifyButton.png)
...
For Session Replay setup and configuration, see our [Session Replay documentation](../session-replay.md).
...
![Lexicon Export](../.gitbook/assets/lexiconExport.png)
...
![Lexicon CSV Import Format](../.gitbook/assets/lexicon-csv-import-format.png)
...
To export all of your entities from the Lexicon, please use the [CSV export method](./lexicon.md#export-and-import-lexicon-data), which will export everything as seen in the UI, which includes recently sent entities and all entities with a Schema.
