...
* Mixpanel Service Account Username & Secret (Owner or Admin role required) To publish your Avo data dictionary to Lexicon, click the "Publish to Lexicon" button in the integration interface.
