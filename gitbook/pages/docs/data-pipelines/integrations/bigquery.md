...
Refer to [Step 2: Creating the Pipeline](../../data-pipelines.md#step-2-creating-the-pipeline) to create data pipeline via UI. You need to provide specific details to enable authentication and data export to BigQuery.
