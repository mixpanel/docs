...
Mixpanel supports exporting events and people data directly to Google Cloud Storage (GCS) via [Json Pipelines](../../data-pipelines.md).
...
Refer to [Step 2: Creating the Pipeline](../../data-pipelines.md#step-2-creating-the-pipeline) to create data pipeline via UI. You need to provide the following details to ensure Mixpanel can accurately direct the data exports to your GCS:
