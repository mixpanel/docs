...
This version of managing pipelines via API is Deprecated going forward.
  ...
  Otherwise, go to the Integrations page in Mixpanel to create and manage pipelines via UI and
  go to [docs](../data-pipelines.md) for more info.
{% endhint %}
...
We offer a 30-day free trial of the Data Pipelines add-on. See the [FAQ](#free-trial) for how to enable it.
...
- [Amazon Web Services](./old-pipelines/integrations/raw-aws-pipeline.md)
- [Google Cloud Storage](./old-pipelines/integrations/raw-gcs-pipeline.md)
- [Azure Blob Storage](./old-pipelines/integrations/raw-azure-pipeline.md)
...
- [BigQuery](./old-pipelines/integrations/schematized-bigquery-pipeline.md)
- [Snowflake](./old-pipelines/integrations/schematized-snowflake-pipeline.md)
- [Amazon Web Services](./old-pipelines/integrations/schematized-aws-pipeline.md)
- [Google Cloud Storage](./old-pipelines/integrations/schematized-gcs-pipeline.md)
- [Azure Blob Storage](./old-pipelines/integrations/schematized-azure-pipeline.md)

The [Schematized Pipeline reference](./old-pipelines/schematized-export-pipeline.md) goes into the details of schematization and the output format.
...
{% hint style="info" %}
Note that the Service Account must have an Admin or Owner role in order to authenticate the request.
{% endhint %}
