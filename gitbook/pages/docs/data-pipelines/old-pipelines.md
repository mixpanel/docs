...
The [Schematized Pipeline reference](/docs/data-pipelines/old-pipelines/schematized-export-pipeline) goes into the details of schematization and the output format.
