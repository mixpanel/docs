...
> **Important:** Please do not modify the schema of glue tables generated by Mixpanel. Altering the table schema can cause the pipeline to fail to export due to schema mismatches.
...
Mixpanel can write and update a schema in your Glue instance as soon as new data is available. To get more information about the table schemas, please see [Schema](../schematized-export-pipeline.md#schema). To set this up:
...
![image](../../../.gitbook/assets/230698416-039e4357-f8f3-4c9a-bba9-c6b0a16311b6.png)
...
To avoid these issues, Mixpanel can write and update a schema in your Glue instance as soon as new data is available. Follow [these instructions](./schematized-aws-pipeline.md#configuring-glue-for-mixpanel-direct-export) to enable Mixpanel to write your data catalog to AWS Glue.
...
## Queries
You can query data with a single table schema or with a multiple table schema in Redshift Spectrum. To get more information about the table schemas, please see [Schema](../schematized-export-pipeline.md#schema).
...
`CLEANED_EVENT_NAME` is the transformed event name based on [transformation rules](../schematized-export-pipeline.md#transformation-rules).
