...
Mixpanel’s Azure Blob Export is one type of [Schematized Export Pipeline](../schematized-export-pipeline.md) that exports Mixpanel events and people data and imports them into an Azure Blob storage instance. 
