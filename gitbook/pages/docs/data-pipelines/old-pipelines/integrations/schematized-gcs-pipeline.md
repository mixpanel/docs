...
The Google Cloud Storage schema pipeline exports [transformed data](../schematized-export-pipeline.md#transformation-rules) to a GCS bucket. This can be useful in case you want to export Mixpanel data into your own BigQuery instance.
