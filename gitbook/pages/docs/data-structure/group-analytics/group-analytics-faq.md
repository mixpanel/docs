...
- 1M events per day per group identifier (e.g. company_id = "Mixpanel") - see [Hot Shard Limits](../../tracking-best-practices/hot-shard-limits.md)
- Group properties have similar [limits as User properties](../user-profiles.md#what-are-the-limits-of-user-properties)
...
Alternatively, the `<data_group_id>` can also be seen as part of the URL of the [Group Profile](../group-analytics.md#group-profiles) page:
