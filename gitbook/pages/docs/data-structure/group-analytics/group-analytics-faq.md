...
* 1M group profiles per group key (e.g. company\_id)
* 1M events per day per group identifier (e.g. company\_id = "Mixpanel") - see [Hot Shard Limits](../../../../../docs/tracking-best-practices/hot-shard-limits/)
