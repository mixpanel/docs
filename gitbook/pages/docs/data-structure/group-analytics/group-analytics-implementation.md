...
{% hint style="info" %}
Customers on an Enterprise or Growth plan can access Group Analytics as an [add-on package](https://mixpanel.com/pricing/). See our pricing page for more details.
{% endhint %}
...
It is possible to create Group Profiles by CSV upload as an alternative to the Groups API. [Follow the instructions here to learn how to upload Group Profiles using the Users report](../user-profiles.md#importing-from-csv).

## SDK references for Groups

To view the setup guides for implementing Groups using the Groups API, follow the instructions connected to the SDK you are using, cataloged [here](../../tracking-methods/sdks.md).

- [HTTP](https://developer.mixpanel.com/reference/group-set-property)
- [Javascript SDK](../../tracking-methods/sdks/javascript.md#group-analytics)
- [iOS-Swift SDK](../../tracking-methods/sdks/swift.md#group-analytics)
- [iOS-Objective-C SDK](../../tracking-methods/sdks/ios.md#group-analytics)
- [Android SDK](../../tracking-methods/sdks/android.md#group-analytics)
- [Java SDK](../../tracking-methods/sdks/java.md#group-analytics)
- [Python SDK](../../tracking-methods/sdks/python.md#group-analytics)
- [React Native SDK](../../tracking-methods/sdks/react-native.md#group-analytics)
- [Ruby SDK](../../tracking-methods/sdks/ruby.md#group-analytics)
