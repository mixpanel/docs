...
| $mp_api_endpoint | API Endpoint | Mixpanel property to record the API endpoint the data was sent to: **api.mixpanel.com** - default ingestion **api-eu.mixpanel.com** - EU data ingestion **api-in.mixpanel.com** - India data ingestion **api-js.mixpanel.com** - Javascript SDK |
