...
You can export data from your project using a variety of methods, including lightweight CSVs generated from the UI, large volume raw data export from our APIs, and data syncs to external destinations through [Cohort Syncs](./cohort-sync.md) and [Data Pipelines](./data-pipelines.md).
...
You can sync your Mixpanel data to your other destinations using our native connectors. Learn more about the [Data Pipeline](./data-pipelines.md) for warehouse syncs and [Cohort Syncs](./cohort-sync.md) for audience targeting.
