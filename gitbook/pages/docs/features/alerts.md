...
{% hint style="info" %}
To create and manage alerts, you will need an analyst, admin, or owner project role. Learn more about [Roles and Permissions](../orgs-and-projects/roles-and-permissions.md).
{% endhint %}
...
1. Navigate to **Gear Icon** > **Integrations** > **Notification Webhook**. Note this is separate to [Custom Webhooks](../cohort-sync/webhooks.md) (meant to sync cohorts)
