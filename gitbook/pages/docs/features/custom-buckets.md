...
No, you can’t save a custom bucket. If your custom bucket is something you or your team would like to re-use, we encourage you to instead create a [custom property](./custom-properties.md#creating-a-custom-property).

**How is custom buckets different from [custom property](./custom-properties.md)?**
...
No, the operators are fixed. The lower bound is inclusive (≥), and the upper bound is exclusive (\<). If you are looking for more control over the operators, please create a [custom property](./custom-properties.md#creating-a-custom-property).
