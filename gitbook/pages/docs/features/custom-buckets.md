...
4\. Post changing data type, open the custom buckets modal. This will now open a modal meant for string property data type 5. Follow the steps as elaborated for the String property use-case above, and achieve the goal
