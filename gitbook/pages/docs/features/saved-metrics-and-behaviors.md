...
Simple Behaviors and [Custom Events](./custom-events.md) are similar in that both allow you to combine multiple events for analysis. As a best practice, follow the guidelines below to determine whether to use Simple Behaviors or Custom Events:
...
{% hint style="info" %}
Learn more about the [Funnels report](../reports/funnels.md).
{% endhint %}
...
{% hint style="info" %}
Learn more about the [Retention report](../reports/retention.md).
{% endhint %}
...
You can view all Saved Metrics and Behaviors in your project, add descriptions to clearly define them, and delete any unwanted definitions directly from the [Lexicon](../data-governance/lexicon.md).
...
- **Verify:** [Add Verified badges](../data-governance/lexicon.md#verify-data) to the metric/behavior. Only project Admins and Owners can verify entities in the Lexicon.
