...
Project Admins or Owners can choose between one of these configurations in [Project Settings](https://mixpanel.com/settings/project) > Overview > Session Settings.

Since Mixpanel computes sessions dynamically at query, you can change this definition at any time and it will apply historically. Read more [below](#session-computation-deep-dive).

## Use Cases
These use cases assume that you're tracking an event for each page a user views. You can do this automatically with our [Javascript SDK](../quickstart/connect-your-data?sdk=javascript.md) or using a CDP like Segment.

To make these examples more interesting, we're using our own tracking on our [documentation site](../what-is-mixpanel.md).
...
![session-average-duration](../.gitbook/assets/session-average-duration.png)
...
![](../.gitbook/assets/session-duration-distribution.png)
...
![](../.gitbook/assets/pages-per-session-nobounce.png)
...
![](../.gitbook/assets/sessions-landing-pages.png)
...
![](../.gitbook/assets/sessions-funnel.png)
...
Here, we provide more detail on how sessions are computed under the hood. Project Admins or Owners can choose between one of these session configurations in [Project Settings](https://mixpanel.com/settings/project) > Overview > Session Settings.
...
Use your [Time to Convert Chart in Funnels](../reports/funnels/funnels-advanced.md#time-to-convert) to help determine an appropriate session timeout period that aligns with your users’ behavior.
...
![/sessions6.png](../.gitbook/assets/sessions6.png)
...
![/sessions7.png](../.gitbook/assets/sessions7.png)
...
![/Untitled__3_.png](../.gitbook/assets/Untitled__3_.png)
...
![/Untitled__4_.png](../.gitbook/assets/Untitled__4_.png)
...
![/10260746661780](../.gitbook/assets/10260746661780.png)
...
![/Untitled__6_.png](../.gitbook/assets/Untitled__6_.png)
...
![/10494738316692](../.gitbook/assets/10494738316692.png)

## Session Controls in Reports
### Funnels

In [Funnels](../reports/funnels/funnels-overview.md), once you have set up sessions, a “Session Start” and “Session End” events will be generated in the report based on the funnel criteria.
...
In [Flows](../reports/flows.md), you can use the “Session Start” and “Session End” events to view the top Flows events within a session. 

When you select sessions in Flows, the flow will be weighted by the number of sessions, rather than unique users.

### Insights

In [Insights](../reports/insights.md), you can use the “Session Start” and “Session End” events to explore a variety of metrics:
