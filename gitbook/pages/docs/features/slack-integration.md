...
To send an alert to a Slack Channel, see [Custom Alerts](./alerts.md). To set up a board subscription to a Slack Channel, see [Advanced Board Functionality - Subscriptions](../boards/advanced.md#board-subscriptions).
