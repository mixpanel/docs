...
- [Adobe Analytics Migration Guide](./migration/adobe-analytics.md)
- [Amplitude Migration Guide](./migration/amplitude.md)
- [Google Analytics Migration Guide](./migration/google-analytics.md)
...
- If you have a data warehouse: Leverage our [data warehouse connector](./tracking-methods/warehouse-connectors.md) or our [Import API](https://developer.mixpanel.com/reference/import-events) to import to Mixpanel. 
...
- Have your Mixpanel champion or owner first set up your [Organization settings](./best-practices/project-setup.md#mixpanel-organization) and [Project settings](./best-practices/project-setup.md#mixpanel-projects). This will ensure the right access level for your team and enable you to prepare the workspace for ingesting data. This can be done later but doing it up front will allow for you to set key settings for data ingestion (US vs EU servers, project timezone, etc.).
...
For a more in-depth look into the steps required for a successful project migration, check out our [project migration playbook](https://app.gitbook.com/s/T5M6sZZR1LgkJeivZBt6/playbooks/project-migration). 
