...
If you haven't already, we recommend starting with our [Migration Guides Overview](../migration.md) as it details the key components of migrating to Mixpanel from other analytics tools. Below we outline specific steps and considerations when migrating from Amplitude.
...
Note that while the migration tool is free to use, backfilling historical event data can have significant impact on your billing. Refer to [this section](../pricing.md#are-monthly-events-calculated-based-on-ingestion-time-or-event-timestamp) for more details.
...
3. Set up [Mixpanel Warehouse Connector](../tracking-methods/warehouse-connectors.md) to initiate data sync from your data warehouse to Mixpanel. 
...
Once you've transformed your data in your data warehouse, you can set up the [Mixpanel Warehouse Connector](../tracking-methods/warehouse-connectors.md) to migrate your historical data into Mixpanel. We'd recommend first sending a month of data into a test project for validation.
...
You can set up the [Mixpanel Warehouse Connector](../tracking-methods/warehouse-connectors.md) to set your implementation to Mixpanel. You can learn more about event mappings [here](../tracking-methods/warehouse-connectors.md#events) and about user mappings [here](../tracking-methods/warehouse-connectors.md#user-profiles).
...
- **Event JSON Structure:** Amplitude and Mixpanel have slightly different structures (explained [here](./amplitude.md#differences-in-the-data-models)). You will want to remap the Amplitude event format to the expected Mixpanel JSON payload as described [here](./amplitude.md#differences-in-the-data-models).
