...
{% hint style="info" %}
To create a project, you will need an admin or owner organization role. Learn more about [Roles and Permissions](./roles-and-permissions.md).
{% endhint %}
...
![manageprojects 1 Image](../.gitbook/assets/manageprojects1.png)
...
![manageprojects 2 Image](../.gitbook/assets/manageprojects2.png)
...
![manageprojects 3 Image](../.gitbook/assets/manageprojects3.png)
...
![manageprojects 4 Image](../.gitbook/assets/manageprojects4.png)

## Reset Projects

{% hint style="info" %}
Only project owners and organization owners may reset projects. Learn more about [Roles and Permissions](./roles-and-permissions.md).
{% endhint %}
...
![manageprojects 11 Image](../.gitbook/assets/manageprojects11.png)
...
![manageprojects 12 Image](../.gitbook/assets/manageprojects12.png)

## Delete Projects

{% hint style="info" %}
Only project owners and organization owners may delete projects. Learn more about [Roles and Permissions](./roles-and-permissions.md).
{% endhint %}
...
![manageprojects 5 Image](../.gitbook/assets/manageprojects5.png)
...
![manageprojects 7 Image](../.gitbook/assets/manageprojects7.png)

Then select the Projects tab.

![manageprojects 8 Image](../.gitbook/assets/manageprojects8.png)
...
{% hint style="info" %}
You must have an admin or owner project role to change your project timezone setting. Learn more about [Roles and Permissions](./roles-and-permissions.md).
{% endhint %}
...
![manageprojects 9 Image](../.gitbook/assets/manageprojects9.png)

2. 2. In **Overview**, select the pencil icon in the **Timezone** field to display a list of timezones.

![manageprojects 10 Image](../.gitbook/assets/manageprojects10.png)
...
[Date properties are one of the five data types](../data-structure/property-reference/data-type.md#date) Mixpanel accepts. Mixpanel events should be ingested with timestamps set to Coordinated Universal Time (UTC). If you overwrite the default timestamp, import old data, or set a property that is in date format (e.g. Account Created Date), be sure to send the timestamp or date in UTC.
...
The `$time` property values from your raw event export are Unix timestamps, which represents the number of seconds that have elapsed since 00:00:00 on January 1, 1970. Note that [the timezone of the `$time` property in your exports depends on how your project records time at ingestion](./managing-projects.md#manage-timezones-for-projects).
...
![manageprojects 13 Image](../.gitbook/assets/manageprojects13.png)
...
![manageprojects 14 Image](../.gitbook/assets/manageprojects14.png)
