...
You may want to disable ip geolocation when using a server-side SDK. You can learn more in [Server-Side Best Practices](../tracking-best-practices/server-side-best-practices.md)
{% endtab %}
...
[Learn More About Default Properties](../data-structure/property-reference.md#default-properties)
</details>
