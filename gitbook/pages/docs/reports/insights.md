...
- Use Saved Formulas if your report contains formulas. Learn more about [Saved Formulas](./insights.md#save-formulas-for-re-use).
- Combine multiple events into a behavior. Learn more about [Saved Behaviors](../features/saved-metrics-and-behaviors.md#simple-behaviors).
