...
Ensure you have Session Replay set up using our Javascript SDK (see [developer guide on implementing Session Replay](../tracking-methods/sdks/javascript/javascript-replay.md)), with the `record_heatmap_data` set to `true`. 
...
If you currently use [Autocapture](../tracking-methods/autocapture.md) to track clicks, you can leverage these clicks to populate the Heatmaps without the `record_heatmap_data` init option.
...
{% hint style="info" %}
Clicks generated by `record_heatmap_data` are exempt from your plan data allowance only when a session recording is taking place. Clicks generated by [Autocapture](../tracking-methods/autocapture.md) are billable events.
{% endhint %}
...
![heatmap_home.png](../.gitbook/assets/heatmap_home.png)
...
![heatmap_rename.png](../.gitbook/assets/heatmap_rename.png)

4. Rotate through UI States to view different states of your application for the same URL.

![UI States view](../.gitbook/assets/heatmap_backdrops.png)
...
![heatmap_selection_menu.png](../.gitbook/assets/heatmap_selection_menu.png)
