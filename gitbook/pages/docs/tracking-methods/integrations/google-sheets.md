...
Visit the [Sheets ⇔ Mixpanel Google Workspace Marketplace page](https://workspace.google.com/marketplace/app/sheets_%E2%87%94_mixpanel/1078767167468) to install the extension. Learn more about the permissions requested [here](./google-sheets.md#permissions).
...
Here is a summary of Mixpanel's [data model](../../data-structure/concepts.md) and [required fields for event data](../../data-structure/concepts.md#anatomy-of-an-event):
- **event name:** what to call each event in mixpanel
- **distinct_id:** the unique user identifier to whom the event is attributed (learn more [here](../id-management.md#distinct-id))
...
You will also need to provide the following details found in your [project settings](../../orgs-and-projects/managing-projects.md#project-details):
- **project_id**
- **project_token**
...
Next, learn about [runs and syncs](./google-sheets.md#runs-and-syncs) below.

## Export to Google Sheet

**Mixpanel → Sheet** queries your Mixpanel project for a report or cohort and makes the results available in a new Sheet.

This will replicate the functionality when [exporting a CSV file from the Mixpanel UI](../../export-methods.md#exporting-reports).
...
- your [project_id](../../orgs-and-projects/managing-projects.md#viewing-project-information)
