...
If you want to import User Profiles into Mixpanel, see our [User Profiles guide](./data-structure/user-profiles.md).
...
Learn more about Cohorts [here](./users/cohorts.md).
...
Follow [this guide](./users/cohorts.md#creating-a-cohort-via-a-csv) to create a Cohort using a CSV file.
