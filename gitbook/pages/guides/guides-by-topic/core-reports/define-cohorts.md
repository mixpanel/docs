...
## Creating a Cohort
You can [create cohorts](https://app.gitbook.com/s/qGpd1uH02qXOCsOiKqLX/users/cohorts#creating-cohorts) via any of our report visualizations or explicitly using the cohort builder. Click any bar or point in an Insights, Funnels, or Retention report and select "View Users". You can save that group of users as a cohort or use the Cohort Builder to define cohorts based on a precise set of conditions.

## Managing your cohorts and setting up syncs

You can view all the Cohorts within your project by navigating to [Lexicon](https://app.gitbook.com/s/qGpd1uH02qXOCsOiKqLX/data-governance/lexicon) > Cohorts.

Cohorts that you create are, by default, only visible to you. You can optionally share cohorts with specific other people or with your organization. You can download the list of users in any Cohort as a CSV via the Cohort Builder. You can also push cohorts and create regular syncs to 3rd-party destinations like [Segment](https://app.gitbook.com/s/qGpd1uH02qXOCsOiKqLX/cohort-sync/integrations/segment), [Braze](https://app.gitbook.com/s/qGpd1uH02qXOCsOiKqLX/cohort-sync/integrations/braze), or a [Custom Webhook](https://app.gitbook.com/s/qGpd1uH02qXOCsOiKqLX/cohort-sync/webhooks).
