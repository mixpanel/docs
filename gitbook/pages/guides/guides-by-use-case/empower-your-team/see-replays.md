...
Discover what users really experience—and turn those insights into action. This Guide shows you how to use [Heatmaps](https://app.gitbook.com/s/qGpd1uH02qXOCsOiKqLX/analysis/session-replay/heatmaps) and [Session Replay](https://app.gitbook.com/s/qGpd1uH02qXOCsOiKqLX/session-replay) together to quickly spot friction, understand behavior, and drive better product decisions.
...
Together, they help you understand not just _what_ happened, but _why_.
...
{% hint style="info" %}
**Pro tip:** Use _Click Maps_ for precision and _Traditional Heatmaps_ for broader engagement patterns. Click Maps provide precise insights on dynamic pages with modals or dropdowns.
{% endhint %}

Learn more about [Click Maps and Traditional Heatmaps](https://app.gitbook.com/s/qGpd1uH02qXOCsOiKqLX/analysis/session-replay/heatmaps#overview).
...
Learn more about [Session Replay Privacy Controls](https://app.gitbook.com/s/qGpd1uH02qXOCsOiKqLX/analysis/session-replay/session-replay-privacy-controls).
...
* [Annotations](https://app.gitbook.com/s/qGpd1uH02qXOCsOiKqLX/analysis/features/annotations): Add notes to your reports to document findings and experiments.
* [Alerts](https://app.gitbook.com/s/qGpd1uH02qXOCsOiKqLX/analysis/features/alerts): Set notifications for spikes or drops in engagement or friction.
...
📚 **Go deeper:** Explore the Mixpanel Docs on [Heatmaps](https://app.gitbook.com/s/qGpd1uH02qXOCsOiKqLX/analysis/session-replay/heatmaps) and [Session Replay](https://app.gitbook.com/s/qGpd1uH02qXOCsOiKqLX/session-replay).
