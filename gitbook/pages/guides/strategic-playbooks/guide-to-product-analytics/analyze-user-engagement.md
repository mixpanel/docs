...
<div class={style.logoTable}>
    <RakutenViberLogo />
    <div class={style.logoText}>
        "We create cohorts based on percentiles of activity (to identify power users), region-based cohorts/breakdowns by countries (there's a lot of cultural difference in how people use the app as well as their data usage). We break it down as much as we can and try to understand users based on their behavior, not the average behavior."<div class={style.logoSpeaker}>**Idan Dadon**</div> *Product Manager, Viber*
...
<div class={style.logoTable}>
    ...
    <div class={style.logoSpeaker}>**Manuel Eugster**</div> *Vice President Data Intelligence, Avira*
...
[Read Chapter 4 →](./retain-your-users.md)
