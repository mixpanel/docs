...
description: >-
  Learn how to identify, measure, and track the core value your product brings
  to users through effective product analytics.
---

# Chapter. 1: Measure Value

## Questions answered

* [How does my product bring value?](measure-value.md#how-does-my-product-bring-value)
* [How can I monetize my product?](measure-value.md#how-can-i-monetize-my-product)
* [Can product value always be measured and analyzed?](measure-value.md#can-product-value-always-be-measured-and-analyzed)
* [What is a value moment?](measure-value.md#what-is-a-value-moment)
* [Which metrics should I pick to measure product success?](measure-value.md#which-metrics-should-i-pick-to-measure-product-success)
* [Where do product leaders typically go wrong when defining their value metric?](measure-value.md#where-do-product-leaders-typically-go-wrong-when-defining-their-value-metric)
* [When it comes to choosing product metrics, what's the difference between a good PM and a great PM?](measure-value.md#when-it-comes-to-choosing-product-metrics-whats-the-difference-between-a-good-pm-and-a-great-pm)
...
To understand your product's value, you need to step back and ask: _"What are my users hoping to do with my product? And what is my product really about?"_
...
**Dan Hockenmaier** _Founder, Basis One; Growth Mentor and Contributor at Reforge_
{% endcolumn %}
{% endcolumns %}
...
**Jamie Kapilivsky** _Data Insights, Vrbo, part of Expedia Group_
{% endcolumn %}
{% endcolumns %}
...
**Stephan Brenner** _Vice President - Product, Avira_
{% endcolumn %}
{% endcolumns %}
...
**Idan Dadon** _Product Manager, Viber_
{% endcolumn %}
{% endcolumns %}
...
**Karim Mouahbi** _Head of Marketing, Mad Paws_
{% endcolumn %}
{% endcolumns %}
...
**Akio Bandle** _Senior Product Manager, ZipRecruiter_
{% endcolumn %}
{% endcolumns %}
...
**Shannon Ferguson** _Director of Measurement, The Weather Company_
{% endcolumn %}
{% endcolumns %}
...
**Drew Ashlock** _Lead Product Manager, DocuSign_
{% endcolumn %}
{% endcolumns %}
...
> "Great PMs understand that metrics are not the mission. At the macro-level, metrics are useful markers for whether the product is achieving its mission and is doing so in a way that creates value for the company (i.e., that the execution is in alignment with the product strategy). At the micro-level, it's important to recognize that certain products lend themselves well to metrics-based product decisions whereas others don't.
>
...
>
> **Shreyas Doshi** _PM Lead at Stripe, Former PM Lead at Twitter, Google and Yahoo_
...
>
> **Vinati Malik** _Senior Vice President of New Product Development, Tata Play_
...
[Read Chapter 2 →](get-to-know-your-users.md)
