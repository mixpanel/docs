...
- [x] [Setup](../../../tutorials/plan/setup.md#setting-up-mixpanel) *(for Organization Owners and Admins)* - takes you through how you should go about setting up your Mixpanel Organization and the underlying Projects. 
- [x] [Framework](../../../tutorials/plan/framework.md) - if you need guidance on defining your metrics and KPIs to help you achieve your business and product objectives, this tutorial should help you. 
- [x] [Tracking Strategy](../../../tutorials/plan/tracking-strategy.md) - this tutorial helps you understand Mixpanel's data model so you're equipped with building out your tracking plan to measure your metrics and KPIs.
...
You should have a Mixpanel [Organization](../../../orgs-and-projects/organizations.md) already assigned to your login if you had signed up as the main Mixpanel [Owner](../../../orgs-and-projects/roles-and-permissions.md#owner). If not, please contact our [Mixpanel Support](../../../response-times.md#contacting-mixpanel-support) team for assistance.
...
Click [here](https://mixpanel.com/settings/org/users-and-teams/find-your-org) to setup your organization, or for more information, refer to our documentation on [Organization Discoverability](../../../orgs-and-projects/organizations.md#organization-discoverability).

![image](/tutorials/organization-discoverability.png "Organization Discoverability")

## Simplified Identity Management

Since April 2024, Mixpanel has made the [Simplified API](../../../tracking-methods/id-management/identifying-users.md#how-does-the-simplified-api-differ-from-the-original-api) as the default identity management setting for newly created organizations. If your Mixpanel organization was created prior to this, it might not have this enabled.
...
We recommend using the **Simplified API** option as it is a straightforward simpler way of managing your users' identity in Mixpanel. More details about how Simplified API handles identity management can be found in our documentation under [Identifying Users](../../../tracking-methods/id-management/identifying-users.md#how-does-the-simplified-api-differ-from-the-original-api). We will also cover a tutorial around this under the [Identity Management Best Practice](../../../tutorials/implement/send-your-data.md#identity-management-best-practices) section.

## Development and Production Project Setup

We recommend that you minimally setup two Mixpanel projects, one for **Development** data and another for **Production** data. This is to ensure that you keep development test data separate from actual live user behavioral data. Read more details about [Developer Environments](../../../best-practices/developer-environments.md).
...
2. Click **Create Project** to create each project
   - We recommend choosing **United States** as *Where To Store Your Data* (unless you have [EU Residency](../../../privacy/eu-residency.md) requirements)
   - Select the **Timezone** with which you want to analyze your data (more information on [Project Timezones](../../../orgs-and-projects/managing-projects.md#manage-timezones-for-projects))

Refer to docs on [Project Setup](../../../best-practices/project-setup.md) for more detailed steps and best practices.
...
> Note: Filtering by User Profile Properties removes the ability to analyze by [Groups](../../../data-structure/advanced/group-analytics.md#group-by-a-custom-identifier) 

<p >
  {% embed url="https://www.youtube.com/watch?v=E4C-eQgj2Zs" %}

Refer to docs for a more detailed guide on setting up [Data Views](../../../data-governance/data-views-and-classification.md#data-views-overview).
...
In scenarios where you want to send non-PII data but want to limit only certain users within the project access, you can do so using [Classified Data](../../../data-governance/data-views-and-classification.md#mark-properties-as-classified-data). This allows you to mark those specific event and user properties as classified, and only users who have been granted access to classified data can view them.
...
Refer to docs for a detailed guide on setting up [Classified Data](../../../data-governance/data-views-and-classification.md#data-classification).

## Setup Teams or Add Users to Mixpanel Projects

There are two general approaches to user management in Mixpanel. 

- [Teams](../../../orgs-and-projects/roles-and-permissions.md#teams) - organization owners and admins create teams at the organization level, grant projects and permissions, and assign users to teams.
- [Project based](../../../orgs-and-projects/roles-and-permissions.md#invite-users-to-a-project) - organization admins appoint project level admins who grant permissions to users.

![image](/tutorials/user-access-approach.png "User Access Approach")

Users are required to be part of your Mixpanel Organization (either through [self-joining](../../../orgs-and-projects/organizations.md#organization-discoverability) or via an [invitation from the admin](../../../orgs-and-projects/roles-and-permissions.md#invite-users-to-an-organization)), before they can be granted access to any Mixpanel Project.
...
2. Invite users to your [organization](../../../orgs-and-projects/roles-and-permissions.md#invite-users-to-an-organization), either add them to teams or directly add them into your [projects](../../../orgs-and-projects/roles-and-permissions.md#invite-users-to-a-project)
3. Assign the appropriate [Organization](../../../orgs-and-projects/roles-and-permissions.md#organization-roles) and [Project](../../../orgs-and-projects/roles-and-permissions.md#project-roles) roles; a default project role can also be set for All Users in the Organization as a baseline access. 

Refer to docs for a detailed guide on [Project Setup](../../../best-practices/project-setup.md).
