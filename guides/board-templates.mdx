...
description: "Pre-built board templates to jumpstart your analytics workflow"
---

import { BoardTemplates } from "/snippets/BoardTemplates.jsx";
...
{/*
  Cards API (examples):
  {
    ...
    img: '/images/templates/kpi.webp',      // Image src (314x160 pixels recommended)
