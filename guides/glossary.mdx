...
title: Mixpanel Glossary
description: "Definitions of Mixpanel and product analytics terms, from data tracking and privacy to growth metrics and product strategy, by category or A-Z"
---
...
Browse by category, or jump directly to the [A-Z list](#a-z-glossary).

---

## Browse by Category

<Accordion title="Expand to view categories">
  <AccordionGroup>
    <Accordion title="Analysis & Visualization Terms">
      - [Annotation](#annotation)
      - [Board](#board)
      - [Formula](#formula)
    </Accordion>

    <Accordion title="Business Models & Key Metrics">
    ...
    <Accordion title="Compliance & Privacy Terms">
    ...
    <Accordion title="Data & Technical Terms">
    ...
    <Accordion title="Data Management Terms">
      - [Data Lake](#data-lake)
    ...
    <Accordion title="Product Development Terms">
      - [Feature Flag](#feature-flag)
      - [Minimum Viable Product (MVP)](#minimum-viable-product-mvp)
      - [Multivariate Test](#multivariate-test)
    </Accordion>

    <Accordion title="Product & User Lifecycle Terms">
...
The transmission of event data into the analytics platform, accepted via [client-side SDKs](/docs/tracking-methods/sdks), the [Ingestion API](/reference/ingestion-api), or [partner integrations](/docs/tracking-methods/integrations).
