...
<FrameColumn 
  src="https://www.youtube-nocookie.com/embed/NQygWnSViZc"
  title="Mixpanel MCP Overview"
  description="If you’re new to MCP, watch this first to ground the concepts below in a concrete example. If you’re evaluating MCP for your team, this video illustrates the difference between simply querying Mixpanel and using MCP as a data synthesis layer."
  link="https://youtu.be/NQygWnSViZc?si=cFEc1aGyEKZClWg9"
/>
