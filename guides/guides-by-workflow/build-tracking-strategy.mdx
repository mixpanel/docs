---
sidebarTitle: Build Tracking Strategy
title: How To Build a Tracking Strategy
description: "Build a tracking strategy that decides which events and properties to capture, how to name them, and how to keep them consistent over time"
---
...
<Steps>
  <Step title="Utilize properties to avoid creating separate events for each variation.">
  ...
  <Step title="Use consistent data types for predictable analysis.">
  ...
  <Step title="Attach session-level context as super properties.">
...
<Steps>
  <Step title="Prioritize analysis needs.">
...
<Note>
  Check out our [Onboarding Playbook](/guides/strategic-playbooks/onboarding-playbook).
</Note>
