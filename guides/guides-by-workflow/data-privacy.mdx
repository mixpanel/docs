---
sidebarTitle: "Manage PII & Data Privacy"
title: "Mixpanel Guide to Data Privacy & PII Best Practices"
description: "Best practices for handling PII and sensitive data in Mixpanel: collect only what you need and reduce risk without losing analytics quality"
---
...
<Steps>
  <Step title="Classify Sensitive Properties">
  ...
  <Step title="Define Access & Roles">
  ...
  <Step title="Operationalize Compliance">
  ...
  <Step title="Document in Lexicon">
...
<Steps>
  ...
  <Step title="Remediation Workflow">
    If you discover unexpected PII, follow a structured remediation flow immediately:

    - **Stop Ingestion**: [Drop](/docs/data-governance/data-clean-up#3-drop-filters) the event or property at ingestion to stop the leak.
