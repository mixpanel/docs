...
<Info>
  If you want to query Mixpanel from a chat interface rather than code, [Mixpanel MCP](/guides/mcp) is the better fit. For AI-assisted analysis inside Mixpanel itself, see [Mixpanel Agent](/guides/mixpanel-agent).
</Info>
