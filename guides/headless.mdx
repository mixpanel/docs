...
<Tip>
  See how [Acid Labs runs Mixpanel almost entirely through Headless and Claude Code](https://mixpanel.com/customers/how-acid-labs-runs-mixpanel-headless-claude-code/): dashboard setups that used to take a couple of hours of manual clicking now come back finished in about 10 minutes, with consistent naming and no forgotten filters.
</Tip>
