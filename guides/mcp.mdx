...
This guide covers the core workflow. [MCP Integration Pairings](/guides/mcp/integrations) goes deeper on tool-specific combinations — including automated delivery via Slack — and [MCP by Industry](/guides/mcp/mcp-by-industry) gives you use cases and prompts tailored to your context.
...
👉 **Next step**: Ready to go deeper? See [MCP by Industry](/guides/mcp/mcp-by-industry) for use cases and sample prompts tailored to your context, or [MCP Integration Pairings](/guides/mcp/integrations) to explore what each external data source unlocks.
