---
sidebarTitle: Use Mixpanel MCP
title: "Use Mixpanel MCP to Go From \"What Happened?\" to \"What Should We Do?\""
description: "Connect Mixpanel to AI tools like Claude, ChatGPT, and Cursor using the Model Context Protocol server"
---
...
<Frame>
  ![image](/images/mixpanel-mcp-2048x1151.jpeg)
</Frame>
...
<FrameColumn src="https://www.youtube-nocookie.com/embed/NQygWnSViZc" title="Mixpanel MCP Overview" description="If you’re new to MCP, watch this first to ground the concepts below in a concrete example. If you’re evaluating MCP for your team, this video illustrates the difference between simply querying Mixpanel and using MCP as a data synthesis layer." link="https://youtu.be/NQygWnSViZc?si=cFEc1aGyEKZClWg9" />
...
<Frame>
  ![image](/images/mcp-synthesis.png)
</Frame>
