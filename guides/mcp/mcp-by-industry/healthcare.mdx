...
description: "Use Cases and Sample Prompts"
---
...
<Note>
  **New to MCP?** Start with [Explore Data with AI](/guides/mcp) for setup instructions and foundational concepts before diving into industry-specific use cases.
</Note>
...
<Tabs>
  ...
  <Tab title="Clinical / Operations Lead">
...
👉 **Next step**: See the [MCP by Industry](/guides/mcp/mcp-by-industry) page for other industry guides, or visit [MCP Integration Pairings](/guides/mcp/integrations) to explore what each data connection unlocks.
