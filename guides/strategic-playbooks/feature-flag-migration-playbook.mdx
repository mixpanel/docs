...
| :-- | :-- | :-- | :-- | :-- |
| Experiment | `statsig::experiment_exposure` | Streaming: `Feature` event - `reason.inExperiment` = true<br/><br/>Warehouse: `evaluation_events` - `experiment_iteration_id` != NULL | `campaign_activated` event/decisions dataset | Experiment Viewed |
| Feature Gate | `statsig::gate_exposure` | Streaming: `Feature` event - `reason.inExperiment` is absent/false<br/><br/>Warehouse: `evaluation_events` -  `experiment_iteration_id` is absent | Feature Rollout | (no gate exposure concept) |
| Dynamic Configuration | `statsig::config_exposure` | Streaming: `Feature` event - `reason.inExperiment` is absent/false<br/><br/>Warehouse: `evaluation_events` - `experiment_iteration_id` is absent | Flag with Variables | (no config exposure concept) |
