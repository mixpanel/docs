...
| :-- | :-- | :-- | :-- | :-- |
| Experiment | `statsig::experiment_exposure` | *Streaming* <br/>- event: `Feature` <br/>property: `reason.inExperiment` = true<br/><br/>*Warehouse*: <br/>- table: `evaluation_events` <br/>- column: `experiment_iteration_id` != NULL | event/decisions dataset: `campaign_activated` | Experiment Viewed |
| Feature Gate | `statsig::gate_exposure` | *Streaming*: <br/>- event: `Feature` <br/>property: `reason.inExperiment` is absent/false<br/><br/>*Warehouse*: <br/>- table: `evaluation_events` <br/>- column: `experiment_iteration_id` is absent | Feature Rollout | (no gate exposure concept) |
| Dynamic Configuration | `statsig::config_exposure` | *Streaming*: <br/>- event: `Feature` <br/>property: `reason.inExperiment` is absent/false<br/><br/>*Warehouse*: <br/>- table: `evaluation_events` <br/>- column: `experiment_iteration_id` is absent | Flag with Variables | (no config exposure concept) |
