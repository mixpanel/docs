...
<Frame>
![image](/images/tutorials/continuous-iterations.png "Continuous Iterations")
</Frame>
...
- Subscribe to our monthly product newsletter to receive updates on our latest product releases or read our [Changelog](/changelogs).

- Subscribe to Mixpanel system status updates to be alerted on any downtimes [here](https://www.mixpanelstatus.com/).

Should you have any feedback you want to share, simply click Submit Feedback in the Mixpanel UI.

<Frame>
![image](/images/tutorials/submit-feedback.png "Submit Feedback")
</Frame>
