---
sidebarTitle: "Stage 2: Intermediate"
title: Intermediate
description: "Intermediate product analytics strategy for growing teams"
---
...
<div className="flex items-start gap-5 justify-between my-[50px] max-[766px]:block">
  ...
  <div className="w-4/5 max-[766px]:w-full">
    ...
    <div className="text-base mt-4">**Vince Maniago**</div> *VP of Product Management, Empower*
  </div>
</div>
...
[Read Stage 03: Advanced →](/guides/strategic-playbooks/product-analytics-strategy/advanced)
