...
- If you haven’t done so already, consider running an [analytics strategy session](/guides/strategic-playbooks/onboarding-playbook) to develop a framework of KPIs and identify the events and properties that are needed to unlock this analysis.
