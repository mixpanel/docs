...
If you’re looking for details on how to use one of those surfaces or define your event schema, check out the guides on [Mixpanel Agent](/guides/mixpanel-agent), [MCP](/guides/mcp), [Headless](/guides/headless), or [event schema](/docs/data-structure/events-and-properties).
...
**Project context** describes the domain a specific project covers and how it's used. [Project owners and admins, along with anyone assigned a Custom Role that includes the ability to edit project settings, can view and edit it in Settings](/docs/business-context#edit-project-context). Everyone else with project access can't view project context in Settings, but has read-only access to it through the in-product Mixpanel AI or MCP. Either way, agents use your business context to enhance their responses for all users, regardless of view permissions.
