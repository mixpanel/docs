...
**Project context** describes the domain a specific project covers and how it's used. [Project owners and admins, along with anyone assigned a Custom Role that includes the ability to edit project settings, can view and edit it in Settings](/docs/business-context#edit-project-context). Everyone else with project access can't open the Settings page, but has read-only access to project context through the in-product Mixpanel AI or MCP. Either way, agents use your business context to enhance their responses for all users, regardless of view permissions.
