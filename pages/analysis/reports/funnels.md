...
3. Exclusion steps have the same [two second grace period](/analysis/reports/funnels#faq#how-does-mixpanel-handle-simultaneous-events) as other steps in the funnel.
...
In statistical hypothesis testing, the p-value or probability value is the probability that the variation in a segment’s conversion rate, compared to the overall conversion rate, is not driven by a random chance. This value is shown for every segment by default. To learn more about how this is calculated, click [here](/analysis/reports/funnels#faq-Funnels-FAQ#how-does-mixpanel-calculate-statistical-significance).
