...
Navigate to Project Settings > Warehouse Sources to get started today. For more information, check out our docs on setting up via [BigQuery](https://docs.mixpanel.com/docs/tracking-methods/data-warehouse/bigquery) and [Snowflake](https://docs.mixpanel.com/docs/tracking-methods/data-warehouse/bigquery).
