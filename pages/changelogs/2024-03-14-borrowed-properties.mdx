...
Borrowed Properties is available for customers on Growth & Enterprise plans. For more information, check out our [help docs.](https://docs.mixpanel.com/docs/features/custom-properties#borrowed-properties)
