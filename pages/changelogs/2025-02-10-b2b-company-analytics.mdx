...
[Two new features built for B2B analysis](https://docs.mixpanel.com/docs/data-structure/group-analytics#how-is-b2b-company-analytics-different-than-group-analytics) are now available for customers with the [Group Analytics](https://docs.mixpanel.com/docs/data-structure/group-analytics) add-on! You can now improve adoption and reduce churn risk by monitoring strategic accounts with out-of-the-box **Account Profiles** and **Activation Metrics**.
...
To access the new features, customers will need the Group Analytics add-on. In addition, you will need to turn on the advanced B2B Account Analytics functionality, steps for which are [here](https://docs.mixpanel.com/docs/data-structure/group-analytics#setup-b2b-company-key).

Once done, [Account Profiles](https://docs.mixpanel.com/docs/features/advanced#company-profiles) will automatically be created per each account, and can be accessed in the Users tab. You can also share Account Profiles with key stakeholders for simple account health reporting, such as Sales teams, Customer Success teams, and executives.

To identify your [Account Activation Metrics](https://docs.mixpanel.com/docs/features/advanced#activation-metrics), head over to an insights report and use the new computed property now available: **Number of users who did… (then select an event)**. This property makes it easy to create reports to track account activation, i.e., their adoption progress as an account.
...
*Requires ingesting revenue data from [Data Warehouse Connectors](https://docs.mixpanel.com/docs/tracking-methods/warehouse-connectors).
