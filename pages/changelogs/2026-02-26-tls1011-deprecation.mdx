...
For a comprehensive list of environments that may still use TLS 1.0/11, we recommend visiting the Browser/OS Official Documentation or you can refer to the [TLS Support Version History](https://en.wikipedia.org/wiki/Version_history_for_TLS/SSL_support_in_web_browsers) (External Resource).
