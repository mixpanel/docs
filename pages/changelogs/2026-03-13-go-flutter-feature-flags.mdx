...
date: "2026-03-13"
description: "Feature Flags and Experiments are now supported in Go (server-side) and Flutter (client-side) SDKs."
---
<ChangelogPostHeader
  date="2026-03-13"
  title="Feature Flags + Experiments: Now on Go and Flutter"
...
Learn more →
- [Go SDK](https://docs.mixpanel.com/docs/tracking-methods/sdks/go/go-flags) | [Github](https://github.com/mixpanel/mixpanel-go)
- [Flutter SDK](https://docs.mixpanel.com/docs/tracking-methods/sdks/flutter/flutter-flags) | [Github](https://github.com/mixpanel/mixpanel-flutter)
