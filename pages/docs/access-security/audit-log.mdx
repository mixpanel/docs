...
- **Organization-level logs** — Found in Organization Settings. Accessible to organization admins and owners, these logs capture all events across the organization, including user authentication, service account management, and organization-wide changes.
