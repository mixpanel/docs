...
Audit logs can be accessed at two levels by users with Admin or Owner roles in the organization:
...
- **Custom Roles** - 2026-03-31T19:00:00Z
...
You can export your audit logs to CSV format for further analysis or archival purposes. The export will contain the raw data information for each event.
...
Only users with Admin or Owner roles in an organization can view audit logs for that organization or project.
