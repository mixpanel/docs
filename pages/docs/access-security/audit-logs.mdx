...
1. **Navigate to Organization Settings or Project Settings** by clicking the gear icon in the top navigation.
...
![Audit logs in Organization Settings](/auditLogsOrganizationView.png)
...
![Exporting audit logs to CSV](/auditLogsExport.png)
...
#### Can I set up alerts based on audit log events?

Audit log events are tracked for visibility and compliance purposes. For security monitoring, consider using Mixpanel's alert functionality on your data or integrating audit log exports with your security information and event management (SIEM) system.

#### What's the difference between organization and project audit logs?

Organization audit logs track organization-wide events like user authentication and service account creation. Project audit logs track project-specific events like report creation and data exports. Some events appear in both logs depending on their scope.
