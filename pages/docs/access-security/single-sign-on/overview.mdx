...
<Callout type="info">
  The SCIM endpoint only affects users whose email has a domain in the list of your verified claimed domains.
</Callout>
...
If you need to remove all of your SSO configuration, you can do so with the "Remove SSO Configuration" button. This option is available if you have configured Single Sign-On and it is disabled. This will clear the settings and SAML certificate cleared, as well as entries that facilitate the Single Sign-On process.
