...
- [Project Token, API / Project Secret](/docs/quickstart/connect-your-data)
- [Data Governance: Event Approval](/docs/data-governance/event-approval)
- [Group Analytics](/docs/data-structure/advanced/group-analytics)
- [Session Settings](/docs/features/sessions)
- [Identity Merge](/docs/tracking-methods/id-management/identifying-users)
