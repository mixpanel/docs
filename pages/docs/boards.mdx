...
* If you are on the Enterprise plan, you would have access to Pinned Filters. You would need to click the three dots besides the existing filter, then the "Edit" button. Once you've updated the filter, you would need to click the "Apply" button. To save your changes to the board, please click "Save". 
