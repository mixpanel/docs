...
* If you are on the Enterprise plan, you would have access to [Pinned Filters](https://docs.mixpanel.com/changelogs/2025-01-10-pinned-filters). You would need to click the three dots besides the existing filter, then the "Edit" button. Once you've updated the filter, you would need to click the "Apply" button. To save your changes to the board, please click "Save". 
