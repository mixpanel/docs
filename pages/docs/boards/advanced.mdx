...
Subscriptions will send the board on a recurring schedule. You can choose a daily, weekly or monthly interval. Note that digests only show the 8 reports that are on the top of a board.
