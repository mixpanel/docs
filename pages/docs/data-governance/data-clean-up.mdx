...
4. Select time range (cannot be more than 90 days in the past)
...
Please refer to 'Reminders with ETL Approach' section as you proceed, and submit feedback (accessible in-app with our help menu) if this is a blocker for you and your


### Other resources

- [Event Approval](/changelogs/2023-06-01-event-approval)
- [Recovering from a hot shard](/do/debuggg/disnct-id-limits)
