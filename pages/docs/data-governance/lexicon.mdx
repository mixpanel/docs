...
When you open Lexicon, you see six tabs:
...
| Field | Description |
| --- | --- |
| Event Name | The database name of the event. Status Icons indicate whether event is hidden or visible in the Mixpanel project |
...
| Field | Description |
| --- | --- |
| Event Name | The database name of the property. |
