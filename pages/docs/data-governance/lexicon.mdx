...
Saved [Formulas](/docs/reports/insights#formulas) and [Funnels/Retention Behaviors](/docs/features/saved-metrics-and-behaviors#saved-behaviors) in your project are also documented in your Lexicon. Review here to get an overview of existing definitions in your project that you can quickly leverage in your own analysis.
