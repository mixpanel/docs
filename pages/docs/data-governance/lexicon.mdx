...
![Lexicon Drop Events](/lexicon-block-event.png)
...
2. Click **Block**. A warning indicates that you cannot recover the data that you choose to drop. Click Block to confirm. The status of the property will indicate Blocked.
