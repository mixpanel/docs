...
| Queries | The total number of UI queries that project members executed in the last 30 days. |
...
3. In the top right corner, click the 'Verified' button
...
![verifyButton](/public/verifyButton.png)
