...
For incremental JSON pipelines, data older than 10 days will be exported as they are ingested. However, that is not the case for Raw and Schematized pipelines — manual intervention will be needed to export your data older than 10 days into your data warehouse.
