...
<details>
<summary><strong>2025-06-26 (EU and IN): Pipeline System Improvements By Incremental Export</strong></summary>
...
You can find out more about [Incremental Export here](docs/data-pipelines/json-pipelines#whats-affected).
</details>
