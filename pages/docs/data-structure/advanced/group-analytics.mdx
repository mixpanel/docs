...
[Session events](https://docs.mixpanel.com/docs/features/sessions) are not supported when analyzing by groups in a report.
...
curl --request POST \
  ...
  --data 'filter_by_cohort={"id": 1234567}' \
  --data data_group_id=12345678910
```
