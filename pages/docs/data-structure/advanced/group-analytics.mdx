...
The limits below ensure reports using group analytics perform correctly. This is especially when they are analyzed against user level data (e.g. break down my user funnel by company group key):
