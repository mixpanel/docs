...
{<h3>Click the "..." button next to the breakdown property from your report and choose "Map Lookup Table".</h3>}
...
{<h3>Select a Lookup Table to map to the breakdown property.</h3>}
