...
- Note: Editing of list properties is not supported directly within the Mixpanel UI. To modify list properties, you must use the Mixpanel API or one of our SDKs.
