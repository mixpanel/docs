...
You can export data from your project using a variety of methods, including lightweight CSVs generated from the UI, large volume raw data export from our APIs, and data syncs to external destinations through [Cohort Syncs](/docs/cohort-sync/overview) and [Data Pipelines](/docs/data-pipelines/overview).

var endUserDataLink = <a href="https://docs.mixpanel.com/docs/privacy/end-user-data-management">this page</a>;
<Callout type="info">
  For GDPR/CCPA compliant exports, please see {endUserDataLink} on End User Data Management.
</Callout>
...
<Callout type="warning">
  The from_date and to_date parameter are in UTC timezone, regardless of your project's timezone setting.
</Callout>
...
You can sync your Mixpanel data to your other destinations using our native connectors. Learn more about the [Data Pipeline]((/docs/data-pipelines/overview) for warehouse syncs and [Cohort Syncs]((/docs/cohort-sync/overview) for audience targeting.
