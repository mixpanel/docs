...
A feature flag API request is a call made by your application to a Feature Flag system’s API to determine **which all features** should be enabled or disabled, or which variant should be serverd to a user. All the active flags in the system are evaluated as part of this API request.  
