...
- **Rollout Groups** - the configuration determining which users are in the rollout. This is comprised of:
    ...
    - **Runtime Rule Filter** - a targeting method that checks data available at runtime against Runtime Property or Runtime Event configuration
...
Runtime targeting enables immediate, per-request decisions. There are two methods:
...
<Cards>
  ...
  <Cards.Card icon title="Flutter (Beta)" href="/docs/tracking-methods/sdks/flutter/flutter-flags" />
