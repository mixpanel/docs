...
![image.png](/webhookalert1.png)

1. Complete the webhook configuration:
...
2. Click **Test connection** to verify connectivity to your endpoint
...
1. Complete the rest of your alert configuration and save
