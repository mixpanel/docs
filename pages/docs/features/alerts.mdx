...
{/* RCA lives on its own top-level page at */}
{/* /docs/features/root-cause-analysis. This section is now just a */}
...
When an alert fires, you can launch AI-powered [Root Cause Analysis](/docs/features/root-cause-analysis) directly from the trigger notification to automatically diagnose what drove the change. See the [Root Cause Analysis](/docs/features/root-cause-analysis) page for the full feature.
