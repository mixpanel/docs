...
<img src="/webhookalert1.png" alt="Webhook configuration interface" style={{maxWidth: '50%'}} />
...
<img src="/webhookalert2.png" alt="Webhook selection in alert notification settings" width="500" />
