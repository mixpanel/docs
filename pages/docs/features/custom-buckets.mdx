...
No, the operators have been fixed. The lower bound is inclusive (≥), and the upper bound is exclusive (<). If you are looking for more control over the operators, please create a [custom property](/docs/features/custom-properties#creating-a-custom-property).
