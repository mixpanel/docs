...
You also want to name and save this bucketing as a property that everyone else in your company can use. You can do this with custom properties. You can also use the [Channel Classifier](/changelogs/2023-11-16-channel-classifier) template in custom properties as a starting point.
