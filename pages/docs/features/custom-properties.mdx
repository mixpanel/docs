...
|parse_url()| Extracts the part of the url that is specified: domain(google) or full_domain(google.co.uk) | parse_url(string property, part of url) <br /><br />Example: parse_url(A,"domain") |
