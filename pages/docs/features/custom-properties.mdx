...
![image](/create-custom-property.png)
...
- Borrowing of a property is strictly from the most recent event in the 7 day lookback window. To elaborate
    - Say on event “purchase”, you want to borrow property “search term” from an event “search product”. If there are multiple events “search product” before “purchase”, the property will be borrowed from the most recent “search product” event
