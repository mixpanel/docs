...
You also want to name and save this bucketing as a property that everyone else in your company can use. You can do this with custom properties. Checkout our pre-built [Channel Classifier](/changelogs/2023-11-16-channel-classifier):
