...
- Query: "What did this user do before they submitted positive feedback?"
- Business Value: Understand user context and behavior patterns by combining event data with visual replay footage

- Query: "What features does this user use most? Analyze their session replays"
- Business Value: Better understand specific customers usage patterns without building reports or watching dozens of replays
...
- Query: "Analyze all replays for user [user_id] and identify common patterns"
- Business Value: Surface themes and patterns across multiple replays for faster, more comprehensive user analysis
