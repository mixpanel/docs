...
A saved behavior is a custom funnel or retention behavior definition that you can save. When saving a behavior you specify all of the steps as well as any filter that pertain to any of the steps, as well as the conversion criteria. A saved behavior is not a metric and does not include the [measurement](/docs/reports/overview#measurements).
