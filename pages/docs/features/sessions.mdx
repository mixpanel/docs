...
<Callout icon="🚧" theme="warn">
    Events hidden in Lexicon are excluded from session calculations by default so you may notice session numbers change if you change an events status in Lexicon.                     </Callout>     
