...
Read more about best practices for Group Analytics in Mixpanel [here](/docs/features/group-analytics).
...
5. Select the Table.
6. Specify what group key this table contains. See more about setting up Group keys [here](/docs/features/group-analytics#group-keys-in-project-settings).
