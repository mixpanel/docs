...
Once enabled:
- Any Mixpanel user in your organization can connect using their own credentials
- Users can only access projects they already have permission to view in Mixpanel
- The roles & permissions of the user will be applied to their MCP access as well
