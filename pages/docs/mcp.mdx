...
<Callout type="info">
  **Admin setup required.** An organization owner / admin must enable MCP in **Settings → Org → Overview** before anyone can connect. Changes can take up to 15 minutes to take effect.
</Callout>
