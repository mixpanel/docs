...
- Go to the [Mixpanel App](https://chatgpt.com/apps/mixpanel/asdk_app_69b2e9aed45c8191b254b207dfcc2bb4), click **Connect**, and complete the Mixpanel OAuth flow.
- For EU or IN regions:
  ...
  4. Optionally publish the custom Mixpanel app to your workspace so teammates can use it
