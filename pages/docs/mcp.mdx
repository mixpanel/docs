...
- For EU or IN regions, add your [MCP Server URL](#mcp-server-urls) as a custom connector. See the [Claude documentation](https://support.claude.com/en/articles/11176164-use-connectors-to-extend-claude-s-capabilities#h_4201f9e625) on adding custom connectors.
