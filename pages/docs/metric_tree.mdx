...
Make your tree more actionable for yourself and the team by adding context to it - whether it is pinned content with some interesting deep dive reports, or examining correlation and finding interesting insights to add to the logbook. You can learn more [here](/docs/metric_tree#add-important-insights-to-the-logbook-for-future-reference).
