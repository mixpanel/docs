...
Make your tree more actionable for yourself and the team by adding context to it - whether it is pinned content with some interesting deep dive reports, or examining correlation and finding interesting insights to add to the logbook. You can learn more [here](https://docs.mixpanel.com/docs/metric_tree#customize-each-metric).
...
<img src="/metrictree5.png" width="600" height="380"/>
...
<img src="/metrictree8.png" width="495" height="225"/>
