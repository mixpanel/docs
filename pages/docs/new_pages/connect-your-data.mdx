...
<Tabs items={['Javascipt', 'Python', 'Node', 'Go', 'Ruby', 'Java', 'React Native', 'Flutter', 'iOS (Objective-C)', 'iOS (Swift)', 'Android', 'Unity']}>
<Tab>
...
Note: For XCode 12.5+, there is a known compile issue, please refer to this [workaround](https://github.com/mixpanel/mixpanel-react-native/issues/43#issuecomment-829599732).</tab>
...
**Carthage**
Add `github "mixpanel/mixpanel-iphone"` to your Cartfile.</tab>
