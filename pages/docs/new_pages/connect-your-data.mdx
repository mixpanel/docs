...
<Tabs items={['Javascipt', 'Python', 'Node', 'Go', 'Ruby', 'Java', 'React Native', 'Flutter', 'iOS (Objective-C)', 'iOS (Swift)', 'Android', 'Unity', 'HTTP API']}>
<Tab>
...
<Tab>
You can use Mixpanel's Python SDK to send events from your backend servers to Mixpanel. We [recommend](/docs/getting-started/what-should-I-track#how-to-track) server-side tracking, since it is more reliable and easier to maintain than web/mobile tracking.
...
<Tab>
You can use Mixpanel's Node SDK to send events from your backend servers to Mixpanel. We [recommend](/docs/getting-started/what-should-I-track#how-to-track) server-side tracking, since it is more reliable and easier to maintain than web/mobile tracking.
...
<Tab>
You can use Mixpanel's Go SDK to send events from your backend servers to Mixpanel. We [recommend](/docs/getting-started/what-should-I-track#how-to-track) server-side tracking, since it is more reliable and easier to maintain than web/mobile tracking.
...
<Tab>
You can use Mixpanel's Ruby SDK to send events from your backend servers to Mixpanel. We [recommend](/docs/getting-started/what-should-I-track#how-to-track) server-side tracking, since it is more reliable and easier to maintain than web/mobile tracking.
...
<Tab>
You can use Mixpanel's Java SDK to send events from your backend servers to Mixpanel. We [recommend](/docs/getting-started/what-should-I-track#how-to-track) server-side tracking, since it is more reliable and easier to maintain than web/mobile tracking.
