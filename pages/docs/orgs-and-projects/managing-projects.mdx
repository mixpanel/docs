...
ou can reset the API Secret and API Keys for any projects you own. To do so, go to **Settings** → **Profile** → **Projects** → **Your Projects**, and click **Reset** next to the desired project.
