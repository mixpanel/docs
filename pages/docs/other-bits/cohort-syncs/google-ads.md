...
### One-Time Export
In a one-time export, Mixpanel sends Google Ads a static export of users who currently qualify for the cohort. The cohort data will not be updated in Appcues after a one-time export.
