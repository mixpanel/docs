...
As of Sept 12th, 2023, Mixpanel is piloting the use of a chatbot powered by [kapa.ai](https://kapa.ai) in the Mixpanel Slack Community. [kapa.ai](https://kapa.ai)'s chatbot generates responses to your questions automatically by leveraging [OpenAI LLC's](https://open.ai) generative AI model, trained using Mixpanel's Docs. Your questions and answers to the @kapa.ai will be processed by [Kapa.ai](https://kapa.ai) and [Open.ai](https://open.ai).
