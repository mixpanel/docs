...
You can update user profile properties via [Mixpanel SDK](https://developer.mixpanel.com/docs/javascript#setting-profile-properties) or [Engage API](/reference/ingestion/profiles#set). The following are the operations supported in Mixpanel.
