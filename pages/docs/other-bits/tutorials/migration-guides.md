...
- If you have a data warehouse: Leverage our [data warehouse connector](/docs/implementation/data-warehouse/overview) or our [Import API](https://developer.mixpanel.com/reference/import-events) to import to Mixpanel. 
