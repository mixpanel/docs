...
![Events Usage](/../main/public/2026_Plan_Details_Billing_tab.png)

![Historic Usage](/../main/public/2026_Data_Usage_tab.png)
...
<Callout type="info">
Any of the following actions can only be done by "Owner" and "Billing Admin" users. Learn more about [Roles and Permissions](https://docs.mixpanel.com/docs/orgs-and-projects/roles-and-permissions).  
...
To update your credit card or download invoices:  

1. Click the gear icon in the lower-left corner of your screen, then select “Organization Settings”.
2. Once there, click the “Plan Details & Billing” tab, "Billing Info" tab, and finally the “Manage Billing & Payment” button.

![Manage Billing & Payment](/../main/public/2026_Manage_Billing_Payment_button.png)
...
![Edit Payment Method](/../main/public/2026_Update_Credit_Card.png)
...
![Switch to Free](/../main/public/2026_Downgrade_To_Free.png)
...
In either of the following scenarios, **Mixpanel won't stop collecting your data**:  
- If you sent more data than your Free plan allows, your access will be temporarily blocked until you either upgrade to a Growth plan or the new billing cycle begins next month.  
- If you sent more data than your Growth plan allows, the additional cost will be charged at the beginning of the next month based on your "à la carte" data rate, which you can find in the "Data Usage" tab in the Plan Details & Billing" section of your organization's Settings.

Organization owners and billing admins are sent email alerts if their paid account reaches one of the following percentages of their plan volume: 85%, 100%, 110%, 120%, 200%, 300%, and 400%. It is possible to receive multiple alerts in a month if an account reaches two or more of the thresholds mentioned above.
...
At this moment, it’s not possible to set a billing limit. However, you can read [this article](https://github.com/orgs/mixpanel/discussions/526) to learn how to create a report and get warning alerts when you’re close to exceeding your plan limit.
...
If you are an existing customer on an MTU plan, refer to our [MTU Pricing Guide](https://docs.mixpanel.com/docs/pricing/legacy-mtu-billing).
