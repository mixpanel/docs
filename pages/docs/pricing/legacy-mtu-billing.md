...
To assist in analyzing potential sources of MTU spikes, create a copy of [this board (opens in a new tab)](https://mixpanel.com/project/2195193/view/139237/app/boards#id=5762529) from our demo project into the main project contributing to MTU charges. As you open the board linked above, you can click on the 3 dots menu located on the top right hand corner of the board to duplicate the board, and then move the duplicated board into your project.  
