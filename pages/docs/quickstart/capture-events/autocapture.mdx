...
Autocapture is currently available for web only via Mixpanel’s [Javascript SDK]((https://docs.mixpanel.com/docs/tracking-methods/sdks/javascript)). To turn it on, ensure you have the config `{autocapture: true}` set in the SDK.
