...
<ExtendedAccordion title="Why aren't my events showing up?">
...
<ExtendedAccordion title="What are the recommended configuration options?">
...
<ExtendedAccordion title="How do I connect events from logged out vs logged in users?">
