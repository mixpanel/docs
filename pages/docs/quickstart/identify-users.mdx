...
Tracking this information allows you to create groups of users, aka **Cohorts**, and filter for certain users, which will aid you in identifying 
trends and insights.
...
or user profile update. Examples include: location, operating system, device, etc. Mixpanel calls this automatically
generated data "Default Properties".

[Read More About Default Properties](/docs/data-structure/property-reference#default-properties)
</FAQBox>