...
# Framework Guides
<Cards>
  <Cards.Card icon title="Next.js" href="/docs/quickstart/install-mixpanel/nextjsguide" />
  <Cards.Card icon title="Wordpress" href="/docs/quickstart/install-mixpanel/wordpress" />
  <Cards.Card icon title="Segment" href="/docs/quickstart/install-mixpanel/segmentwithautocapture" />
</Cards>
