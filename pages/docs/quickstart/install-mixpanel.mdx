...
<Callout type="info" emoji>
  **Tip** If you already collect product data, checkout our guides to connect with Mixpanel via your [Data Warehouse](/docs/tracking-methods/data-warehouse) or [3rd Party Integrations]().
</Callout>

## Install

Installing Mixpanel is easy. We recommend serverside methods, especially for the web. If you're not sure which method to use, [read our guide](/docs/tracking-methods/choosing-the-right-method).
...
Sending data to Mixpanel via HTTP does not require an installation. **You're ready to move to the next step.**
