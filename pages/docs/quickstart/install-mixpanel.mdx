...
<Callout type="info" emoji>
  **Tip** If you already collect product data, check out our guides to connect with Mixpanel via your 
  [Data Warehouse](/docs/tracking-methods/data-warehouse) or 
  [3rd Party Integrations](/docs/tracking-methods/integrations/).
</Callout>

## Overview

Installing Mixpanel is easy. We recommend server-side methods, especially for the web. 

## Code

Choose the platform that works best for you. If you're not sure which method to use, [read our guide](/docs/tracking-methods/choosing-the-right-method).
...
<div className="bg-base100 rounded-xl">
    <h2 className="text-2xl font-medium mb-2 color:bg-purple200">Next: Identify Your Users</h2>
