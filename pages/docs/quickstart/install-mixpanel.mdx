...
<FAQBox title="Does Mixpanel use third-party cookies?">
  ...
  When tracking on web and cross-subdomain tracking is not needed, we recommend using localStorage 
  persistence. This option also entirely avoids setting or using any first- or third-party cookies.
</FAQBox>
