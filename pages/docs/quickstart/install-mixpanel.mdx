...
# Framework Guides
<Cards>
  <Cards.Card icon title="Next.js" href="/docs/quickstart/install-mixpanel/nextjs-guide" />
  <Cards.Card icon title="Wordpress" href="/docs/quickstart/install-mixpanel/wordpress" />
  <Cards.Card icon title="Segment" href="/docs/quickstart/install-mixpanel/segment-with-autocapture" />
</Cards>
