...
<ExtendedAccordion title="Does Mixpanel automatically track page views?">
...
<ExtendedAccordion title="What are the recommended web configuration options?">
...
<ExtendedAccordion title="Does Mixpanel use third-party cookies?">
...
<ExtendedAccordion title="How can I track in a privacy compliant way?">
