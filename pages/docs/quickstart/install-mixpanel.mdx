...
Installing Mixpanel is easy. We recommend serverside methods, especially for the web. Not sure which method to choose? [Read our guide](/docs/tracking-method/choosing-the-right-method)
