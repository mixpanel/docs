...
Installing Mixpanel is easy. We recommend serverside methods, especially for the web. If you're not sure which method to use, [read our guide](/docs/tracking-method/choosing-the-right-method).
