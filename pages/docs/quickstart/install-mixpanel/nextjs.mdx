...
4. Initialize Mixpanel in your Next.js application
   ...
   **If using page router**, open or create the file `_app.js` or `app.tsx` in your pages/ directory. Then import and initialize Mixpanel inside `useEffect`. You’ll also need to track pageviews manually using `useRouter`.
  ...
  **If using app router**, open or create the file `layout.js` or `layout.tsx` in your app/ directory
