...
<div class="bg-base100 rounded-xl">
    <h2 class="text-2xl font-medium mb-2 color:bg-purple200">You're ready to start using Mixpanel</h2>
...
{/*
<div class="bg-base100 rounded-xl">
    <h2 class="text-2xl font-medium mb-2 color:bg-purple200">Optional: Tips & Tricks</h2>
