...
Depending on the behavior, certain measurements may be not be possible. For example, for a single event, you cannot measure the conversion rate of it.  The measurement is chosen at the bottom left area of the metric.
