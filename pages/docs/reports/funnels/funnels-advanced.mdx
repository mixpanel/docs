...
<Cards>
  <Cards.Card icon title="Conversion Criteria" href="/docs/reports/funnels/funnels-advanced#conversion-criteria" />
  <Cards.Card icon title="Exclusion Steps" href="/docs/reports/funnels/funnels-advanced#exclusion-steps-exclude-users-who-did" />
  <Cards.Card icon title="Saved Funnels Behavior" href="/docs/reports/funnels/funnels-advanced#saved-funnel-behaviors" />
  <Cards.Card icon title="Counting Methods and Measurements" href="/docs/reports/funnels/funnels-advanced#counting-methods-and-measurements" />
  <Cards.Card icon title="Time to Convert" href="/docs/reports/funnels/funnels-advanced#time-to-convert" />
  <Cards.Card icon title="Property Sum" href="/docs/reports/funnels/funnels-advanced#property-sum" />
  <Cards.Card icon title="Behavioral Properties" href="/docs/reports/funnels/funnels-advanced#behavioral-properties" />
  <Cards.Card icon title="Attributed by... Breakdowns" href="/docs/reports/funnels/funnels-advanced#attributed-by-breakdown" />
  <Cards.Card icon title="Comparison Events" href="/docs/reports/funnels/funnels-advanced#comparison-events" />
  <Cards.Card icon title="Breakdowns" href="/docs/reports/funnels/funnels-advanced#breakdowns" />
  <Cards.Card icon title="Filters" href="/docs/reports/funnels/funnels-advanced#filters" />
  <Cards.Card icon title="Property Attribution" href="/docs/reports/funnels/funnels-advanced#property-attribution" />
  <Cards.Card icon title="View as Flow" href="/docs/reports/funnels/funnels-advanced#view-as-flow" />
  <Cards.Card icon title="Rename a Step" href="/docs/reports/funnels/funnels-advanced#rename-a-step" />
</Cards>
