...
> Which app version promotes the best retention after signup, for users on Chrome?
...
### Quick Start - New Retention

If you are on the beta retention experience, follow this guide. The core concepts all stay the same, but some things are slightly rearranged. You can watch the video below to get a preview of what's changed.

<p style={{ position: 'relative', paddingBottom: '56.25%', height: 0, overflow: 'hidden' }}>
  <iframe src="https://www.loom.com/embed/df20b07ac50f497f80cd3bfce6f6ae9b" frameborder="0" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%' }} allowfullscreen></iframe>
</p>
