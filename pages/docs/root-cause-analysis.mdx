...
# AI-Powered Root Cause Analysis: AI-generated explanations for why your metrics changed
...
When you run an RCA, Mixpanel will immediately launch a new board, then expose its reasoning as it works through the data:
1. **Validates the anomaly.** The agent first investigates there really is a meaningful change to explain.
