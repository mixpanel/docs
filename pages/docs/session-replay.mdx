...
For customers who have purchased the Session Replay add-on, if you exceed your purchased limit, you'll be billed at the per-unit rate. We’ll notify “Owner” and “Billing Admin” users via email before this happens. 

Customers also can use Session Replay without purchasing our add-on (for example, using complimentary replays included with your plan). For these customers, if you exceed your complimentary replay limit, replays will not be viewable until you upgrade your plan / purchase the add-on. 

Mixpanel may stop ingesting replays if you exceed your purchased or allocated limit. This also applies to customers that remove the Session Replay add-on. We’ll notify “Owner” and “Billing Admin” users and display in-product banners before replays are dropped. To avoid disruption, monitor your usage in Mixpanel and consult your Account Manager if needed.
