...
The Replay Player has three main areas: the Player Area, the Replay Feed, and the Details Panel.
...
The Replay Feed on the left side of the player lets you browse and find replays:
