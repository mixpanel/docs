...
You can use Session Replay with CDPs (e.g., Segment and mParticle) for the web platform. Your app must include the Mixpanel Javascript SDK, with Session Replay enabled. Learn more in the technical guide [here](/docs/session-replay/implement-session-replay/session-replay-web).
