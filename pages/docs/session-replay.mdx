...
**For customers who have purchased the Session Replay add-on**

If you exceed your purchased limit, you'll be billed at the per-unit rate. We’ll notify “Owner” and “Billing Admin” users via email before this happens. 

**For customers utilizing complimentary Session Replay**

If you exceed your complimentary replay limit, your excess replays will be paywalled from viewing, and eventually dropped from ingestion. For example, if you are a Mixpanel Enterprise customer with access to 20,000 complimentary replays monthly, and your organization exceeds this limit, Mixpanel will not ingest or retain the excess replays beyond a certain point. We’ll notify “Owner” and “Billing Admin” users and display in-product banners before replays are dropped. To avoid disruption, monitor your usage in Mixpanel and consult your Account Manager if needed. 

If you would like access to more monthly replays, then you can upgrade your plan or purchase the add-on by speaking to sales.
