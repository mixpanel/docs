...
<Callout type="info">
By default, user replays are stored for 30 days after the time of ingestion. Enterprise plan customers with paid session replay add-ons can customize this retention period between 7 days and 360 days. Once a replay is expired, there is no way to view that replay.
</Callout>
...
By default, user replays are stored for 30 days after the time of ingestion. Once a replay is expired, there is no way to view that replay. Enterprise plan customers with the paid session replay add-on can customize this retention period between 7 days and 360 days. For more information, reach out to your Account Manager or our sales team. 
