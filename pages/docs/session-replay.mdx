...
| Growth | 20k free Replays per month | You’re on the latest plan if you purchased or edited after April 2024. Confirm or switch on the [pricing page](https://mixpanel.com/pricing/). |
