...
| Growth | 20k free Replays per month | You're on the latest plan if you purchased or edited your plan after April 2024. If you are not sure if your organization is using the latest plan, check your plan details page (Organization Settings > Plan Details & Billing). |
