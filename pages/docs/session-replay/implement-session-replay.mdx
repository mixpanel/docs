...
Session Replay is supported on three platforms: Web, iOS, and Android. Additionally, can use Session Replay with CDPs (e.g., Segment and mParticle) through the Web platform. We also support Electron desktop apps.
