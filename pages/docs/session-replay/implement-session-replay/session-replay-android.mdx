...
This developer guide will assist you in configuring your Android app for [Session Replay](/docs/session-replay) using the [Session Replay SDK (Android)](/docs/tracking-methods/sdks/android-replay). Learn more about [viewing captured Replays in your project here](/docs/session-replay).
