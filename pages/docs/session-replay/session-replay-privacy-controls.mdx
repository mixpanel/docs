...
![Masking vs Blocking](/01-masking-vs-blocking.svg)
...
![Text vs Input Masking](/02-text-vs-input-masking.svg)
...
![Nesting and Inheritance](/03-nesting-inheritance.svg)

## Quick Reference: Which Config Do I Use?

![Configuration Recipes](/04-configuration-recipes.svg)
