...
<Tabs items={['Web', 'Android', 'iOS']}>
  ...
  <Tabs.Tab>HOW SESSION REPLAY WORKS FOR ANDROID</Tabs.Tab>
  <Tabs.Tab>HOW SESSION REPLAY WORKS FOR IOS</Tabs.Tab>
</Tabs>
...
<Tabs items={['Web', 'Android', 'iOS']}>
  ...
  <Tabs.Tab>HOW MASKING WORKS FOR ANDROID</Tabs.Tab>
  <Tabs.Tab>HOW MASKING WORKS FOR IOS</Tabs.Tab>
</Tabs>
...
<Tabs items={['Web', 'Android', 'iOS']}>
  ...
  <Tabs.Tab>CONFIGURING PRIVACY CONTROL FOR ANDROID</Tabs.Tab>
  <Tabs.Tab>CONFIGURING PRIVACY CONTROL FOR IOS</Tabs.Tab>
</Tabs>
...
<Tabs items={['Web', 'Android', 'iOS']}>
  ...
  <Tabs.Tab>HOW TO MASK ELEMENTS FOR ANDROID</Tabs.Tab>
  <Tabs.Tab>HOW TO MASK ELEMENTS FOR IOS</Tabs.Tab>
</Tabs>
