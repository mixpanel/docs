...
<div class="bg-base100 p-0 rounded-xl">
    <h4 class="text-2xl font-medium mb-2 color:bg-purple200">Already know the events you want to track?</h4>
    <p>If you already know what you want to track, you can skip planning and start by install Mixpanel.</p>
    <br></br>
