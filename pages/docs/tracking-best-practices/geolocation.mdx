...
<Callout type="info">
    IP address is an approximation of location. For more granular precision, [set your location using latitude and longitude](/docs/tracking-best-practices/geolocation#ignore-ip-address).
</Callout>
