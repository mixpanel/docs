...
- utm_content: specific link within in an ad that a user clicked
- utm_term: keywords associated with campaigns
- utm_id / utm_campaign_id : unique identification number of a campaign
- utm_source_platform: marketing platform responsible for directing traffic
- utm_creative_format: type of ad creative, example: display, native, video, search
