...
> Note: Mixpanel client-side SDK by default uses [/track API endpoint](https://developer.mixpanel.com/reference/track-event#limits) which by default only ingests events in the last 5 days.
