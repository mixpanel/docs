...
Along with the above list of IPs also whitelist the ips of GCPs Storage Transfer Service which can be found [here](https://www.gstatic.com/storage-transfer-service/ipranges.json).
</Tab>
</ExtendedTabs>
