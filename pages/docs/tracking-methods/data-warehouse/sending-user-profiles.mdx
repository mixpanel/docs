...
Read more about best practices for tracking User Properties in Mixpanel [here](/docs/tracking-specs/user-profiles).
...
7. Optionally, you can select which columns map to [Mixpanel Reserved Properties](/docs/tracking-specs/user-profiles#reserved-user-properties), which receive special treatment in our UI or are used for special processing.
