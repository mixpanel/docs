...
Edit the mapping of the Action to configure your output payload in your desired format. You can configure the output value using the available objects from your source payload on the left side of the UI. On the right side of the UI, you can define the property name for the value in Mixpanel.
