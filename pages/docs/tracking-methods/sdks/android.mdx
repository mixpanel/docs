...
To install the library inside Android Studio, declare it as dependency in your build.gradle file by adding the following line to the `dependecies` section in `app/build.gradle`:
...
The library can be initialized with different configurations. See a complete list of the configuration options [here](https://mixpanel.github.io/mixpanel-android/com/mixpanel/android/mpmetrics/MixpanelAPI.html#getInstance(android.content.Context,java.lang.String,org.json.JSONObject,java.lang.String,boolean)).

```java Java
// initialize Mixpanel with automatic events disabled
trackAutomaticEvents = false;
MixpanelAPI mixpanel = MixpanelAPI.getInstance(this, "YOUR_PROJECT_TOKEN", trackAutomaticEvents);
```
...
A few commonly used people methods are highlighted below:
  ...
  * [`.getPeople().setOnce()`](https://mixpanel.github.io/mixpanel-android/com/mixpanel/android/mpmetrics/MixpanelAPI.People.html#setOnce(org.json.JSONObject)) - set profile properties only if they do not exist (will not overwrite existing properties)
  * [`.getPeople().append()`](https://mixpanel.github.io/mixpanel-android/com/mixpanel/android/mpmetrics/MixpanelAPI.People.html#append(java.lang.String,java.lang.Object)) - append values to a list profile property
  * [`.getPeople().union()`](https://mixpanel.github.io/mixpanel-android/com/mixpanel/android/mpmetrics/MixpanelAPI.People.html#union(java.lang.String,org.json.JSONArray)) - append to a list property, excluding duplicates
  * [`.getPeople().increment()`](https://mixpanel.github.io/mixpanel-android/com/mixpanel/android/mpmetrics/MixpanelAPI.People.html#increment(java.lang.String,double)) - increment/decrement numeric profile properties
...
JSONObject props = new JSONObject();
props.put('name', 'Sam');
props.put('company', 'Store ABC');
props.put('age', 25);
props.put('roles', ['sales','engineer']);
...
A few commonly used group methods are highlighted below:
  * [`.getGroup().setOnce()`](https://mixpanel.github.io/mixpanel-android/com/mixpanel/android/mpmetrics/MixpanelAPI.Group.html#setOnce(org.json.JSONObject)) - set group properties only if they do not exist (will not overwrite existing properties)
  * [`.getGroup().unset()`](https://mixpanel.github.io/mixpanel-android/com/mixpanel/android/mpmetrics/MixpanelAPI.Group.html#unset(java.lang.String)) - remove a group property from a group profile
  * [`.getGroup().union()`](https://mixpanel.github.io/mixpanel-android/com/mixpanel/android/mpmetrics/MixpanelAPI.Group.html#union(java.lang.String,org.json.JSONArray)) - merge a list with a list-valued group property, excluding duplicates
  * [`.getGroup().remove()`](https://mixpanel.github.io/mixpanel-android/com/mixpanel/android/mpmetrics/MixpanelAPI.Group.html#remove(java.lang.String,java.lang.Object)) - remove a value from a list-valued group property
...
props.put('name', 'Mixpanel');
props.put('features', ['reports','alerts','cohorts']);
props.put('employee_count', '100');
...
// disable legacy automatic events
