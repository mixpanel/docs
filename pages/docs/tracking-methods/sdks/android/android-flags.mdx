...
String fallback = "control"; // the value to use if the user is not targeted by the flag
...
boolean fallback = false; // the value to use if the user is not targeted by the flag
