...
To install the library in your [Flutter development environment](https://docs.flutter.dev/get-started/install), declare it as a dependencie in the `pubspec.yaml` file of your package:
