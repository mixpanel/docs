...
A few commonly used people methods are highlighted below:
  ...
  * [`.people setOnce:`](https://mixpanel.github.io/mixpanel-iphone/Classes/MixpanelPeople.html#//api/name/setOnce:) - set profile properties only if they do not exist (will not overwrite existing properties)
  * [`.people append:`](https://mixpanel.github.io/mixpanel-iphone/Classes/MixpanelPeople.html#//api/name/append:) - append values to a list profile property
  * [`.people union:`](https://mixpanel.github.io/mixpanel-iphone/Classes/MixpanelPeople.html#//api/name/union:) - append to a list property, excluding duplicates
  * [`.people increment:by`](https://mixpanel.github.io/mixpanel-android/com/mixpanel/android/mpmetrics/MixpanelAPI.People.html#increment(java.lang.String,double)) - increment/decrement numeric profile properties
...
[[mixpanel getGroup:@"company", groupID:@“mixpanel”] set:@{@"industry": @"analytics"}];
```
...
A few commonly used group methods are highlighted below:
  * [`getGroup:groupID setOnce:`](https://mixpanel.github.io/mixpanel-iphone/Classes/MixpanelGroup.html#//api/name/setOnce:) - set group properties only if they do not exist (will not overwrite existing properties)
  * [`getGroup:groupID unset:`](https://mixpanel.github.io/mixpanel-iphone/Classes/MixpanelGroup.html#//api/name/unset:) - remove a group property from a group profile
  * [`getGroup:groupID union:values:`](https://mixpanel.github.io/mixpanel-iphone/Classes/MixpanelGroup.html#//api/name/union:values:) - merge a list with a list-valued group property, excluding duplicates
  * [`getGroup:groupID remove:value:`](https://mixpanel.github.io/mixpanel-iphone/Classes/MixpanelGroup.html#//api/name/remove:value:) - remove a value from a list-valued group property
