...
- You are on an Enterprise subscription plan and have the appropriate version of the SDK installed (minimum supported version is `1.6.0-flags`). If not, please follow [this doc](/docs/quickstart/install-mixpanel) to install the SDK.
