...
Afterward, start using the library by creating an instance of the Mixpanel object using your project token in your JS file. Any methods called from this object will target your project.
...
The library is available as a package [on NPM](https://www.npmjs.com/package/mixpanel-browser) and [on Yarn](https://classic.yarnpkg.com/en/package/mixpanel-browser). 
