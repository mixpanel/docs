...
Use [npm](https://www.npmjs.com/) to install Mixpanel. The Mixpanel module will be available in the Node project after installing the library.

```bash
npm install mixpanel
```

Next, create a Mixpanel instance to communicate with Mixpanel servers. To do this, grab the Mixpanel factory and create an instance of the Mixpanel client by calling `mixpanel.init('YOUR_PROJECT_TOKEN')` using [your project token](/docs/orgs-and-projects/managing-projects#find-your-project-tokens).
