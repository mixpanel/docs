...
- You are on an Enterprise subscription plan and have the appropriate version of the SDK installed (minimum supported version is [`v5.0.0`](https://github.com/mixpanel/mixpanel-node)). If not, please follow [this doc](/docs/quickstart/install-mixpanel) to install the SDK.
