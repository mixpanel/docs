...
- You are on an Enterprise subscription plan and have the [Mixpanel Ruby SDK](https://github.com/mixpanel/mixpanel-ruby) installed. If not, please follow [this doc](/docs/quickstart/install-mixpanel) to install the SDK. The minimum supported version is [v2.3.0](https://rubygems.org/gems/mixpanel-ruby)
...
# Stop polling when shutting down your application
