...
Install the [Session Replay SDK for Swift](/docs/tracking-methods/sdks/android/swift/swift-replay) to record replay data. Learn more about [Session Replay](/docs/session-replay) and [implementing Session Replay on iOS](/docs/session-replay/implement-session-replay/session-replay-ios).
