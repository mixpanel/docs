...
**Note:** Available only for customer with a paid session replay add-on.
By setting `remote_settings_mode` you can quickly set SDK options for your project in mixpanel under `Settings > Org > Session Replay`.
