...
<Callout type="info">
You can monitor your warehouse syncs and set up alerts for sync health and data volume changes. Learn more in [Warehouse Sync Monitoring](/docs/data-governance/warehouse-sync-monitoring).
</Callout>
