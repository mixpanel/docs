...
3. You should see a new page to create your Postgres connector. Fill out the following fields:
    - **Server Hostname**  - This is the hostname of your Postgres database.
    ...
    - **User Name** - This is the username you want to connect with. Please ensure it has the proper permissions.
    - **Password** - This is the password for the user you want to connect with.
    - **SSL Mode** - To keep your data secure, Mixpanel requires encryption for Postgres connections. You can choose between two SSL modes:
