...
Read more about best practices for tracking User Properties in Mixpanel [here](https://docs.mixpanel.com/docs/how-it-works/user-profiles).
...
7. Optionally, you can select which columns map to [Mixpanel Reserved Properties](https://docs.mixpanel.com/docs/how-it-works/user-profiles#reserved-user-properties), which receive special treatment in our UI or are used for special processing.
