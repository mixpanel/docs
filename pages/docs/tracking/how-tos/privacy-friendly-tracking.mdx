...
Our JavaScript library automatically captures default properties to help enrich your data (full list of default properties available [here](https://docs.mixpanel.com/docs/tracking/reference/default-properties)), your team has the choice to remove these if you'd like. Within our JavaScript library, there's the opportunity to blacklist properties on library load. This is done through a property_blacklist config option. For the correct syntax please reference our [GitHub](https://github.com/mixpanel/mixpanel-js/releases/tag/v2.7.1)
