...
### Does Mixpanel automatically track pageviews?
Yes, if you pass `track_pageview: true` in the `mixpanel.init` call, Mixpanel will automatically track a Pageview event every time a new page is loaded. Learn more [here](/docs/tracking/reference/javascript#tracking-page-views).
