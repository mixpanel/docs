...
🎉 Congratulations, you've tracked your first event! You can see it in Mixpanel via the [Events page](https://mixpanel.com/report/events). For more options, see our [JavaScript reference](/tracking/reference/javascript).
...
We recommend [setting up a proxy server](/tracking/how-tos/tracking-via-proxy) so that you don't lose events due to ad-blockers.
