...
| --- | --- | --- |
| $city | City | The city of the event sender parsed from the IP property. |
| $region | Region | The region (state or province) of the event sender parsed from the IP property. |
| mp_country_code | Country | The country of the event sender parsed from the IP property. |
