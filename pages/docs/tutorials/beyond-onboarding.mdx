...
- [x] Plan your next tracking sprints, by...
      ...
      - Adding new events and properties, and refining existing ones to gain better insights<br />
- [x] Implement your next set of tracking plan, by...
      - Sending your new events and properties from the updated tracking plan
      - Conducting quality and audit checks to ensure data governance before going live<br />
