...
Besides conducting Quality Assurance tests, it's good to keep track of your overall implementation progress by monitoring all the data that is coming into Mixpanel. There's no better way to do this than to use Mixpanel itself. 

Our Customer Success Team has created a [Mixpanel Monitoring Dashboard](https://mixpanel.com/project/2195193/view/139237/app/boards/#id=6051217) that you can copy into your own project to help you track key high-level statistics around your events, properties, and identity management.
