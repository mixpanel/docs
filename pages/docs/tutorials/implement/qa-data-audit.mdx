...
4. Lexicon - Mixpanel's **Lexicon** contains all the metadata about your events and properties. It also contains other metadata about [Custom Events](/docs/features/custom-events), [Custom Properties](/docs/features/custom-properties), [Lookup Tables](/docs/data-structure/lookup-tables), and [Formulas](/changelogs/2023-11-09-saved-formulas) that you would eventualy create in the Mixpanel UI.
   ...
   Lexicon can be used to check naming consistencies across your events and properties and also ensure that you are not sending any event or property that you should not be tracking. For more details refer to our documentation on [Lexicon](/docs/data-governance/lexicon)

For more help, refer to our section on [Debugging](https://docs.mixpanel.com/docs/debugging/overview)
