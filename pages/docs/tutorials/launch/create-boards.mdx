# Overview
If you've gone through our tutorials on how to [send production data into Mixpanel](/docs/implement/send-your-data) and have done so, you can start to create your first Mixpanel boards and reports. 
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/zbbMNJOvxMk?si=v6aUoxoEXlcfrOCZ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</p>
...
In certain instances, e.g. communication with your executives, you might want to send an email digest of the top metrics instead of links to the live board itself. You can do that via [board Digests](/docs/boards/advanced#board-digests). These digests, which can also be sent as Slack messages, allow you to schedule and share the most recent metrics with both project members and external audiences.
