...
Mixpanel's RAE Framework, which stands for **R**each, **A**ctivation, and **E**ngagement, is a simple framework allowing you to focus on 2-3 KPIs / metrics to plan for the events and properties that you need to measure them. This framework also translates into a clearly defined funnel or sequence of events that monitors your product's reach, to enabling user activation, and tracking the level of product engagement.

![image](/tutorials/rae-framework.png "RAE Framework")

### Measure your Product's Value

Your product's metrics and KPIs should be defined around your product's value to your target users. The more value your users derive from your product, the higher the adoption and thus eventually retention.

====

“Value Moments” are the building blocks to successful product adoption
