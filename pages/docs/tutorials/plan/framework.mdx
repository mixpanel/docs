...
Mixpanel's RAE Framework, which stands for **R**each, **A**ctivation, and **E**ngagement, is a simple framework allowing you to focus on 2-3 KPIs / metrics to plan for the events and properties that you need to measure them. This framework also translates into a clearly defined funnel or sequence of events that tracks your product's reach, to monitoring user activation, and measuring the level of product engagement.
