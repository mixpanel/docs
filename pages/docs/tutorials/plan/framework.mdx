...
Output measurement. Leading Metrics, on the other hand, help you anticipate and predict what will happen.

Manipulatable Metrics: Avoid metrics that you can easily manipulate. Include them in your framework instead.

Summary Metrics: Are single action, static snapshot of product usage. All those metrics are important for getting a summary of digital health. But if your goal is to have long-term customers who get enough value out of your product to keep using it, spend lots of money, and recommend it to their friends, those metrics don’t tell you enough.
