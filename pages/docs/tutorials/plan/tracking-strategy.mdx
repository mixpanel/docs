...
> [User Journey Figma](https://www.figma.com/file/tYEeeRE0Xz6IampBhGLotw/Media-and-Entertainment-Tracking-Plan?type=whiteboard&node-id=523-159&t=5GQDQsaqLeOTB8zU-4) show in video.
...
1. Prioritize on the key user journeys that are pertinent to the metrics and KPIs you want to measure. 
   ...
   If you used the [RAE Framework](/docs/tutorials/plan/framework#the-rae-framework), make sure you cover the journeys that will help you track and measure your (R)each, (A)ctivation, and (E)ngagement.<br />
...
3. As you map your events and properties, it's also important to ensure that you have factored [identifying users](/docs/tracking-methods/identifying-users) in your product *(eg website, app, devices)*. 
   ...
   If you are not specifically tracking a sign-up journey or login event, make sure you work with your developers to have them understand how identity management works in Mixpanel.<br />
...
4. Define and document your naming standards, approaches to data types and values in your properties, and how you should deal with nullable or not-applicable values; this will help ensure data quality and data trust over time.
   ...
   - If certain property values *(eg null, N/A, "" - empty string)* are essentially considered unavailable, Mixpanel generally recommends that for those instances the property should not be sent with the event or user profile.<br />
...
- [Retail and E-commerce](https://docs.google.com/spreadsheets/d/1Kyys37m_GEL79_1BKKEnU5KxK91NF04kY-L_bFfcfqE/edit#gid=1641519238)
- [Media and Entertainment](https://docs.google.com/spreadsheets/d/1K9t53kJJjaBG36kCIbZn_qKjXR9Iy306zYZAqDrv_AM/edit#gid=1641519238)
- [SaaS](https://docs.google.com/spreadsheets/d/1A5wm5MKzRfSOZfUfCAg8YpePiz8Jn3Ar_u8KBo5lD6g/edit#gid=1641519238)
- [Financial Services](https://docs.google.com/spreadsheets/d/1oGv6vbIFiYbima9IX4ItpBJvuChs-zzh83MRt_dSPgg/edit#gid=1641519238)
