...
**Super Properties**: In some cases, you may have certain properties that are relevant in which you may want to include with every event you send. These attributes are typically more about the user such as age, gender, source, or subscription plan type. Mixpanel allows you to register these properties as super properties so you can just let us know once, and these properties will be included in all subsequent events. Check out the link to find more information on 
