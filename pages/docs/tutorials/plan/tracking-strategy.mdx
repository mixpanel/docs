...
> Examples: App User ID, Subscription / User Type, Favorite Genre, App Source,
...
Mixpanel reserves certain property names for special use cases and system processing. Unlike default Mixpanel properties, which are auto-populated with a value, reserved properties may or may not be auto-populated.
...
Refer to the list of [Reserved Event Properties](docs/data-structure/events-and-properties#reserved-event-properties) and [Reserved User Properties](/docs/data-structure/user-profiles#reserved-user-properties) in our documentation.
