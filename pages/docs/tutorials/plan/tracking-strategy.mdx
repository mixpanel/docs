...
2. Map the key actions within these journeys into events and capture event properties to provide additional information about the action. As you define your events, think about whether certain event properties should be global / super properties and user properties. 
   ...
   If you have screenflows in tools like [Figjam](https://www.figma.com/figjam) or [Miro](https://miro.com), use them to visualise the steps and actions in a user's journey to define the events and properties.
...
3. As you map your events and properties, it's also important to ensure that you have factored [identifying users](/docs/tracking-methods/identifying-users) in your product *(website, app, devices)*. 
