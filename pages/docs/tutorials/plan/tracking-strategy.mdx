...
**Super Properties**: In some cases, you may have certain properties that are relevant in which you may want to include with every event you send. These attributes are typically more about the user such as age, gender, source, or subscription plan type. Mixpanel 

- **Reserved Properties**: Mixpanel have some properties that are reserved for special use or processing within our UI. Check out the link to find more information on these [Reserved Properties](https://docs.mixpanel.com/docs/data-structure/events-and-properties#reserved-event-properties).
