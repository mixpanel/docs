...
> Use case: I want to analyze users who are currently in country = "Singapore" *(user property)*, did these same users also use my product in another country *(event property)*.
...
- App Source - useful when you are tracking mulitple apps into one single Mixpanel project, which can be used for data segregation (see [Data Views](/docs/data-governance/data-views-and-classification#data-views-overview))
