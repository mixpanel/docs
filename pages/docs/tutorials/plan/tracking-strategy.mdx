...
<p style={{ position: 'relative', paddingBottom: '56.25%', height: 0, overflow: 'hidden' }}>
  <iframe src="https://www.loom.com/embed/d74f556113fa4c81a459c3900dbadb3c" frameborder="0" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%' }} allowfullscreen></iframe>
</p> 
...
<dl>
  <dt>For more information about Mixpanel's Data Model</dt>
  <dd>Checkout our [Mixpanel Data Model Board](https://mixpanel.com/project/2195193/view/139237/app/boards/#id=4600772/) in the demo project.</dd>
  <dd>Read about Mixpanel [Infrastructure](/docs/how-it-works/infrastructure)</dd>
</dl>
