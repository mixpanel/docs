...
Events are the foundation of the Mixpanel Data Model. In order to conduct meaningful analysis and gather insights from Mixpanel reports, you will need to understand and intentionally design your events and event properties based on business objectives, specific use cases, and key metrics.
...
* Event properties provide description or add context to the event. Similarly, include only relevant event properties that will enable you drill deeper into the analysis.
...
Along with the Data Model Overview video, you can find this [Mixpanel Data Model Board](https://mixpanel.com/project/2195193/view/139237/app/boards/#id=4600772/) in our sample Mixpanel project which offers an in-depth explanation to see events and event properties live-in-action within the platform. 
...
### Deeper Understanding of Properties 
