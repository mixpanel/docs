...
<div className="bg-base100 rounded-xl">
    <h4 className="text-2xl font-medium mb-2 color:bg-purple200">Already Know What You Want to Track?</h4>
    <p>If you already know the events you want to track, you can skip planning and start by installing Mixpanel.</p>
    <br></br>
...
<div className="bg-base100 rounded-xl">
    <h4 className="text-2xl font-medium mb-2 color:bg-purple200">Explore a demo dataset</h4>
    <p>Register for a free account to explore a full demo of Mixpanel. If you make a Board and like it, you can move it into your own project and add your own data.</p>
    <br></br>
    <ExtendedButton title="Explore Demo Dataset" link="https://mixpanel.com/project/?show-demo-dataset-modal=true"></ExtendedButton>
</div>
...
<div className="bg-base100 rounded-xl">
    <h4 className="text-2xl font-medium mb-2 color:bg-purple200">Get an in-depth product demo</h4>
    ...
    <br></br>
    <ExtendedButton title="Live Demo Request" link="https://mixpanel.com/contact-us/ps-sem-demo-request-na/"></ExtendedButton>
</div>
