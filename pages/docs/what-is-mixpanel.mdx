...
>
  <p>
    <iframe
      src="https://www.youtube.com/embed/PbKnQ777vuk"
      frameBorder="0"
...
<br></br>
<ExtendedButton
  title="Plan Your Tracked Events"
  link="/docs/what-to-track"
></ExtendedButton>
...
<div className="bg-base100 rounded-xl">
  ...
  <br></br>
  <ExtendedButton
    title="Explore Demo Dataset"
    link="https://mixpanel.com/project/?show-demo-dataset-modal=true"
  ></ExtendedButton>
</div>
