...
<div className="bg-base100 rounded-xl">
    ...
    <p>[Register for a free account](https://mixpanel.com/signup/) to explore a full demo of Mixpanel. If you make a Board and like it, you can move it into your own project and add your own data.</p>
    <br></br>
    <ExtendedButton title="Explore Demo Dataset" link="/docs/quickstart/install-mixpanel"></ExtendedButton>
</div>
