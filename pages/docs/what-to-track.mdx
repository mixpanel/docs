...
* **A Value Moment** - Tracking a value moment can help you assess how well your product is doing. You can
...
We recommend keeping your event names short and descriptive. We like to use the Object-Action convention:
```python
