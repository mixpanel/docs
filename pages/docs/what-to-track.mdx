...
* **A Value Moment** - Tracking a value moment can help you access how well your product is doing. You can
...
Value moments are often use of important features or taking a critical action. Here are some examples:
...
We recommend keeping your event names short and descriptive. We like to use is the Object-Action convention:
```python
    e.g. 'Video Watched', 'Message Liked', 'Friend Added'
```
...
**Frontend event tracking (especially on web) loses between 15% and 30% of events**. 
