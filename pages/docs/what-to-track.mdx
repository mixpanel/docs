...
<div className="bg-base100 rounded-xl">
    ...
    <br></br>
    <ExtendedButton title="Quickstart Guide" link="/docs/quickstart/install-mixpanel"></ExtendedButton>
</div>
...
<div className="bg-base100 rounded-xl">
    <h2 className="text-2xl font-medium mb-2 color:bg-purple200">Tracking Plan</h2>
    <p>Outline your events and properties definition in a centralized document as a source of truth on your implementation.</p>
    <br></br>
    <ExtendedButton title="Create a Tracking Plan" link="docs/tracking-best-practices/tracking-plan"></ExtendedButton>
</div>
