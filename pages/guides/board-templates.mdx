...
<details style={{ cursor: 'pointer', marginBottom: '16px' }}>
  <summary style={{ fontSize: '1.15rem', fontWeight: 600 }}>
  ...
  <br /><br />
  * **The Template Selector:** Click the <a href="https://mixpanel.com/project/?show-template-selector=true" target="_blank" style={{ color: '#b794f4', fontWeight: 600 }}>Ready to build? Create a Board &rarr;</a> button to launch the configuration wizard.
