...
<details style={{ cursor: 'pointer', marginBottom: '16px' }}>
  <summary style={{ fontWeight: 600, fontSize: '18px', padding: '10px 0' }}>
    How do I use these templates in my own project?
  </summary>
  <p style={{ paddingLeft: '20px', opacity: 0.8, marginTop: '8px' }}>
    Pick a template above to explore the interactive demo. Once you're ready to use it with your own data,
    simply click "Create Board" from the Template Selector in Mixpanel. Your reports will populate
    automatically, and you can customize any metric, filter, or visualization from there.
  </p>
</details>
