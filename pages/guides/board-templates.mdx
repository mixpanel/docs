...
<details style={{ cursor: 'pointer', marginBottom: '16px' }}>
  <summary style={{ 
    ...
    color: 'var(--sgt-title, #ffffff) !important',
    opacity: '1 !important' 
  }}>
  ...
  <div style={{ 
    ...
    lineHeight: '1.6',
    color: '#ffffff !important', 
    color: 'var(--sgt-blurb, #ffffff) !important',
    opacity: '1 !important' 
  }}>
    ...
    <ul style={{ marginTop: '8px', listStyleType: 'disc', paddingLeft: '20px' }}>
      <li style={{ marginBottom: '8px' }}>
        <strong>The Template Selector:</strong> Click the <a href="https://mixpanel.com/project/?show-template-selector=true" target="_blank" style={{ color: 'rgb(139, 92, 246) !important', fontWeight: 600, textDecoration: 'underline' }}>Ready to build? Create a Board &rarr;</a> button to launch the configuration wizard.
      </li>
      <li>
