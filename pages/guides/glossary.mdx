...
### Active User
A user who interacts with your product within a defined period, [measured via event-based tracking](/docs/data-structure/events-and-properties) as Daily Active Users (DAU), Weekly Active Users (WAU), or Monthly Active Users (MAU).
...
### Bounce Rate
A metric tracking the percentage of [sessions with only a single page view](/docs/features/sessions#what-are-the-average-number-of-pages-visited-per-session), often used to indicate low engagement or friction in the onboarding experience.
...
### Formula
A custom expression that [modifies or combines data series](https://docs.mixpanel.com/changelogs/2023-09-19-formulas)—such as dividing total revenue by user count—to calculate derived metrics and ratios.
