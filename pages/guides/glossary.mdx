...
A European Union regulation that governs how personal data is collected, processed, and stored. Mixpanel supports [GDPR](/docs/privacy/gdpr-compliance) compliance through data controls and deletion tools.  
