...
### Formula
A custom expression that [modifies or combines data series](/docs/reports/insights#formulas)—such as dividing total revenue by user count—to calculate derived metrics and ratios.
