...
<div className={style.logoTable}>
    <img src="/logo-andreessen.png" className={style.logo}/>
    <div className={style.logoText}>
        ...
        **The best metrics for understanding growth will be aligned with your company's north star metric**, and therefore, will vary widely depending on the specific context. In a luxury jewelry company, for example, a key metric might be the number of items sold over $10k where the buyer is x."<div className={style.logoSpeaker}>**Andrew Chen**</div> *General Partner, Andreessen Horowitz; Board Member, Reforge*
    </div>
</div>

<div className={style.logoTable}>
    <img src="/logo-product_school.png" className={style.logo}/>
    <div className={style.logoText}>
        "User acquisition matters as a growth metric but you also need to focus on retention. **If you're churning users, you're not really growing.** And while companies like Amazon can afford to stay unprofitable for years, your company probably can't. Outrageous success stories are outliers. Don't get dazzled by what works for them. Focus on what works for you. What's 'table stakes' will vary by industry and market, but these days, it's all about UX—especially at the onboarding stage. Make the user jump through hoops to use your app/software, and they will simply hop away."<div className={style.logoSpeaker}>**Carlos González de Villaumbrosia**</div> *CEO, Product School*
    </div>
</div>
