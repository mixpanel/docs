...
<br></br>
<section id="video" aria-label="MCP overview video" style={{ padding: '8px 16px 32px' }}>
  <div
    style={{
      display: 'flex',
      flexWrap: 'wrap',
  ...
  >
    ...
    <aside style={{ flex: '1 1 320px', minWidth: 280 }}>
      <h2 style={{ marginTop: 0 }}>**Mixpanel MCP Overview**</h2>
      <p>
...
<br></br>
      <a href="https://youtu.be/NQygWnSViZc?si=cFEc1aGyEKZClWg9"
