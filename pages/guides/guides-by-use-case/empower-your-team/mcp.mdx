...
- A copy of the [MCP Prompt Library](https://mixpanel.com/wp-content/uploads/2026/04/Mixpanel_MCP_Prompt_Library.pdf). It's useful to have on hand and covers ready-to-use prompts for analysis, investigation, dashboard creation, and governance, with tool annotations showing what fires under the hood.
