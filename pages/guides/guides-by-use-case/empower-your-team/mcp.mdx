...
<Callout type="info">
    **Pro tip:** These outputs are not persisted in Mixpanel. When something matters, it’s best practice to recreate or formalize it in the Mixpanel UI.
</Callout>
...
Ask it to synthesize: *Given everything we’ve analyzed, what would you change about our checkout strategy going into the next quarter?*
