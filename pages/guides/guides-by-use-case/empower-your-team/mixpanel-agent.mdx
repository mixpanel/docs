...
3. Choose your delivery destination — Slack, email, or in-product
...
| Open Mixpanel every morning to check if anything moved | KPI Agent | It comes to you — daily, weekly, or monthly, via Slack, email, or in-product. You know where to dig in. |
...
- Set up the KPI Agent once on the metric you're accountable for and it delivers a digest on your schedule — daily, weekly, or monthly, via Slack, email, or in-product.
...
| **Delivery** | In-product | In-product | Slack, email, or in-product | In-product |
