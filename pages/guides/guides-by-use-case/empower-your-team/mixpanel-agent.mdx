...
This guide covers how to get the most out of each capability — and how to migrate workflows you're already running today. If you're looking to query Mixpanel from an external AI tool like Claude or ChatGPT, see [Explore Data with AI](/guides/guides-by-use-case/empower-your-team/mcp) instead.
