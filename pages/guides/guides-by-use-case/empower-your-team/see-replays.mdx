...
<section id="video" aria-label="Mixpanel Session Replay video" style={{ padding: '8px 16px 32px' }}>
  ...
  >
    ...
    <aside style={{ flex: '1 1 320px', minWidth: 280 }}>
      ...
      <p>
        n this 7-minute overview, learn how Mixpanel Session Replay lets you jump from data (the 'what') to the user session (the 'why') to fix friction points fast. This demo also shows you the simple, one-line-of-code implementation required to start watching real user sessions and accelerating product growth.
      </p>
<br></br>
