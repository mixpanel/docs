...
<br></br>
<section id="video" aria-label="Mixpanel Experiments video" style={{ padding: '8px 16px 32px' }}>
  <div
    style={{
      display: 'flex',
      flexWrap: 'wrap',
