...
- ⚠️ **Pitfall:** Skipping SDK setup causes flags to appear “inactive” even if configured correctly in Mixpanel.
...
- [Funnels](/docs/reports/funnels): Track conversion rates between control and variant users.
