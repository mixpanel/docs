...
- Developers can experiment safely without polluting your production dataset
- Data teams have confidence that every event in production has been tested

Do not shortcut by sending test events to production. As a best practice, your team should enforce a rule that "*Nothing hits production until it passes QA.*"
