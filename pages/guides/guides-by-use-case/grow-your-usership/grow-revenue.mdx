...
### Capture the Right Revenue Events
...
### Verify and Define Your Revenue Data

Before you begin analysis, confirm that Mixpanel is reading your data correctly.

Steps to take:

1. **Tag your revenue events** in Lexicon to make them discoverable and easy to reference across reports.

2. **Check event integrity** — look for duplicate event names, missing properties, or inconsistent casing.

3. **Compare totals** against your finance system or source-of-truth warehouse to confirm that imported revenue matches what you expect.
...
${ Average Revenue Per User (ARPU) = Sum of Revenue over time / Number of Unique Users}$
