...
>
  <div style={{ flex: '1 1 420px', minWidth: '280px' }}>
    <p>
  Mixpanel is built around a simple but powerful framework for continuous improvement: <strong>Observe → Analyze → Decide → Act (OADA)</strong>.
 </p>
 <p>Each stage in the OADA framework connects directly to Mixpanel’s tools, helping you move from data to observation to action–—all in one platform.
    </p>
  ...
  <div style={{ flex: '1 1 280px', textAlign: 'center' }}>
    ...
    <p style={{ fontSize: '0.9em', color: '#666', marginTop: '8px' }}>
      The OADA framework: Observe → Analyze → Decide → Act — the cycle of continuous innovation.
    </p>
  </div>
</section>
