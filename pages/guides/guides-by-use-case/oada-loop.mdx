# Mixpanel and the OADA Loop
The OADA loop––**Observe → Analyze → Decide → Act**––is the framework behind how great teams use data to build better products. Each phase connects to specific Mixpanel capabilities that help you measure, learn, and improve faster.
