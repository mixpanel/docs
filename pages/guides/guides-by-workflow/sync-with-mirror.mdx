...
Each event supports a maximum of 255 [data type](/docs/data-structure/property-reference/data-type) properties. Property names longer than 255 characters are truncated. For a full list of limits, see [Events and Properties](/docs/data-structure/events-and-properties#what-are-the-limits-of-events-and-properties).
