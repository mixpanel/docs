...
If you've previously collected data in other systems and wish to analyze it in Mixpanel, you have the option to backfill it into Mixpanel. 
...
If your historical data is stored in a data warehouse, you can import it into Mixpanel through [Mixpanel Warehouse Connector](/docs/tracking-methods/data-warehouse). 
