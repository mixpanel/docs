...
If your data is already stored in a data warehouse, our [Warehouse Connectors](/docs/tracking-methods/data-warehouse) allows you to import different [Table Types](/docs/tracking-methods/data-warehouse#table-types) that map to Events, User Profiles, Group Profiles, and Lookup Tables 
in your Mixpanel project. It also provides various [Sync Modes](/docs/tracking-methods/data-warehouse#sync-modes) such as Mirror, Append, Full, and One-Time syncs to ensure that your data in Mixpanel matches your trusted data source.
