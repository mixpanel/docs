...
Here’s another [example](https://mixpanel.com/blog/data-democratization-product-analytics/) where we walk through in-depth how to optimize a customer’s event structure.
