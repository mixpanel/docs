...
A property's default data type can be [typecast](/docs/reports/overview#typecasting) to another data type in Mixpanel reports. However, it's always an important best practice that you keep a property's data type consistent during implementation to avoid any confusion.
