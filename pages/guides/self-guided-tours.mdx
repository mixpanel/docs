...
"  ready(function(){",
"    function boot(){",
"      if (!(window && window.NavatticEmbed && window.NavatticEmbed.initPopup)) { setTimeout(boot, 120); return; }",
"      var nodes = document.querySelectorAll('[data-navattic-id]');",
...
"        try { window.NavatticEmbed.initPopup(url, { title: title, preload: false }); } catch(e) {}",
"        el.addEventListener('click', function(evt){",
"          var btn = evt.currentTarget;",
"          var id2 = btn.getAttribute('data-navattic-id');",
"          var url2 = 'https://capture.navattic.com/' + id2;",
"          if (window && window.NavatticEmbed && window.NavatticEmbed.openPopup) {",
"            window.NavatticEmbed.openPopup(url2);",
"          }",
"        });",
"      }",
"    }",
