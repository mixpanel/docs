...
import OrgSettingsImage from "../../public/Authentication/service-accounts-org-settings.png";
import ProjectSettingsImage from "../../public/Authentication/service-accounts-project-settings.png";
import AddServiceAccount from "../../public/Authentication/add-service-account.png";
import CreateServiceAccount from "../../public/Authentication/create-service-account.png";

# Authentication Methods

Most of our APIs require authentication for which we recommend using [Service Accounts](/reference/authentication#service-accounts) to authenticate. However, most of our Ingestion API calls such as [Import Events](/reference/ingestion/events), [Track Events](/reference/export/profiles), [User Profiles](ref:user-profiles), and [Group Profiles](ref:group-profiles) only require a [Project Token](/reference/authentication#project-token). Because these APIs are often called from our client-side SDKs, we do not want to expose credentials, but we do need to know which project to send data to so we use the Project Token for that purpose.
...
<Image src={CreateServiceAccount.src} />
...
<Image src={AddServiceAccount.src} />
...
<CustomCallout type="warning" title="Deprecation Warning">
