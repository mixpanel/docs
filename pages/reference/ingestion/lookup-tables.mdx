...
<CustomCallout type="info">
  To see this API in action, visit our [API Playground](https://developer.mixpanel.com/reference/list-lookup-tables).
</CustomCallout>
...
These APIs use [Service Accounts](/reference/authentication#service-accounts) for authentication.
