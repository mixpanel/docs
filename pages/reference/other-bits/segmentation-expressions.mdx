...
Segmentation Expressions are used in [Query API](/reference/other-bits/query-api) and [Raw Data Export API](/reference/export/events) to allow for more specificity when querying your data.
