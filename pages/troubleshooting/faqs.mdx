...
 Check out [our Guides](https://docs.mixpanel.com/guides/onboarding-overview) for a walk-through on how to plan, implement, and analyze in Mixpanel!
</FAQBox>
...
 Companies across industries track and create reports focused on the metrics most relevant to their business models. Check out [these case studies](https://mixpanel.com/customers/all) from Mixpanel customers to get ideas about what to track and how Mixpanel is being used in your industry. We also have [templates](https://docs.mixpanel.com/docs/boards/templates) and demo datasets for various industries (accessed through the ? menu) that are a helpful starting point for tracking.
</FAQBox>
...
 Organizations on enterprise plans can set [data standards](https://docs.mixpanel.com/docs/data-governance/data-standards) and [approve events](https://docs.mixpanel.com/docs/data-governance/event-approval) to ensure that the events users are using to create reports are standardized. All plans can add a description and [other metadata in Lexicon](https://docs.mixpanel.com/docs/data-governance/lexicon) to help users find the right events to use.
</FAQBox>

<FAQBox title="How do I edit and duplicate reports?" section="Building Mixpanel Reports and Analyses">
 The [Reports](https://docs.mixpanel.com/docs/reports) doc has a lot of great information about editing reports. You can duplicate a report through the overflow (…) menu in the upper-right-hand corner of the report builder.
</FAQBox>

<FAQBox title="How do I filter reports?" section="Building Mixpanel Reports and Analyses">
 The [Filters](https://docs.mixpanel.com/docs/reports#filters) section of the Reports doc goes over how to add inline and global filters. The filters work a bit differently in a Funnel report, which you can read about [here](https://docs.mixpanel.com/docs/reports/funnels/funnels-advanced#filters).

 You can also add [board-level filters](https://docs.mixpanel.com/docs/boards#step-5-board-wide-date-ranges-and-filters) to apply a global filter across all the reports on the board.
</FAQBox>
...
 Growth and Enterprise plans can create custom alerts based on reports. When an alert fires, Mixpanel’s [Root Cause Analysis feature](https://docs.mixpanel.com/docs/features/alerts#root-cause-analysis) analyzes the properties of unexpected events and automatically generates a Board with reports broken down by relevant properties so you can search for the underlying cause of any unexpected data point or fired alert.

 Organizations with enterprise plans can also set up [anomaly detection alerts](https://docs.mixpanel.com/docs/features/alerts#anomaly-detection) to automatically monitor their metrics and notify you when significant anomalies occur.

 Learn more about custom alerts [here](https://docs.mixpanel.com/docs/features/alerts).
</FAQBox>
...
  - [Insights](https://docs.mixpanel.com/docs/reports/insights): Visualize trends and compositions within your data
  - [Funnels](https://docs.mixpanel.com/docs/reports/funnels/funnels-overview): Measure conversions through a series of events
  - [Retention](https://docs.mixpanel.com/docs/reports/retention): Measure engagement over time
  - [Flows](https://docs.mixpanel.com/docs/reports/flows): See frequent paths taken by users to or from any event

 Check out [templates](https://docs.mixpanel.com/docs/boards/templates) and demo datasets for various industries (accessed through the ? menu) to get a feel for popular metrics.
</FAQBox>

<FAQBox title="How can I collaborate and share within Mixpanel?" section="Building Mixpanel Reports and Analyses">
 The [Sharing and Permissions](https://docs.mixpanel.com/docs/boards/sharing-and-permission) doc has information sharing reports. [Custom properties](https://docs.mixpanel.com/docs/features/custom-properties), [cohorts](https://docs.mixpanel.com/docs/users/cohorts), and [custom events](https://docs.mixpanel.com/docs/features/custom-events) can also be shared explicitly with users or across the project. You’ll be prompted to save and share those entities after creation.
</FAQBox>
...
<FAQBox title="How can I best conserve snowflake/wh credits when exporting data from Mixpanel?" section="Exporting Data from Mixpanel">
</FAQBox>
