...
<ExtendedAccordion title="What does Mixpanel do?" section="General">
...
<ExtendedAccordion title="Can I demo Mixpanel?" section="General">
...
<ExtendedAccordion title="How much does it cost to use Mixpanel?" section="General">
...
<ExtendedAccordion title="Why can’t I see any data in my Mixpanel project?" section="Sending Data to Mixpanel">
...
<ExtendedAccordion title="What methods are available for importing data into Mixpanel?" section="Sending Data to Mixpanel">
...
<ExtendedAccordion title="How does ad-blockers affect Mixpanel tracking?" section="Sending Data to Mixpanel">
...
<ExtendedAccordion title="How do I exclude bots from my tracking?" section="Sending Data to Mixpanel">
...
<ExtendedAccordion title="Why are my user profiles all set to the same location?" section="Sending Data to Mixpanel">
...
<ExtendedAccordion title="How do I override the default geolocation set by Mixpanel when sending data from a server?" section="Sending Data to Mixpanel">
...
<ExtendedAccordion title="How do I track downloads and installs from Apple App Store and Google Play Store?" section="Sending Data to Mixpanel">
...
<ExtendedAccordion title="How do I track first-touch UTM tags?" section="Sending Data to Mixpanel">
...
<ExtendedAccordion title="How do I track last-touch UTM tags?" section="Sending Data to Mixpanel">
...
<ExtendedAccordion title="Why do I see Session Start and Session End events in my project?" section="Sending Data to Mixpanel">
...
<ExtendedAccordion title="What are super properties?" section="Sending Data to Mixpanel">
...
<ExtendedAccordion title="How can I edit the event data inside my project?" section="Sending Data to Mixpanel">
...
<ExtendedAccordion title="How can I send data from my data warehouse to Mixpanel?" section="Sending Data to Mixpanel">
...
<ExtendedAccordion title="How can I do a one-time import of historic events? How much does it cost?" section="Sending Data to Mixpanel">
...
<ExtendedAccordion title="Why do I see CORS errors in the console when Mixpanel requests in my website?" section="Sending Data to Mixpanel">
...
<ExtendedAccordion title="How do we send data to Mixpanel?" section="Sending Data to Mixpanel">
...
<ExtendedAccordion title="Can Mixpanel integrate with our current data model or database?" section="Sending Data to Mixpanel">
...
<ExtendedAccordion title="How do we handle sensitive or private data?" section="Sending Data to Mixpanel">
...
<ExtendedAccordion title="What is the best way to send both client-side and server-side events?" section="Sending Data to Mixpanel">
...
<ExtendedAccordion title="How do we ensure the data is accurate and implementation is correct?" section="Sending Data to Mixpanel">
...
<ExtendedAccordion title="How do I anonymize an actual known user?" section="Sending Data to Mixpanel">
...
<ExtendedAccordion title="What is a distinct_id?" section="Identity Management in Mixpanel">
...
<ExtendedAccordion title="How is distinct_id generated?" section="Identity Management in Mixpanel">
...
<ExtendedAccordion title="Where is distinct_id stored?" section="Identity Management in Mixpanel">
...
<ExtendedAccordion title="What is the best practice for handling user identity in a client-side implementation?" section="Identity Management in Mixpanel">
...
<ExtendedAccordion title="What is the best practice for handling user identity in a server-side implementation?" section="Identity Management in Mixpanel">
...
<ExtendedAccordion title="How do I setup cross-domain tracking with Mixpanel?(Original API)" section="Identity Management in Mixpanel">
...
<ExtendedAccordion title="How do I setup cross-subdomain tracking with Mixpanel?" section="Identity Management in Mixpanel">
...
<ExtendedAccordion title="How do I setup consistent user tracking across multiple platforms, such as a website and an app?" section="Identity Management in Mixpanel">
...
<ExtendedAccordion title="Why is the distinct_id shown in Mixpanel different from the ID I used to identify the user?" section="Identity Management in Mixpanel">
...
<ExtendedAccordion title="Why do I see data from 2 different users under a single Mixpanel profile?" section="Identity Management in Mixpanel">
...
<ExtendedAccordion title="Why do I see 2 duplicated Mixpanel user profiles sharing the same email value?" section="Identity Management in Mixpanel">
...
<ExtendedAccordion title="What dev lift is involved when migrating from Legacy ID merge to Original or Simplified?" section="Identity Management in Mixpanel">
...
<ExtendedAccordion title="Are there limitations with using Simplified ID vs Original ID merge?" section="Identity Management in Mixpanel">
...
<ExtendedAccordion title="What happens if a user clears cookies or reinstalls the app?" section="Identity Management in Mixpanel">
...
<ExtendedAccordion title="Is there a limit to the number of identities that can be merged?" section="Identity Management in Mixpanel">
...
<ExtendedAccordion title="How does Mixpanel handle merging IDs and what are the best practices?" section="Identity Management in Mixpanel">
...
<ExtendedAccordion title="How does Mixpanel ensure data privacy and compliance?" section="Identity Management in Mixpanel">
...
<ExtendedAccordion title="How does Mixpanel attribute campaign data when identities are set or changed?" section="Identity Management in Mixpanel">
...
<ExtendedAccordion title="How do I get started and what should I analyze?" section="Building Mixpanel Reports and Analyses">
  Check out [our Guides](/guides/onboarding-overview) for a walk-through on how to plan, implement, and analyze in Mixpanel!
</ExtendedAccordion>

<ExtendedAccordion title="What are the best practices for setting up trusted boards for users to view and use?" section="Building Mixpanel Reports and Analyses">
...
<ExtendedAccordion title="How do I know my report is “correct”?" section="Building Mixpanel Reports and Analyses">
...
<ExtendedAccordion title="What are other companies in my industry tracking and creating reports for in Mixpanel?" section="Building Mixpanel Reports and Analyses">
...
<ExtendedAccordion title="How can I standardize what events my users use to create reports?" section="Building Mixpanel Reports and Analyses">
...
<ExtendedAccordion title="How do I edit and duplicate reports?" section="Building Mixpanel Reports and Analyses">
...
<ExtendedAccordion title="How do I filter reports?" section="Building Mixpanel Reports and Analyses">
...
<ExtendedAccordion title="How can I get automated insights from alerts and setup anomaly detection?" section="Building Mixpanel Reports and Analyses">
  Growth and Enterprise plans can create custom alerts based on reports. When an alert fires, Mixpanel’s AI-powered [Root Cause Analysis feature](/docs/features/root-cause-analysis) automatically diagnoses what drove the change — validating the anomaly, ranking the dimensions that contributed most, and generating a Board with an AI-written interpretation, confidence level, and suggested next steps.
...
<ExtendedAccordion title="What are the common analysis types done in Mixpanel?" section="Building Mixpanel Reports and Analyses">
...
<ExtendedAccordion title="How can I collaborate and share within Mixpanel?" section="Building Mixpanel Reports and Analyses">
...
<ExtendedAccordion title="What is the difference between a Metric and Behavior?" section="Building Mixpanel Reports and Analyses">
...
<ExtendedAccordion title="How do data pipeline exports work? How is the data structured and what can I expect?" section="Exporting Data from Mixpanel">
...
<ExtendedAccordion title="How can I export my data from Mixpanel?" section="Exporting Data from Mixpanel">
...
<ExtendedAccordion title="Can I automate data exports (e.g., schedule CSV delivery or direct warehouse sync)?" section="Exporting Data from Mixpanel">
...
<ExtendedAccordion title="Is there an additional cost for exporting data?" section="Exporting Data from Mixpanel">
...
<ExtendedAccordion title="Can I export specific data, such as cohorts, user lists, or raw events?" section="Exporting Data from Mixpanel">
...
<ExtendedAccordion title="What if my data warehouse is not natively supported?" section="Exporting Data from Mixpanel">
...
<ExtendedAccordion title="How should we structure our Mixpanel projects?" section="Manage your Mixpanel Projects and Teammates">
...
<ExtendedAccordion title="How do we keep things organized within a Mixpanel project for multiple teams?" section="Manage your Mixpanel Projects and Teammates">
...
<ExtendedAccordion title="Who should own and maintain Mixpanel projects?" section="Manage your Mixpanel Projects and Teammates">
...
<ExtendedAccordion title="How do we onboard new teammates and empower them to use Mixpanel?" section="Manage your Mixpanel Projects and Teammates">
...
<ExtendedAccordion title="How can we audit or review how our team is using Mixpanel?" section="Manage your Mixpanel Projects and Teammates">
...
<ExtendedAccordion title="How do we support and decentralize Mixpanel expertise within our organization?" section="Manage your Mixpanel Projects and Teammates">
...
<ExtendedAccordion title="How can users opt out of tracking?" section="Protecting User Data and Privacy">
...
<ExtendedAccordion title="Where can I learn more about user privacy regulations and opting users out of tracking?" section="Protecting User Data and Privacy">
...
<ExtendedAccordion title="How can we anonymize users and avoid sending PII?" section="Protecting User Data and Privacy">
...
<ExtendedAccordion title="How do we disable geolocation or prevent IP address usage?" section="Protecting User Data and Privacy">
...
<ExtendedAccordion title="How do we handle the accidental sending of PII?" section="Protecting User Data and Privacy">
