---
openapi: /openapi/query.openapi.yaml POST /engage
title: Query Profiles
description: "Query user (or group) profile data and return list of users (or groups) that fit specified parameters"
---
