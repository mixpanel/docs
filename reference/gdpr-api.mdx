---
title: Overview
description: "GDPR and CCPA API (v3) for creating and checking data retrieval and deletion jobs for end-user personal data"
---
...
Request Type: **POST**<br />Description: Creates a data retrieval job.<br />Endpoint: `https://mixpanel.com/api/app/data-retrievals/v3.0/?token=<your_project_token>`<br />Parameters:
...
| disclosure\_type | Body. Passed in JSON blob format. | String | Only required if compliance\_type = CCPA. Can be [Data, Categories, or Sources. Default is Data](/docs/privacy/end-user-data-management). |
...
Example Return:<br />`{"status":"ok","results":[{"status":"PENDING", "disclosure_type":"DATA", "date_requested":"2020-03-09T22:28:55.078315", "tracking_id":"1583792934719392965",  "project_id":1978118, "compliance_type":"ccpa", "destination_url":null, "requesting_user":"pat.davis@mixpanel.com", "distinct_id_count":1}]}`
...
Example Request:<br />`curl "https://mixpanel.com/api/app/data-retrievals/v3.0/1583958896131033662/?token=591b3354bb2bdd96f72f23bf56911673"
-H "Authorization: Bearer vZcErNw8JCq42BZUJyWoZmDWCKBxXc"`

Example Return:<br />`{"status": "ok", "results": {"status": "PENDING", "result": "", "distinct_ids": ["1"]}}`
...
Example Request:<br />`curl "https://mixpanel.com/api/app/data-deletions/v3.0/?token=591b3354bb2bdd96f72f23bf56911673"
...
Example Request:<br />`curl "https://mixpanel.com/api/app/data-deletions/v3.0/35bd8477-f71f-4088-af55-c88a6fb4ad4b/?token=591b3354bb2bdd96f72f23bf56911674" -H "Authorization: Bearer vZcErNw8JCq42BZUJyWoZmDWCKBxXc"`
...
Example Return:<br />`{"status": "ok", "results": {"task_id": "35bd8477-f71f-4088-af55-c88a6fb4ad4a"}}`
