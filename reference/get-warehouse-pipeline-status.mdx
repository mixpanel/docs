---
openapi: /openapi/data-pipelines.openapi.yaml GET /nessie/pipeline/status
title: Get Pipeline
description: "Get the status and summary of recent export jobs for a Data Pipelines pipeline by name"
---
