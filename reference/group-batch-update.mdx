---
openapi: "/openapi/ingestion.openapi.yaml POST /groups#group-batch-update"
title: Batch Update Group Profiles
description: "Send a batch of group profile updates"
---
...
Refer to the respective group profile update commands (\$set, \$set\_once, \$add, \$union, \$remove, \$unset, and \$delete) on syntax for their parameters.
