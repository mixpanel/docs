...
See our [Client-Side vs Server-Side Tracking](/docs/tracking-methods/choosing-the-right-method) guide for tradeoffs between the different integration approaches.
