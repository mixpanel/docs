...
See our [Client-Side vs Server-Side Tracking](/docs/what-to-track#we-recommend-server-side-tracking) guide for tradeoffs between the different integration approaches.
