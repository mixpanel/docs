---
title: Lookup Tables
description: "Lookup Tables are mutable tables that describe non-user entities like accounts, product SKUs, or geographies"
---
...
These APIs use [Service Accounts](/reference/service-accounts) for authentication.
