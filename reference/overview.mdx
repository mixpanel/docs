...
Use the Query API to get the same calculated data that powers Mixpanel's web application. This includes Insights, Funnels, Retention, and custom JQL Queries.
