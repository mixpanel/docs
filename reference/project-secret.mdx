...
description: "Authenticate with a legacy Project Secret via HTTP Basic Auth and find it in project settings; deprecated and fully retired on March 3, 2027"
---

<Warning>
  **Deprecation Warning**

  This authentication method has been deprecated and will be fully retired on **March 3, 2027**. Please migrate to [Service Accounts](/reference/service-accounts-api) instead, as they are the recommended authentication mechanism going forward.
</Warning>
