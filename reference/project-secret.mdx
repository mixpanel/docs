...
<Warning>
  **Deprecation Warning**
  ...
  This authentication method has been deprecated and will be fully retired on **March 3, 2027**. Existing projects will continue to be able to use API Secret until that date. Newly created projects no longer have access to the deprecated authentication method. Please migrate to [Service Accounts](/reference/service-accounts-api) instead, as they are the recommended authentication mechanism going forward.
</Warning>
