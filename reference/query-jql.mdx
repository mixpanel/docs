---
openapi: /openapi/query.openapi.yaml POST /jql
title: Custom JQL Query
description: "Run a custom JQL script via the HTTP API; JQL is in maintenance mode, so prefer the Export API, Query API, or Data Pipelines"
---
