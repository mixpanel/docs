---
title: Overview
description: "The Mixpanel Export Data APIs allow you to export your raw data either manually or through a pipeline"
---

The Mixpanel Export Data APIs allow you to export your raw data either manually or through a pipeline.

Please note that deduplication is not applied to raw data exports. If you export events via the API, you may see duplicates. It is recommended to apply deduplication logic (event name, distinct\_id, timestamp, \$insert\_id) to all exported data.
