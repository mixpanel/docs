---
openapi: /openapi/query.openapi.yaml GET /retention
title: Query Retention Report
description: "Query retention (cohort analysis) data for users who did a born event and then a return event, with interval and unit options"
---
