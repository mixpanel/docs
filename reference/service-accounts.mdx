...
description: "Authenticate API requests with service accounts, non-human Mixpanel users for scripts and backend services, via HTTP basic auth"
---
...
<Warning>
  **Owner or Admin Permissions Required**
  ...
  You must have Owner or Admin permissions to manage a project's Service Accounts. Learn more in our [permissions help doc](/docs/orgs-and-projects/roles-and-permissions#permissions).
</Warning>
...
<div class="mixpanel-custom-two-column">
  ...
  <div class="image-container">
    <img src="/images/reference/2eb540d5d067b44feb76d057cd628dd9a0648c6310607f6d7332dff433fa22b4-org_SA.png" />
  </div>
</div>

<div class="mixpanel-custom-two-column">
  <div class="image-container">
    <img src="/images/reference/0e83a19d5f7b55a0e3369e706a69515f14e7f4fd6fda17b0a83da0eb790e76cf-project_SA.png" />
  </div>
...
<div class="create-service-account">
  <img src="/images/reference/650ddf66560638c3dcae7341b6ef006899fd35069dd99319ef7462e4c3611e74-created_SA.png" />
</div>
...
<Frame>
  <img
    width="80%"
    src="/images/reference/3668062-image_12.png"
  />
</Frame>
