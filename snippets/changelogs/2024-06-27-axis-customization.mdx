...
og:description: "You can now customize the axes of your charts. Using this, you can build better dashboards and tell the story you want more easily. Any changes you make can be saved and will be reflected on the dashboard. To access these new options, go to the 'Chart' tab of the query builder."
---
...
<ChangelogPostHeader
  date="2024-06-27"
  image="/images/changelog/axis-customization.png"
  title="Axis Customization"
/>
