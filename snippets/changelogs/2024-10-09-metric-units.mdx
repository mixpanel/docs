...
og:description: "Mixpanel now allows you to set the units for each of your metrics. You can set the unit, the precision, and whether or not you want an abbreviated value. This gets updated for tooltips as well as in the table below the chart."
---
...
<ChangelogPostHeader
  date="2024-10-09"
  image="/images/changelog/metric-units.png"
  title="Set units for your metrics"
/>
