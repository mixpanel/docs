...
og:description: "Session Replay is now available on all of our latest plans! Customers can update to the latest Free and Growth plans to unlock free monthly replays."
isAnnouncement: true
---
...
<ChangelogPostHeader
  date="2024-12-02"
  image="/images/changelog/session-replay-all-plans.png"
  title="Session Replay is now available on Free and Growth plans"
/>
