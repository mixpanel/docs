...
og:description: "Introducing Autocapture from Mixpanel! With just a single code snippet, you can now track common events without custom code, enabling you to get started with analytics in <2 minutes."
isAnnouncement: true
---
...
<ChangelogPostHeader
  date="2025-02-04"
  image="/images/changelog/auto-capture.png"
