...
og:description: "Two new features built for B2B account analysis are now available for customers with the Group Analytics add-on! You can now improve adoption and reduce churn risk by monitoring strategic accounts with out-of-the-box Account Profiles and activation metrics."
---
...
<ChangelogPostHeader
  date="2025-02-10"
  image="/images/changelog/B2B - Summary.png"
  title="New features for enhanced B2B account analytics!"
/>
