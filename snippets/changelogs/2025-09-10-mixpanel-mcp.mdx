...
og:description: "Talk to your Mixpanel data using natural language. The MCP Server enables AI tools like Claude to directly query your analytics data, democratizing insights across your entire organization."
...
<ChangelogPostHeader
date="2025-09-10"
image="/images/changelog/changelog-mcp-beta.png"
title="Mixpanel Model Context Protocol (MCP) Beta"
/>
