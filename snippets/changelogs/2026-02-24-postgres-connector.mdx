...
og:description: "We’re pleased to announce the Postgres Connector, now available in Public Beta — a simpler way to bring your transactional data into Mixpanel."
...
<ChangelogPostHeader
  date="2026-02-24"
  image="/images/changelog/postgres-connector-changelog.png"
  title="Postgres Connectors now in Public Beta"
/>
