...
og:description: "Connect Mixpanel to Claude, ChatGPT, Gemini, Cursor, Notion, and more. Ask product questions, build dashboards, explore Session Replays, and manage Lexicon — all from the tools you already use."
isAnnouncement: true
---
...
<ChangelogPostHeader
  date="2026-03-24"
  image="/images/changelog/changelog-mcp-launch.png"
  title="Mixpanel MCP: Talk to Your Data"
/>
