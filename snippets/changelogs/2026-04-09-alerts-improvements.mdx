...
og:description: "Schedule exactly when alerts evaluate, test thresholds before going live, see the full history of every trigger, and route notifications to any tool in your stack."
...
<ChangelogPostHeader
  date="2026-04-09"
  image="/images/changelog/alertsImprovements.png"
  title="Alerts: Take control with scheduling, history, and webhooks"
/>
