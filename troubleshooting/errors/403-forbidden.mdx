...
The API reference lists 403 as a possible response for these endpoints but doesn't document the specific conditions that trigger it. The checks below are the usual starting points.
