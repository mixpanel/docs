...
<AccordionGroup>
  ...
  <Accordion title="Which plans include Experiments and Feature Flags?" section="General">
    All Mixpanel plans include a limited amount of [Experiments](/docs/experiments) and [Feature Flags](/docs/featureflags) usage. Growth plans can purchase additional Experiments volume directly from Organization Settings > Plan Details & Billing. See [Experiments plan availability](/docs/experiments#plan-availability) and [Feature Flags plan availability](/docs/featureflags#plan-availability) for the included amounts on each plan.
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  <Accordion title="How do I get started and what should I analyze?" section="Building Mixpanel Reports and Analyses">
    Check out [our Guides](/guides/strategic-playbooks/onboarding-playbook) for a walk-through on how to plan, implement, and analyze in Mixpanel!
  </Accordion>
...
<AccordionGroup>
  ...
  <Accordion title="What if my data warehouse is not natively supported?" section="Exporting Data from Mixpanel">
    You can use a [reverse ETL (rETL) tool such as Census or Hightouch](/docs/migration/amplitude#reverse-etl-retl). These third-party tools allow you to transform and schedule syncs from your warehouse to Mixpanel, even if your warehouse isn’t directly supported. Another option is to use Mixpanel’s Import API to send data directly from your warehouse to Mixpanel.
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  <Accordion title="How should we structure our Mixpanel projects?" section="Manage your Mixpanel Projects and Teammates">
    It's recommended to set up at least two separate projects: one for Development data and another for Production data. This separation ensures that test data doesn’t mix with your live user data. The [Developer Environments guide](/docs/tracking-best-practices/developer-environments) has more information.
  ...
  <Accordion title="Who should own and maintain Mixpanel projects?" section="Manage your Mixpanel Projects and Teammates">
    It depends on your organization and goals. This blog post, [A guide to data governance for product teams](https://mixpanel.com/blog/what-is-data-governance/), goes into best practices for setting up product analytics. You can also check out the [Data Governance guide](/guides/guides-by-topic/govern-data).
  </Accordion>
